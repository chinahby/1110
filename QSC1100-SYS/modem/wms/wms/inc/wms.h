...
$Header: //source/qcom/qct/modem/wms/wms/rel/qsc1100_05.04.00/inc/wms.h#4 $ $DateTime: 2008/12/02 13:02:59 $ $Author: pyaramad $
...
/* CDMA template masks as in IS-820 (SMS parameters)
*/
enum
{
  WMS_CDMA_TEMPLATE_MASK_ORIG_ADDR             = 0x0001, /* Not used */
  WMS_CDMA_TEMPLATE_MASK_DEST_ADDR             = 0x0002,
  WMS_CDMA_TEMPLATE_MASK_RESERVED_4            = 0x0004, /* Not used */
  WMS_CDMA_TEMPLATE_MASK_DCS                   = 0x0008,
  WMS_CDMA_TEMPLATE_MASK_VALIDITY              = 0x0010,
  WMS_CDMA_TEMPLATE_MASK_SERVICE               = 0x0020,
  WMS_CDMA_TEMPLATE_MASK_ORIG_SUBADDR          = 0x0040, /* Not used */
  WMS_CDMA_TEMPLATE_MASK_DEST_SUBADDR          = 0x0080,

  WMS_CDMA_TEMPLATE_MASK_BEARER_REPLY_OPTION   = 0x0100,
  WMS_CDMA_TEMPLATE_MASK_BEARER_DATA           = 0x0200
};
