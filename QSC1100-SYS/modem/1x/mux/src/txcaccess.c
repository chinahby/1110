...
Copyright (c) 1991 - 2008 by QUALCOMM, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //source/qcom/qct/modem/1x/mux/rel/ulc/src/txcaccess.c#4 $ $DateTime: 2008/08/18 13:56:52 $ $Author: joshuam $
...
void txc_hold_enc_clk_init (void)
{
  MSG_MED ("Init Hold ENC Clocks", 0,0,0);
