...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/data/cdps/ps/main/lite/src/ps_udp.h#1 $ $DateTime: 2007/11/05 03:25:37 $ $Author: nsivakum $
...
struct udp_cb
{
  ...
  dsm_item_type* rcvq;          /* UDP receive queue for the socket        */
  uint32 rcvcnt;
};
...
(
  struct ps_iface_s  *in_if_ptr,   /* Incoming interface (ignored)         */
