...
$Header: //source/qcom/qct/modem/uim/mmgsdi/rel/07H1_2/src/gsdilib.c#10 $ $DateTime: 2009/05/15 02:20:16 $ $Author: c_pkamuj $
    ...
    */
    ...
    case UIM_EF:
        if (file_id != UIM_EF_BY_PATH) {
            ...
            /* EF should always be in the last elements of the array */
            msg.sim_filename[UIM_MAX_PATH_ELEMENTS-1] = (word) path_p[path_len-1];
            for (i = 0; i < path_len-1; i++) {
                msg.sim_filename[i] = (word) path_p[i];
            }
