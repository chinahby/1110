...
// Format variables, strings, characters and patterns for Arabic (Saudi Arabia)
...
static const AECHAR Currency_NegativePattern []           = { '#',0x0631,0x002E,0x0633,0x002E,'-',0 }; 
static const AECHAR Currency_PositivePattern[]            = { '#',0x0631,0x002E,0x0633,0x002E,0 }; 
static const AECHAR Currency_CurrencySymbol[]             = { 0x0631,0x002E,0x0633,0x002E,0 }; 
...
static const AECHAR DateTime_AMDesignator[]               = {0x0635 ,0 };
static const AECHAR DateTime_DateSeparator[]              = { '/',0 };
static const AECHAR DateTime_PMDesignator[]               = {0x0645,0 };
...
static const AECHAR DateTime_DayNames[] = {
	0x0627, 0x0644, 0x0623, 0x062D, 0x062F, 0,
	0x0627, 0x0644, 0x0627, 0x062B, 0x0646, 0x064A, 0x0646, 0,
	0x0627, 0x0644, 0x062B, 0x0644, 0x0627, 0x062B, 0x0627, 0x0621, 0,
	0x0627, 0x0644, 0x0623, 0x0631, 0x0628, 0x0639, 0x0627, 0x0621, 0,
	0x0627, 0x0644, 0x062E, 0x0645, 0x064A, 0x0633, 0,
	0x0627, 0x0644, 0x062C, 0x0645, 0x0639, 0x0629, 0,
	0x0627, 0x0644, 0x0633, 0x0628, 0x062A, 0,
   0 };

static const AECHAR DateTime_MonthNames[] = {
	0x064A ,0x0646 ,0x0627 ,0x064A ,0x0631 ,0x0641,0, 
	0x0628 ,0x0631 ,0x0627 ,0x064A ,0x0631,0,
	0x0645 ,0x0627 ,0x0631 ,0x0633,0,
	0x0623 ,0x0628 ,0x0631 ,0x064A ,0x0644,0,
	0x0645 ,0x0627 ,0x064A ,0x0648,0,
	0x064A ,0x0648 ,0x0646 ,0x064A ,0x0648,0,
	0x064A ,0x0648 ,0x0644 ,0x064A ,0x0648,0,
	0x0623 ,0x063A ,0x0633 ,0x0637 ,0x0633,0,
	0x0633 ,0x0628 ,0x062A ,0x0645 ,0x0628 ,0x0631,0,
	0x0623 ,0x0643 ,0x062A ,0x0648 ,0x0628 ,0x0631,0,
	0x0646 ,0x0648 ,0x0641 ,0x0645 ,0x0628 ,0x0631,0,
	0x062F ,0x064A ,0x0633 ,0x0645 ,0x0628 ,0x0631,0,
   0 };
...
/* -----------------------------------------------------------------------
    Locale_Ctor 
   --- */
static void LocaleAR_Ctor(LocaleAR *pMe, AEEVTBL(ILocale) *pvt, IShell *piShell, IModule *piModule)
{
...
/* -----------------------------------------------------------------------
    Locale_New  
   --- */
int LocaleAR_New(ILocale **ppo, IShell *piShell, IModule *piModule)
{
   LocaleAR *pMe;
   ...
   pMe = MALLOCREC_VTBL(LocaleAR, ILocale);
   if (!pMe) {
      return ENOMEMORY;
   }
   LocaleAR_Ctor(pMe,GETVTBL(pMe,ILocale),piShell,piModule);
...
int LocaleAR_CreateInstance(IModule *module, IShell *shell, AEECLSID idClass, void **pp)
{
   if (idClass == AEECLSID_LOCALEAR) {
      return LocaleAR_New((ILocale **)pp, shell, module);
   }
   *pp = 0;
