...
$Header: //source/qcom/qct/wconnect/bthost/brew/statapp/rel/00.00.26/src/BTAppA2DP.c#1 $
...
boolean BTApp_BuildA2DPControlMenu( CBTApp* pMe )
{
  ...
  // set the title
  IMENUCTL_SetTitle( pMe->m_pIMenu, BTAPP_RES_FILE, IDS_A2DP_CONTROL, NULL );
...
boolean BTApp_BuildA2DPTestMenu( CBTApp* pMe )
{
  ...
  // set the title
  IMENUCTL_SetTitle( pMe->m_pIMenu, BTAPP_RES_FILE, IDS_A2DP, NULL );
