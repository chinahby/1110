...
/*============================================================================
  ...
  $Header: //source/qcom/qct/core/wiredconnectivity/qhsusb/main/latest/src/func/qhsusb_fd_fast_enum.c#8 $$DateTime: 2008/12/07 07:41:45 $$Author: vkondrat $
...
#error "Fast-Enum code require FEATURE_QHSUSB_FAST_ENUMERATION"
#endif

#ifndef FEATURE_QHSUSB_FAST_ENUM_SEPARATE
#error "Fast-Enum code require FEATURE_QHSUSB_FAST_ENUM_SEPARATE"
#endif
