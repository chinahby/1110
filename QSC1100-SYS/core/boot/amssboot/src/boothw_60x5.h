#ifndef BOOTHW_60X5_H
#define BOOTHW_60X5_H
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
GENERAL DESCRIPTION
  ...
  QSC60x5. These definitions can be used by other modules in DMSS.
...
$Header: //depot/asic/qsc6055/drivers/boot/boothw_60x5.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/24/07   amw     Fixed lint warning.
...
(
  const boothw_ebi_regs_type*   reg_struct_ptr
);
/*===========================================================================
...
/*===========================================================================
  ...
  DESCRIPTION
    Initializes MSM specific hardware that cannot be put into
    common boot code.
