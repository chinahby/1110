...
$Header: //depot/asic/msmshared/secboot2/shared/1_0/flash/boot_flash_trans_nand.h#1 $
...
===========================================================================*/
extern boot_flash_trans_factory_if_type* boot_flash_trans_nand_factory_init
(
  void
);
