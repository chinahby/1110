#ifndef OSBL_FLASH_DEV_NAND_H
#define OSBL_FLASH_DEV_NAND_H
...
DESCRIPTION
  ...
  for the OSBL NAND flash device module, and declarations for the public
...
$Header: //depot/asic/msmshared/secboot2/osbl/1_0/osbl_flash_dev_nand.h#1 $
...
===========================================================================*/
extern boolean osbl_flash_dev_nand_share_data
(
...
===========================================================================*/
extern void osbl_flash_dev_nand_install_error_callback( void );

#endif /* OSBL_FLASH_DEV_NAND_H */
