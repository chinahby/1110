...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/hfat/main/latest/src/hfat_common.h#3 $ $DateTime: 2009/01/30 12:47:45 $ $Author: richardp $
...
extern rex_crit_sect_type hfat_crit_sect;

#define HFAT_INIT_LOCK() rex_init_crit_sect (&hfat_crit_sect)
#define HFAT_GLOBAL_LOCK()  rex_enter_crit_sect (&hfat_crit_sect)
#define HFAT_RELEASE_LOCK() rex_leave_crit_sect (&hfat_crit_sect)
