...
PUBLIC CLASSES AND STATIC FUNCTIONS:
        ...
        Copyright 2004,2005,2006,2007,2008,2009 QUALCOMM Incorporated.
               All Rights Reserved.
...
$Header: //source/qcom/qct/modem/wms/wmsapp/main/latest/inc_deprecated/OEMWMSDIAG.h#3 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/09/09   SJ      Put in #ifdef FEATURE_IWMSDIAG to remove compilation errors
...
#ifdef FEATURE_IWMSDIAG
/*=========================================================================
PACKET    OEMWMSDIAG_CbDeleteMsgRequest
