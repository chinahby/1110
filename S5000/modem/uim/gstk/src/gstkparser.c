...
$Header: //source/qcom/qct/modem/uim/gstk/rel/07H1_2/src/gstkparser.c#4 $
                       ...
                       const uint32          *ref_id_ptr)
{
    ...
    gstk_status_enum_type           gstk_status            = GSTK_SUCCESS;
    int                             i                      = 0;
#if defined(FEATURE_UIM_TOOLKIT_UTK) || defined(FEATURE_CDMA_800) || defined(FEATURE_CDMA_1900)
    boolean                         partial_comp_temp      = FALSE;
#endif /* FEATURE_UIM_TOOLKIT_UTK || FEATURE_CDMA_800 || FEATURE_CDMA_1900 */
