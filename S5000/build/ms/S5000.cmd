@echo off
@set PROJECTNAME=S5000
@set BASEPROJECTNAME=W206
@set QUALCOMMNAME=SBNAALZ
@set QUALCOMMNAME_BUILD=SXNAALZ
@set RESOURCEDIR=S5000
@set MODELVERSION=%BASEPROJECTNAME%_%PROJECTNAME%_L05_SC_FM_12864_V107_110720_1150
