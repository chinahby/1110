...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //source/qcom/qct/multimedia/mmservices/mpeg4fileformat/parser/main/latest/src/videofmt_bs.c#2 $
    ...
    while (!exit_loop)
    {
        ...
        case VIDEO_FMT_BS_STATE_GET_DATA:
            ...
            */
            ...
            {
                MSG_ERROR ("video_fmt_bs_process: get_data overrun!",
                           0, 0, 0);
            ...
            */
            if (context->get_data_needed)
            {
                ...
                */
                ...
                {
                    MSG_ERROR ("video_fmt_bs_process: "
                               "unexpected end of data!", 0, 0, 0);
                    video_fmt_bs_failure (context);
                    return;
                }
        ...
        case VIDEO_FMT_BS_STATE_STATEMENT:
            ...
            */
            ...
            case '!': /* unsupported option */
                MSG_ERROR ("video_fmt_bs_process: '!' statement hit "
                           "at pos=%d!",
                           bs_stack_top->syntax_pos, 0, 0);
                video_fmt_bs_failure (context);
                return;
            ...
            default:
                ...
                MSG_ERROR ("video_fmt_bs_process: unknown statement "
                           "type at pos=%d!",
                           bs_stack_top->syntax_pos, 0, 0);
                video_fmt_bs_failure (context);
                return;
        ...
        case VIDEO_FMT_BS_STATE_FIXED_CONST:
            ...
            case 1: /* parse constant name */
                ...
                if (bs_stack_top->syntax_pos >= bs_stack_top->syntax_end)
                {
                    MSG_ERROR ("video_fmt_bs_process: unexpected end of "
                               "syntax at pos=%d!",
                               bs_stack_top->syntax_pos, 0, 0);
                    video_fmt_bs_failure (context);
                    return;
                ...
                {
                    MSG_ERROR ("video_fmt_bs_process: error in bitstream - "
                               "expected single-quoted name at pos=%d!",
                               bs_stack_top->syntax_pos - 1, 0, 0);
                    video_fmt_bs_failure (context);
                    return;
                }
                         ...
                         < bs_stack_top->syntax_end; ++i)
                {
                    ...
                    {
                        MSG_ERROR ("video_fmt_bs_process: name heap "
                                   "overflow at pos=%d",
                                   bs_stack_top->syntax_pos, 0, 0);
                        video_fmt_bs_failure (context);
                        return;
                ...
                */
                ...
                {
                    MSG_ERROR ("video_fmt_bs_process: error in bitstream - "
                               "constant name too long at pos=%d!",
                               bs_stack_top->syntax_pos, 0, 0);
                    video_fmt_bs_failure (context);
                    return;
                }
            ...
            case 3: /* expect constant value */
                ...
                {
                    MSG_ERROR ("video_fmt_bs_process: error in bitstream - "
                               "expected %x at offset %x, but found %x!",
            ...
            case 0: /* parse variable name */
                ...
                */
                    ...
                    (context, &ref_header, &ref_name_length, &ref_body))
                {
                    ...
                    {
                        MSG_ERROR ("video_fmt_bs_process: name referenced "
                                   "at pos=%d is not a variable!",
                                   bs_stack_top->syntax_pos, 0, 0);
                        video_fmt_bs_failure (context);
                        return;
                    }
        ...
        case VIDEO_FMT_BS_STATE_VAR_LENGTH_VAR:
            ...
            case 0: /* parse table name */
                ...
                */
                ...
                {
                    MSG_ERROR ("video_fmt_bs_process: undeclared table "
                               "used at pos=%d",
                               bs_stack_top->syntax_pos, 0, 0);
                    video_fmt_bs_failure (context);
                    return;
            ...
            case 1: /* decode variable-length field */
                ...
                */
                ...
                for (i = 0; i < table_body->rows; ++i)
                {
                        /* this check is to fix critical lint errors */
                        if(i>0) 
                        {
                           if ((temp32 >> (table_body->widest - table_data [i * table_body->columns]))
			          == table_data [i * table_body->columns + 1])
                           {
                             break;
                           }                    
                        }
        ...
        case VIDEO_FMT_BS_STATE_FUNCTION_DECL:
            ...
            */
            ...
            {
                MSG_ERROR ("video_fmt_bs_process: error in bitstream - "
                           "unmatched open-brace at pos=%d!",
                           func_body->start - 1, 0, 0);
                video_fmt_bs_failure (context);
                return;
            }
            ...
            case 0: /* parse function name */
                ...
                */
                if (!video_fmt_bs_locate_name
                    (context, &ref_header, &ref_name_length, &ref_body))
                {
                    MSG_ERROR ("video_fmt_bs_process: undeclared function "
                               "called at pos=%d",
                               bs_stack_top->syntax_pos, 0, 0);
                    video_fmt_bs_failure (context);
                    return;
            ...
            case 1: /* evaluate conditional */
                ...
                */
                else
                {
                    ...
                    if (context->syntax [bs_stack_top->syntax_pos++] != '{')
                    {
                        MSG_ERROR ("video_fmt_bs_process: error in "
        ...
        case VIDEO_FMT_BS_STATE_TABLE:
            ...
            case 2: /*lint!e616 no break for aove case */ /* read table value */
                ...
                if (context->syntax [bs_stack_top->syntax_pos] == '}')
                {
                    ...
                    */
                    ...
                    {
                        MSG_ERROR ("video_fmt_bs_process: "
                                   "missing table elements at pos=%d!",
                                   bs_stack_top->syntax_pos - 1, 0, 0);
                        video_fmt_bs_failure (context);
                        return;
                    }
            ...
            case 3: /* add table value */
                ...
                if (!((bs_stack_top->value [1] - 1) % bs_stack_top->nbits))
                {
                    table_body = bs_stack_top->last_table_body;
                    table_body->widest
                        = MAX (table_body->widest, bs_stack_top->value [0]);
                }
                ...
                if (context->syntax [bs_stack_top->syntax_pos] == '\'')
                {
                    ...
                    */
                    ...
                    if (!video_fmt_bs_locate_name
                        (context, &ref_header, &ref_name_length, &ref_body))
                    {
                        MSG_ERROR ("video_fmt_bs_process: unknown variable "
                                   "referenced at pos=%d",
                                   bs_stack_top->syntax_pos, 0, 0);
                        video_fmt_bs_failure (context);
                        return;
                ...
                */
                    ...
                    || (context->syntax [bs_stack_top->syntax_pos] > '9'))
                {
                    ...
                    */
                    ...
                    {
                        MSG_ERROR ("video_fmt_bs_process: expected decimal "
        ...
        case VIDEO_FMT_BS_STATE_PARSE_VALUE:
            ...
            */
            ...
            default:
                /* If we reach here, there is a typo in the syntax. */
                MSG_ERROR ("video_fmt_bs_process: unknown value "
                           "type at pos=%d!",
                           bs_stack_top->syntax_pos, 0, 0);
                video_fmt_bs_failure (context);
                return;
        ...
        case VIDEO_FMT_BS_STATE_PARSE_HEX:
            ...
            */
            ...
            {
                MSG_ERROR ("video_fmt_bs_process: hexadecimal constant "
                           "exceeds 32 bits at pos=%d!",
                           bs_stack_top->syntax_pos, 0, 0);
                video_fmt_bs_failure (context);
                return;
            }
            ...
            {
                MSG_ERROR ("video_fmt_bs_process: expected hexadecimal "
                           "digit for value field in syntax at pos=%d",
                           bs_stack_top->syntax_pos, 0, 0);
                video_fmt_bs_failure (context);
                return;
            }
        ...
        default:
            ...
            */
            MSG_ERROR ("video_fmt_bs_process: Invalid video "
                       "bitstream services state", 0, 0, 0);
            video_fmt_bs_failure (context);
            return;
        }
    }
...
boolean video_fmt_bs_read_buffer (
  ...
  boolean                    expect_eof
    ...
    */
    ...
    {
        MSG_ERROR ("video_fmt_bs_process: in_buffer too small to "
    ...
    {
        MSG_ERROR ("video_fmt_bs_read_buffer: video bitstream position "
...
uint32 video_fmt_bs_data_out (
  ...
  boolean                    consume
    ...
    while (amount)
    {
        ...
        num_bits = MIN (8 - (offset % 8), amount);
...
boolean video_fmt_bs_parse_nbits (
  video_fmt_bs_context_type  *context
    ...
    {
        MSG_ERROR ("video_fmt_bs_parse_nbits: video bitstream position "
                   "stack overflow", 0, 0, 0);
        video_fmt_bs_failure (context);
        return FALSE;
    }
