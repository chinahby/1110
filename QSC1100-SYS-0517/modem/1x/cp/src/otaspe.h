...
$Header: //source/qcom/qct/modem/1x/cp/rel/1h08/src/otaspe.h#1 $ $DateTime: 2009/05/29 03:54:56 $ $Author: prabhuk $
...
#define OTASP_PREF_ROAM    0xC1
  /* Non-std Preferred Roaming Block */
#else
...
#ifdef FEATURE_NSOTASP
#define OTASP_PROG_LOCK    0xC0
  /* Programming Lock (PL_P_REV) as per Sprint Proposal 7/16/96 */
#else
...
#ifdef FEATURE_NSOTASP
#define OTASP_KEY_EXCHANGE_P_REV 0x01
#define OTASP_NAM_DOWNLOAD_P_REV 0x01
#else
