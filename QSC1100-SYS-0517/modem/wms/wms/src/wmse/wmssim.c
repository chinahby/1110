...
$Header: //source/qcom/qct/modem/wms/wms/rel/qsc1100_05.04.00/src/WMSE/wmssim.c#3 $ $DateTime: 2008/12/02 13:02:59 $ $Author: pyaramad $
...
void wms_sim_gsdi_init(void)
{
...

  {
    ...
    mmgsdi_status = mmgsdi_client_id_reg_set_notify (TRUE, mmgsdi_option, 
