...
$Header: //source/qcom/qct/modem/uim/uimdrv/rel/07H1_2/src/uim.c#20 $ $DateTime: 2009/05/11 12:03:29 $ $Author: shanmugh $
...
/* Indicates we have received a task off from MC.  We must power the interface
   down. */
LOCAL boolean uim_powering_down_task = FALSE;
...
#error code not present
  ...
  nv_cmd_buf.data_ptr = &uim_nv_data_buf ;
  /* Where to return it   */
...
{
  uim_cmd_status_type status;      /* UIM result type */
