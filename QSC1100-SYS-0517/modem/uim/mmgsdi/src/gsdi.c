...
$Header: //source/qcom/qct/modem/uim/mmgsdi/rel/07H1_2/src/gsdi.c#15 $$ $DateTime: 2009/05/15 18:47:30 $
...
#error code not present
    ...
    if (gsdi_is_meid_svc_activated(slot))
    {
      ...
      {
        qw_equ(store_esn_req.meid, meid_nv_data.meid);
