...
$Header: //source/qcom/qct/multimedia/audio/codec/sbc/main/latest/src/audiosbci.h#1 $ $DateTime: 2008/04/24 13:56:20 $ $Author: yuanz $
...
typedef struct {
  ...
  OI_UINT32 min_bitrate;

  OI_UINT32 max_bitrate;

  /* Default mode is Mono */
  OI_UINT8 mode;

  /* Default number of subbands */
  OI_UINT8 num_subbands;
