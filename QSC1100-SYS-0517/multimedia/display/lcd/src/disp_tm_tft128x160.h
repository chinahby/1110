#ifndef __DISP_TM_TFT128X160_H__
#define __DISP_TM_TFT128X160_H__




#define TM_TFT128x160_DISPLAY_ON_C  0x29
#define TM_TFT128x160_DISPLAY_OFF_C  0x28
#define TM_TFT128x160_SET_START_ADDRESS_C   0x2a
#define TM_TFT128x160_SET_END_ADDRESS_C   0x2b
#define TM_TFT128x160_RAM_WRITE_C 0x2c
#define TM_TFT128x160_SOFT_RESET_C 0x01
