...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/wconnect/bthost/soccfg/rel/00.00.26/src/btqsocnvm.c#5 $
  $DateTime: 2009/06/02 14:09:12 $
  $Author: sasthana $
...
/******************************************************************************
                  ...
                  - 32 Mhz Clock: 0D.00
                  ------------- 4025 B1  -------------
                  - 19.2 Mhz Clock: 07.0A (BT 2.1), 17.0B (CLASS 2)
		                            47.0B (BT 2.0)  (05/13/09)
                  - 32 Mhz Clock:   0D.0B (BT 2.1), 1D.0B (CLASS 2)
		                            4D.0C (BT 2.0)  (05/13/09)
                  ----------- 4020BD B1 ------------
...
static bt_qsoc_cfg_cst_element_type bt_qsoc_cfg_tag_17_4025_b1[] = \
{
/* set running baud rate to value defined by BT_QSOC_BAUD_RATE */
#ifdef FEATURE_BT_QSOC_INBAND_SLEEP
  0x0A, 0x01, 0x11, 0x07, 
...
#define CFG_TAG_17_4025_B1   (&bt_qsoc_cfg_tag_17_4025_b1[0]) 
...
static bt_qsoc_cfg_cst_element_type bt_qsoc_cfg_tag_36_4025_b1_CLASS1[] = \
{
  0x26, 0x01, 0x24, 0x23,
  0x09, 0x09, 0x07, 0x04, 0x09, 0x00, 0x01, 0x02, 
  0x03, 0x04, 0x05, 0x06, 0x07, 0x07, 0x07, 0x00, 
...
static bt_qsoc_cfg_cst_element_type bt_qsoc_cfg_tag_72_4025_b1_bt_2_0[] = \
{
  0x19, 0x01, 0x48, 0x16,	
...
#define CFG_TAG_72_4025_B1   (&bt_qsoc_cfg_tag_72_4025_b1_bt_2_0[0]) 
...
#define CFG_TAG_72_4025_B1_RAM_INDEX  (5)  /* #72: HCI supported override */ 
#define CFG_TAG_78_4025_B1_RAM_INDEX  (6)  /* #78: BT LMP version */ 
#define CFG_TAG_97_4025_B1_RAM_INDEX  (7)  /* #97: clock sharing */
   ...
   else
   {
     ...
     {	     
       bt_qsoc_cfg_tbl_4025_b1_ram[CFG_TAG_36_4025_B1_RAM_INDEX] =
	                                  &bt_qsoc_cfg_tag_36_4025_b1_CLASS2[0];
     ...
     {	     
       bt_qsoc_cfg_tbl_4025_b1_ram[CFG_TAG_36_4025_B1_RAM_INDEX] =
	                                  &bt_qsoc_cfg_tag_36_4025_b1_CLASS1[0];       
     }
...
)
{
  ...
  {
    rel_nvm[28]= rel_nvm[39]= rel_nvm[40]= rel_nvm[41]= rel_nvm[42]= 
    rel_nvm[95]= rel_nvm[99]= rel_nvm[100]= rel_nvm[101]= rel_nvm[102]=  
    rel_nvm[103] = rel_nvm[104] = rel_nvm[105]= rel_nvm[109]= rel_nvm[110]= 
    rel_nvm[111]= rel_nvm[112]= rel_nvm[113]= rel_nvm[114]= rel_nvm[115]= 
