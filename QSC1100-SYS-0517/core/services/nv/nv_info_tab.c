...
DESCRIPTION
  ...
  $Header: //source/qcom/qct/core/services/nv/common/main/latest/src/nv_info_tab.c#49 $
...
const nvim_item_info_type nvim_item_info_table[] = {
      ...
      ,{ sizeof(nvi_boolean_type), 0, 1}
      ,{ sizeof(nv_voc_pcm_path_cal_type), 0, 1}
      ,{ sizeof(nv_voc_pcm_path_cal_type), 0, 1}
      ,{ sizeof(nv_voc_pcm_path_cal_type), 0, 1}
      ,{ sizeof(nv_qdsp_cmd_ec_params_type), 0, 1}
      ,{ sizeof(nv_qdsp_cmd_ec_params_type), 0, 1}
      ,{ sizeof(nv_qdsp_cmd_ec_params_type), 0, 1}
      ,{ sizeof(nv_qdsp_cmd_ec_params_type), 0, 1}      
