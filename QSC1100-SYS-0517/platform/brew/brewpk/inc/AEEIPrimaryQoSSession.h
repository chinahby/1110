#ifndef AEEIPRIMARYQOSSESSION_H
#define AEEIPRIMARYQOSSESSION_H
/*======================================================
FILE:  AEEIPrimaryQoSSession.h
...
#define AEEIID_IPrimaryQoSSession 0x0104564e
...
Members:
   AEE_PRIMARY_QOS_MODIFY_ACCEPTED_EV:
      ...
      request that has previously returned AEE_NET_SUCCESS, and indicates that the
...
BREW 4.0 - AEEIPrimaryQoSSession.h
BREW 3.1 - AEEPrimaryQoSSession.h
...
Description:
   ...
   After IPrimaryQoSSession_Modify() returns AEE_NET_SUCCESS, the client should listen
   (see IPrimaryQoSSession_AddListener()) for Primary QoS events:
...
Return Value:
   ...
   AEE_EPRIVLEVEL: application does not have privileges to modify Primary QoS
