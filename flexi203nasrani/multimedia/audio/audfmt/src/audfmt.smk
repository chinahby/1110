...
#
# PURPOSE:
#    Makefile script for the audfmt sub-build 
#
# DESCRIPTION:
...
SMK_CINCPATH := $(AUDFMT_CINCPATH)

# List of assembler include header directory search paths
SMK_AINCPATH := $(AUDFMT_AINCPATH)
