...
$Header: //source/qcom/qct/wconnect/bthost/brew/statapp/rel/00.00.26/src/BTAppPBAP.c#2 $
...
static void BTApp_PBAPBuildClientDownloadSubMenu( CBTApp* pMe )
{
  ...
  BTApp_InitAddItem( &ai );
  // set the title
  IMENUCTL_SetTitle( pMe->m_pIMenu, AEE_APPSBTAPP_RES_FILE, 
...
static void BTApp_PBAPBuildvCardFormatMenu( CBTApp* pMe )
{
  ...
  BTApp_InitAddItem( &ai );
  // set the title
  IMENUCTL_SetTitle( pMe->m_pIMenu, AEE_APPSBTAPP_RES_FILE, IDS_PBAP_VCARD_FORMAT, 
                     NULL );
...
static void BTApp_PBAPBuildClientMenu(CBTApp * pMe)
{
  ...
  {
    IMENUCTL_SetTitle( pMe->m_pIMenu, AEE_APPSBTAPP_RES_FILE, IDS_PBAP_CLIENT, NULL );
  }
...
static void BTApp_PBAPBuildServerMenu(CBTApp * pMe)
{
  ...
  {
    IMENUCTL_SetTitle( pMe->m_pIMenu, AEE_APPSBTAPP_RES_FILE, IDS_PBAP_SERVER, NULL );
  }
...
void BTApp_PBAPBuildMainMenu( CBTApp* pMe )
{
  ...
  // set the title
  IMENUCTL_SetTitle( pMe->m_pIMenu, AEE_APPSBTAPP_RES_FILE, IDS_PBAP_TESTS, NULL );
