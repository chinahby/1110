...
/*===========================================================================
 ...
 $Header: //depot/asic/msmshared/services/tokenbucket/token_bucket.c#2 $ $DateTime: 2006/07/11 16:23:22 $ $Author: vparadka $
...
)
{
  ...
  {
    ERR_FATAL("Failed to initialize token bucket, invalid parameter(s)",0,0,0);
    return;
  }
  ...
  -------------------------------------------------------------------------*/
  token_bucket_set_tokens_per_second(token_bucket, tokens_per_second);

  token_bucket_set_max_tokens(token_bucket, max_tokens);
  ...
  -------------------------------------------------------------------------*/
  clk_read_ms(token_bucket->timestamp);
...
===========================================================================*/
extern boolean token_bucket_get_tokens
(
  token_bucket_type *token_bucket,
  uint32             tokens_req
)
{
  ...
  {
    ERR_FATAL("Null token bucket passed to token_bucket_get_token()",0,0,0);
    return FALSE;
  }

  if(tokens_req > (token_bucket->max_tokens_precision_m >> token_bucket->m))
  {
    ERR_FATAL("Number of tokens required greater than max_tokens in bucket",
               0,0,0);
    return FALSE;
  }
  clk_read_ms(current_time);
...
SIDE EFFECTS
  ...
  Sets the timestamp of the token bucket to current time.
===========================================================================*/
extern boolean token_bucket_get_token
(
  token_bucket_type *token_bucket
)
{
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean token_bucket_set_max_tokens
(
  token_bucket_type *token_bucket,
  uint32             max_tokens
)
{
  ...
  {
    ERR_FATAL("Invalid parameter(s) to token_bucket_set_max_tokens()",0,0,0);
    return FALSE;
  }
...
SIDE EFFECTS
  None
===========================================================================*/
extern boolean token_bucket_set_tokens_per_second
(
  token_bucket_type *token_bucket,
  uint32             tokens_per_second
)
{
  ...
  {
    ERR_FATAL("Invalid parameter(s) to token_bucket_set_ms_per_token()",0,0,0);
    return FALSE;
  }
