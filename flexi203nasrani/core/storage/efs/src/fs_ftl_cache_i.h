 ...
 *
 * Copyright (C) 2006-2009 Qualcomm, Inc.  All Rights Reserved
 *
 *****************************************************************************/
...
/*=============================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_ftl_cache_i.h#3 $
  $DateTime: 2009/07/06 18:30:05 $
  $Author: ebuller $
...
#else
  #define FTL_FLASH_MAX_PAGE_SIZE            2048
#endif
