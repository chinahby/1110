...
static const AECHAR Currency_NegativePattern []           = {'R','s','#','-',0 }; 
static const AECHAR Currency_PositivePattern[]            = {'R','s','#',0 }; 
static const AECHAR Currency_CurrencySymbol[]             = {'R','s',0 }; 
...
static const AECHAR DateTime_ShortMonthNames[] = {
	0x062C,0x0646,0x0648,0x0631,0x0649,0, 
	0x067F,0x0631,0x0648,0x0631,0x0649,0, 
	0x0645,0x0627,0x0631,0x0686,0,
	0x0627,0x067E,0x0631,0x064A,0x0644,0,
	0x0645,0x0626,0,
	0x062C,0x0648,0x0646,0,
	0x062C,0x0648,0x0644,0x0627,0x0678,0,
	0x0627,0x06AF,0x0633,0x062A,0,
	0x0633,0x062A,0x0645,0x0628,0x0631,0,
	0x0627,0x06A9,0x062A,0x0648,0x0628,0x0631,0,
	0x0646,0x0648,0x0645,0x0628,0x0631,0,
	0x062F,0x0633,0x0645,0x0628,0x0631,0,
   0 };

static const AECHAR DateTime_DayNames[] = {
	0x067E,0x06CC,0x0631,0,
	0x0645,0x0646,0x06AF,0x0644,0,
	0x0628,0x062F,0x06BE,0,
	0x062C,0x0645,0x0639,0x0631,0x0627,0x062A,0,
	0x062C,0x0645,0x0639,0x06C1,0,
	0x06C1,0x0641,0x062A,0x06C1,0,
	0x0627,0x062A,0x0648,0x0627,0x0631,0,
   0 };
...
/* -----------------------------------------------------------------------
    LocaleUR_Ctor 
   --- */
static void LocaleUR_Ctor(LocaleUR *pMe, AEEVTBL(ILocale) *pvt, IShell *piShell, IModule *piModule)
{
...
/* -----------------------------------------------------------------------
    LocaleUR_New  
   --- */
int LocaleUR_New(ILocale **ppo, IShell *piShell, IModule *piModule)
{
   LocaleUR *pMe;
   ...
   pMe = MALLOCREC_VTBL(LocaleUR, ILocale);
   if (!pMe) {
      return ENOMEMORY;
   }
   LocaleUR_Ctor(pMe,GETVTBL(pMe,ILocale),piShell,piModule); 
...
int LocaleUR_CreateInstance(IModule *module, IShell *shell, AEECLSID idClass, void **pp)
{
   if (idClass == AEECLSID_LOCALEUR) {
      return LocaleUR_New((ILocale **)pp, shell, module);
   }
   *pp = 0;
