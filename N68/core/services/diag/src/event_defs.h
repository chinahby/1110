...
$Header: //depot/asic/msmshared/services/diag/event_defs.h#258 $
...
typedef enum
{
  ...
  EVENT_CM_COUNTRY_SELECTED,              /* 6 byte payload */
  EVENT_CM_SELECT_COUNTRY,                /* 8 byte payload */
  ...
  EVENT_LTE_RACH_ACCESS_PROBLEM,          /* No payload */
  ...
  EVENT_IRAT_RESEL_FROM_EUTRAN,            /* 1 byte payload */
