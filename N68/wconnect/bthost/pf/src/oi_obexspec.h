...
#else
// Image
#define OI_OBEX_IMAGE_X_JPEG_TYPE			"image/x-jpeg"
#define OI_OBEX_IMAGE_X_GIF_TYPE			"image/x-gif"
#define OI_OBEX_IMAGE_X_PNG_TYPE			"image/x-png"
#define OI_OBEX_IMAGE_X_BMP_TYPE			"image/x-bmp"
#define OI_OBEX_IMAGE_X_VNDWAPWBMP_TYPE		"image/x-vnd.wap.wbmp"
#define OI_OBEX_IMAGE_X_UPWPNG_TYPE			"image/x-up-wpng"
#define OI_OBEX_IMAGE_BMP_TYPE				"image/bmp"
#define OI_OBEX_IMAGE_WBMP_TYPE				"image/wbmp"
#define OI_OBEX_IMAGE_BITMAP_TYPE			"image/bitmap"
#define OI_OBEX_IMAGE_GIF_TYPE				"image/gif"
#define OI_OBEX_IMAGE_PJPEG_TYPE			"image/pjpeg"
#define OI_OBEX_IMAGE_PNG_TYPE				"image/png"
#define OI_OBEX_IMAGE_VPNG_TYPE				"image/vnd.vzw-pixframe.png"
#define OI_OBEX_IMAGE_TIFF_TYPE				"image/tiff"
#define OI_OBEX_IMAGE_X_TIFF_TYPE			"image/x-tiff"
#define OI_OBEX_IMAGE_VWBMP_TYPE			"image/vnd.wap.wbmp"
#define OI_OBEX_IMAGE_JPG_TYPE				"image/jpg"
#define OI_OBEX_IMAGE_BCI_TYPE				"image/bci"
#define OI_OBEX_UPF_TYPE					"image/x-UPF"
#define OI_OBEX_JPEG_TYPE					"image/jpeg"

// Video
#define OI_OBEX_VIDEO_X_MPEG4AAC_TYPE 		"video/x-mpeg4aac"
#define OI_OBEX_VIDEO_X_MPEG4AMR_TYPE 		"video/x-mpeg4amr"
#define OI_OBEX_VIDEO_X_MS_WMV_TYPE			"video/x-ms-wmv"
#define OI_OBEX_VIDEO_MP4_TYPE				"video/mp4"
#define OI_OBEX_VIDEO_3GPP_TYPE 			"video/3gpp"
#define OI_OBEX_VIDEO_3GPP2_TYPE			"video/3gpp2"
#define OI_OBEX_VIDEO_MPEG_TYPE				"video/mpeg"
#define OI_OBEX_VIDEO_X_MPEG_TYPE			"video/x-mpeg"
#define OI_OBEX_VIDEO_WMA_TYPE				"video/wma"
#define OI_OBEX_VIDEO_PMD_TYPE				"video/pmd"
#define OI_OBEX_VIDEO_WMV_TYPE				"video/wmv"
#define OI_OBEX_VIDEO_SVG_TYPE				"video/svg"
#define OI_OBEX_VIDEO_SVGZ_TYPE				"video/svgz"
#define OI_OBEX_VIDEO_RM_TYPE				"video/rm"
#define OI_OBEX_VIDEO_ASF_TYPE				"video/wmv"

// Audio
#define OI_OBEX_AUDIO_X_WMA_TYPE			"audio/x-wma"
#define OI_OBEX_AUDIO_X_MID_TYPE			"audio/x-mid"
#define OI_OBEX_AUDIO_X_MIDI_TYPE 			"audio/x-midi"
#define OI_OBEX_AUDIO_X_MPEG4AAC_TYPE 		"audio/x-mpeg4aac"
#define OI_OBEX_AUDIO_MP4_TYPE				"audio/mp4"
#define OI_OBEX_AUDIO_3GPP_TYPE				"audio/3gpp"
#define OI_OBEX_AUDIO_3GPP2_TYPE 			"audio/3gpp2"
#define OI_OBEX_AUDIO_AMR_TYPE				"audio/amr"
#define OI_OBEX_AUDIO_X_MSWMA_TYPE			"audio/x-ms-wma"
#define OI_OBEX_AUDIO_MID_TYPE				"audio/mid"
#define OI_OBEX_AUDIO_MIDI_TYPE 			"audio/midi"
#define OI_OBEX_AUDIO_XMF_TYPE				"audio/xmf"
#define OI_OBEX_AUDIO_AAC_TYPE				"audio/aac"
#define OI_OBEX_AUDIO_PMD_TYPE				"audio/pmd"
#define OI_OBEX_AUDIO_QCP_TYPE				"audio/qcp"
#define OI_OBEX_AUDIO_VND_QCELP_TYPE		"audio/vnd.qcelp"
#define OI_OBEX_AUDIO_IMELODY_TYPE			"audio/imelody"
#define OI_OBEX_AUDIO_MP3_TYPE				"audio/mp3"
#define OI_OBEX_AUDIO_MPEG3_TYPE			"audio/mpeg3"
#define OI_OBEX_AUDIO_MPEG_TYPE				"audio/mpeg"
#define OI_OBEX_AUDIO_X_MPEG_TYPE 			"audio/x-mpeg"
#define OI_OBEX_AUDIO_X_MPEG3_TYPE			"audio/x-mpeg3"
#define OI_OBEX_AUDIO_X_MPEG_3_TYPE 		"audio/x-mpeg-3"
#define OI_OBEX_AUDIO_X_AAC_TYPE			"audio/x-aac"
#define OI_OBEX_AUDIO_WAV_TYPE				"audio/wav"
#define OI_OBEX_AUDIO_X_WAV_TYPE			"audio/x-wav"
#define OI_OBEX_AUDIO_QCF_TYPE				"audio/qcf"
#define OI_OBEX_AUDIO_MMF_TYPE				"audio/mmf"
#define OI_OBEX_AUDIO_SPF_TYPE				"audio/spf"
#define OI_OBEX_AUDIO_IMY_TYPE				"audio/imy"
#define OI_OBEX_AUDIO_WMA_TYPE				"audio/wma"
#define OI_OBEX_AUDIO_HVS_TYPE				"audio/hvs"
#define OI_OBEX_AUDIO_SAF_TYPE				"audio/saf"
#define OI_OBEX_AUDIO_MXMF_TYPE				"audio/mxmf"
#define OI_OBEX_AUDIO_XMF0_TYPE				"audio/xmf0"
#define OI_OBEX_AUDIO_XMF1_TYPE				"audio/xmf1"
#define OI_OBEX_AUDIO_DLS_TYPE				"audio/dls"
#define OI_OBEX_AUDIO_RHZ_TYPE				"audio/rhz"

// Application
#define OI_OBEX_APP_HUCHKEY_TYPE			"application/x-h3g-hutchkey"
#define OI_OBEX_APP_DRM_MMT_TYPE			"application/x-h3g-drm-mmt"
#define OI_OBEX_APP_DRM_MMA_TYPE			"application/x-h3g-drm-mma"
#define OI_OBEX_APP_DRM_MMV_TYPE			"application/x-h3g-drm-mmv"
#define OI_OBEX_APPLICATION_X_PMD_TYPE		"application/x-pmd"
#define OI_OBEX_APPLICATION_X_CMX_TYPE		"application/x-cmx"
#define OI_OBEX_APPLICATION_X_QCP_TYPE		"application/x-qcp"
#define OI_OBEX_APPLICATION_JAD_TYPE		"text/vnd.sun.j2me.app-descriptor"
#define OI_OBEX_APPLICATION_JAR_TYPE		"application/java-archive"
#define OI_OBEX_APPLICATION_DOC_TYPE        "application/msword"
#define OI_OBEX_APPLICATION_PDF_TYPE        "application/PDF"
#define OI_OBEX_APPLICATION_EXCEL_TYPE      "application/msexcel"

// Text
#define OI_OBEX_TEXT_X_IMELODY_TYPE			"text/x-imelody"
#define OI_OBEX_ICALENDAR_TYPE				"text/calendar"
#define OI_OBEX_VCARD_TYPE					"text/x-vcard"
#define OI_OBEX_VCALENDAR_TYPE				"text/x-vcalendar"
#define OI_OBEX_VNOTE_TYPE					"text/x-vnote"
