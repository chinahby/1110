...
$Header: //source/qcom/qct/wconnect/bthost/brew/ibt/rel/00.00.26/src/OEMBTSPP.c#5 $ 
$DateTime: 2009/07/23 18:35:57 $
$Author: c_bhatg $

  when        who  what, where, why
  ----------  ---  ------------------------------------------------------------
  2009-07-23   gb  Fixed problem with invalid pointer access during cancel server
                   search  
  2009-06-16   gb  Fixed problem with extra line inclusion in previos check in  
  2009-06-12   gb  Watermark values chnaged  to ensure the space between HI 
                   watermark and MAX watermark is high enough to hold atleast 
                   one RFCOMM frame  
...
#ifndef BT_SIMULATION
#define WATERMARK_HI           8000
#define WATERMARK_LO           6000
#define WATERMARK_MAX         12000
#else
