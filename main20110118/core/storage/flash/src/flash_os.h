...
/*===========================================================================
  ...
  $Header: //depot/asic/msmshared/drivers/flash/MSM_FLASH.01.04/flash_os.h#8 $ $DateTime: 2009/09/10 02:31:40 $ $Author: rpulyala $

when         who     what, where, why
--------     ---     ----------------------------------------------------------
2009-03-27   rk      Added macro FLASH_BSP_QRTZ_GET_PHYS for bsp_quartz_get_phys
...
#if defined(QUARTZ_BSP)
  #include "bsp_quartz.h"
  #define FLASH_BSP_QUARTZ_GET_PHYS(addr) bsp_quartz_get_phys((uint32)addr)
#else
  #define FLASH_BSP_QUARTZ_GET_PHYS(addr) ((uint32)addr)
#endif
