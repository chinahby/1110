...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //source/qcom/qct/multimedia/audio/6k/ver1/audfmt/main/latest/src/audwma.c#4 $
   
when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/03/09   kkm     When length is sent as 0 during flush, it is considered as error 
                   and loaded flag of buffer is not getting cleared. Due to this data
                   is expecting from QTV. QTV sends length 0 when there is a flush
                   so this is not an error case. So length checking is removed. CR#181968
