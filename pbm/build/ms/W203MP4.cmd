...
@set BASEPROJECTNAME=W203MP4
@set QUALCOMMNAME=SBNAALZ
@set QUALCOMMNAME_BUILD=SXNAALZ
@set RESOURCEDIR=common
@set MODELVERSION=%BASEPROJECTNAME%_CAM_FM_BT_MP4_V1.0
