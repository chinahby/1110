...
#
# PURPOSE:
#    Makefile script for the videofmt sub-build 
#
# DESCRIPTION:
...
#
#         make -f videofmt.smk [make-target] 
#
...
SMK_CDEFINES := $(VIDEOFMT_MSG_LVL) $(VIDEOFMT_MSG_CATEGORY)
...
SMK_CINCPATH := $(VIDEOFMT_CINCPATH)

# List of assembler include header directory search paths
SMK_AINCPATH := $(VIDEOFMT_AINCPATH)
