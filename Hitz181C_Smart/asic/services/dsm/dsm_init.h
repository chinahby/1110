...
/*===========================================================================
  ...
  $Header: //depot/asic/msm6800b/services/dsm/dsm_init.h#3 $
...
#define DSM_DIAG_ITEM_POOL ((dsm_mempool_id_type)(&dsm_diag_item_pool))
extern dsm_pool_mgmt_table_type dsm_diag_item_pool;
...
#define DSM_DIAG_ITEM_SIZ                                                   \
    (DSM_POOL_ITEM_SIZE(DSM_DIAG_ITEM_POOL)) 
#define DSM_DIAG_ITEM_CNT                                                   \
    (DSM_POOL_ITEM_CNT(DSM_DIAG_ITEM_POOL))
