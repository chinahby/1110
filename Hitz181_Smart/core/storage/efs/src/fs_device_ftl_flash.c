...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_device_ftl_flash.c#4 $ $DateTime: 2008/12/15 14:17:12 $ $Author: richardp $
...
fs_device_ftl_flash_init (void)
{
  ...
  fs_paranoia_register (fs_base_ftl_device, sizeof(fs_base_ftl_device),
                        "ftl-dev");
}
