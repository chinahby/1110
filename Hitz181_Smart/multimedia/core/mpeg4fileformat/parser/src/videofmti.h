...
/*===========================================================================
                  ...
                  V I D E O   F O R M A T S   I N T E R N A L
                          H E A D E R    F I L E

DESCRIPTION
  This header file contains all the internal definitions to the video formats
  services.
...
/* <EJECT> */
/*---------------------------------------------------------------------------
** VIDEOFMT Private Function Prototypes
**---------------------------------------------------------------------------
*/
