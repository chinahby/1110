...
#if defined(FEATURE_ADDRBOOK) && !defined(USES_MMI)
...
#if defined(FEATURE_IWMSDIAG) && !defined(USES_MMI) 
...
// Dialer app
#if defined (FEATURE_APP_DIALER) && !defined(FEATURE_MANGO_UI) && !defined (USES_MMI)
