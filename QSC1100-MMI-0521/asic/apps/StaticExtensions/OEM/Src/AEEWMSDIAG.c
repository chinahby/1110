...
$Header: //depot/asic/qsc60x0/apps/StaticExtensions/OEM/Src/AEEWMSDIAG.c#1 $
...
=========================================================================*/
int AEEWMSDIAG_CbSaveResponse (IWMSDIAG *pMe, AEEWMSDIAGSaveCbRsp *rsp_pkt);
...
=========================================================================*/
int AEEWMSDIAG_CbReadResponse (IWMSDIAG *pMe, uint16 payloadSize, AEEWMSDIAGReadCbRsp *rsp_pkt);


/*=========================================================================
PACKET    AEEWMSDIAG_CbDeleteAllResponse
...
RESPONSE  Sends back a delayed response to the DM with the appropriate field
          values
=========================================================================*/
int AEEWMSDIAG_CbDeleteAllResponse (IWMSDIAG *pMe, AEEWMSDIAGDeleteAllCbRsp *rsp_pkt);
...
static const AEEVTBL(IWMSDIAG) gAEEWMSDIAGFuncs =
{
   ...
   AEEWMSDIAG_CbSaveResponse,
   AEEWMSDIAG_CbReadResponse,
   AEEWMSDIAG_CbDeleteAllResponse,
   AEEWMSDIAG_EventCbSmsNotify
};
...
static void OEM_FREEWMSDIAGNotifier()
{
  ...
  {
    aee_forcereleaseobj((void *)&IWMSDIAGNotifierObj);
...
static void OEM_FREEWMSDIAG()
{
  if (IWMSDIAGobj != NULL)
  {
    aee_forcereleaseobj((void *)&IWMSDIAGobj);
    IWMSDIAGobj = NULL;
  }
}
...
/*===========================================================================
FUNCTION: AEEWMSDIAG_CbDeleteAllResponse
...
{
  /* Pass Through to OEMWMSDIAG Function */
  return OEMWMSDIAG_CbDeleteAllResponse(rsp_pkt);
}
