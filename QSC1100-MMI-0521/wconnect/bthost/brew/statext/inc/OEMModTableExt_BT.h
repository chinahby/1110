...
#if defined(FEATURE_BMP) && defined(FEATURE_BT_EXTPF_FTP)
...
#ifdef FEATURE_BT_AVRCP_13
extern int AEEBTAVRCPMetadataTarget_New(IShell* piShell, AEECLSID cls, void** ppif);
#endif /* FEATURE_BT_AVRCP_13 */
#if defined(FEATURE_BMP) && defined(FEATURE_BT_EXTPF_FTP)
extern int AEEBTFTPClient_New(IShell* piShell, AEECLSID clsid, void** ppif);
#endif
#endif
/*======================================================
...
#if defined(FEATURE_IBT_DYNAMIC) && defined(FEATURE_BMP) && defined(FEATURE_BT_EXTPF_FTP)
#  define BT_QBT_DYNAMIC_CLASS_LIST_ENTRY_IBTFTPClient \
...
#ifdef FEATURE_IBT_DYNAMIC
#ifdef FEATURE_BT_AVRCP_13
#define BT_DYNAMIC_CLASS_LIST_ENTRY \
...
#define BT_STATIC_CLASS_LIST_ENTRY \
   ...
   BT_DYNAMIC_CLASS_LIST_ENTRY \
   BT_QBT_DYNAMIC_CLASS_LIST_ENTRY_IBTFTPClient \
