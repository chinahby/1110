...
enum
{
    ...
    BTM_ERR_PROCESSING,                 /* Generic error                     */
    ...
    BTM_RE_SEND_CMD,                    /* request the btm user to resend the cmd */
    BTM_DELAY_CHECK                     /* delay the check on encryption */
};
...
/* Bits 2-7 meaningful    */
#define COD_MINOR_WRIST_WATCH           0x04
#define COD_MINOR_PAGER                 0x08
#define COD_MINOR_JACKET                0x0C
#define COD_MINOR_HELMET                0x10
#define COD_MINOR_GLASSES               0x14

/* minor device class field for Toy Major Class */
/* Bits 2-7 meaningful    */
#define COD_MINOR_ROBOT                 0x04
#define COD_MINOR_VEHICLE               0x08
#define COD_MINOR_DOLL_ACTION_FIGURE    0x0C
#define COD_MINOR_CONTROLLER            0x10
#define COD_MINOR_GAME                  0x14
...
#define BTM_EIR_OOB_BD_ADDR_TYPE            0x0C   /* 6 bytes */
#define BTM_EIR_OOB_COD_TYPE                0x0D   /* 3 bytes */
#define BTM_EIR_OOB_SSP_HASH_C_TYPE         0x0E   /* 16 bytes */
#define BTM_EIR_OOB_SSP_RAND_R_TYPE         0x0F   /* 16 bytes */
...
#define BTM_OOB_COD_SIZE            3
#define BTM_OOB_HASH_C_SIZE         16
#define BTM_OOB_RAND_R_SIZE         16
...
#if (BTM_LISBON_INCLUDED == TRUE)&&(BTM_EIR_CLIENT_INCLUDED == TRUE)
...
#define BTM_SEC_SERVICE_FIRST_EMPTY     43

#ifndef BTM_SEC_MAX_SERVICES
#define BTM_SEC_MAX_SERVICES            57
#endif
...
**
*******************************************************************************/
BTM_API extern tBTM_STATUS BTM_SyncStack(tBTM_SW_DIR sync_dir, tBTM_SYNC_STACK_CBACK p_sync_callback);
