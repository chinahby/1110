...
#define BTA_AV_METADATA_CMD_EVT 17      /* metadata command */
#define BTA_AV_METADATA_RSP_EVT 18      /* metadata response */
#define BTA_AV_REJECT_EVT       19      /* incoming connection rejected */
...
typedef struct
{
    ...
    tBTA_AV_STATUS  status;
    BOOLEAN         starting;
    BOOLEAN         edr;        /* TRUE, if EDR is supported by the peer device */
} tBTA_AV_OPEN;
...
typedef tBTA_AV_VENDOR                  tBTA_AV_METADATA;
typedef tAVRC_META_HEADER               tBTA_META_HEADER;
typedef tAVRC_META_CAPABILITY           tBTA_META_CAPABILITY;
typedef tAVRC_META_APPSETTING           tBTA_META_APPSETTING;      
typedef tAVRC_META_PLAYERAPPSETTING     tBTA_META_PLAYERAPPSETTING;
typedef tAVRC_META_CHARACTERSET         tBTA_META_CHARACTERSET;
typedef tAVRC_META_BATSTAT              tBTA_META_BATSTAT;
typedef tAVRC_META_STRING               tBTA_META_STRING;
typedef tAVRC_META_MEDIA_INFO           tBTA_META_MEDIA_INFO;
typedef tAVRC_META_ELEMENT_ATTRIBUTES   tBTA_META_ELEMENT_ATTRIBUTES;
typedef tAVRC_META_PLAYSTATUS           tBTA_META_PLAYSTATUS;
typedef tAVRC_META_NOTIFICATION         tBTA_META_NOTIFICATION;
typedef tAVRC_META_CONTINUATION         tBTA_META_CONTINUATION;
typedef tAVRC_META_GROUP_NAVIGATION     tBTA_META_GROUP_NAVIGATION;
typedef tAVRC_META_ERRORSTATUS          tBTA_META_ERRORSTATUS;
typedef tAVRC_META_MSGS                 tBTA_AV_META_MSGS;    
...
typedef union
{
    ...
    tBTA_AV_PEND        pend;
    tBTA_AV_METADATA    metadata_cmd;
    tBTA_AV_METADATA    metadata_rsp;
    tBTA_AV_REJECT      reject;
} tBTA_AV;

#define BTA_METADATA_CMD               AVRC_METADATA_CMD
#define BTA_METADATA_RESP              AVRC_METADATA_RESP
...
#define BTA_ERROR_INVALID_CMD           AVRC_META_ERROR_INVALID_COMMAND         
#define BTA_ERROR_INVALID_PARAM         AVRC_META_ERROR_INVALID_PARAM           
#define BTA_ERROR_BAD_CONTENTS          AVRC_META_ERROR_BAD_CONTENTS            
#define BTA_ERROR_INTERNAL              AVRC_META_ERROR_INTERNAL                

#define BTA_AV_META_SINGLE_PACKET       AVRC_META_PKT_SINGLE
...
/*******************************************************************************
**
** Function         BTA_AvMetadataCmd
**
** Description      Send a Metadata command.  This
**                  function can only be used if AV is enabled with feature
...
**
*******************************************************************************/
BTA_API void BTA_AvMetadataCmd(UINT8 rc_handle, UINT8 label, tBTA_AV_CODE cmd_code,
                               tBTA_AV_META_MSGS *p_params, UINT8 *p_data);

/*******************************************************************************
**
** Function         BTA_AvMetadataRsp
**
** Description      Send a Metadata response.  This
**                  function can only be used if AV is enabled with feature
**                  BTA_AV_FEAT_METADATA.
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_AvMetadataRsp(UINT8 rc_handle, UINT8 label, tBTA_AV_CODE rsp_code,
                               tBTA_AV_META_MSGS *p_params, UINT8 *p_data);

/*******************************************************************************
**
** Function         BTA_AvMetadataParse
**
** Description      Parse the received metadata vendor_dependent_data field. This
**                  function can only be used if AV is enabled with feature
**                  BTA_AV_FEAT_METADATA.
**
** Returns          void
**
*******************************************************************************/
BTA_API UINT8 BTA_AvMetadataParse(UINT8 *p_data, UINT16 len, tBTA_AV_CODE ctype,
                         tBTA_AV_EVT event, tBTA_AV_META_MSGS *p_params);

/*******************************************************************************
**
** Function         BTA_AvMetadataIsFrag
**
** Description      This function returns the Metadata fragmentation status. This
**                  function can only be used if AV is enabled with feature
**                  BTA_AV_FEAT_METADATA.
**
** Returns          BOOLEAN         
**
*******************************************************************************/
BTA_API BOOLEAN BTA_AvMetadataIsFrag(UINT8 rc_handle);
