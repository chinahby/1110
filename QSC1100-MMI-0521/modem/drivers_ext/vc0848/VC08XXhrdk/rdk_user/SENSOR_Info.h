...
typedef void	(*PSnrEnvironment)(UINT8 val);
typedef void	(*PSnrBanding)(UINT8 val);
...
void SensorSetBrightness_OV2650_YUV(UINT8 val); 
void SensorSetBanding_OV2650_YUV(UINT8 val);
void SensorSetEnvironment_OV2650_YUV(UINT8 val);
...
//	PSnrSwitchSize			snrSwitchSizeCall;		//不用了，要删除掉
	...
	PSnrEnvironment      snrEnvironmentCall;
	PSnrBanding          snrBandingCall;
	PSnrGetEt			snrGetEt;
	PSnrSetEt			snrSetEt;
