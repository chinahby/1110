...
#ifdef CUST_EDITION
  byte                  file_char;       /* file caracteristics */
  byte                  num_df;       /* number of DFs */
  byte                  num_ef;       /* number of EFs */
  byte                  num_chv;       /* number of CHV and Unblock CHV */
  byte                  rfuh;       /*  */
  byte                  chv1_status;       /* CHV1 status */
  byte                  uchv1_status;       /* Unblock CHV1 Status */
  byte                  chv2_status;       /* CHV2 status */
  byte                  uchv2_status;       /* Unblock CHV2 Status */
#endif  
