...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/hfat/main/latest/inc/hfat_api_f.h#6 $ $DateTime: 2009/01/30 12:47:45 $ $Author: richardp $
 ...
 ***************************************************************************/
  ...
  extern int fm_gettimedate (const char *filename, unsigned short *pctime,
                             unsigned short *pcdate);
  extern int fm_settimedate (const char *filename, unsigned short ctime,
  ...
  extern int fm_wgettimedate (const wchar * filename, unsigned short *pctime,
                              unsigned short *pcdate);
  extern int fm_wsettimedate (const wchar * filename, unsigned short ctime,
                              unsigned short cdate);
