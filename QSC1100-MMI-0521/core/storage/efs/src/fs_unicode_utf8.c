...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_unicode_utf8.c#2 $ $DateTime: 2008/07/31 16:33:33 $ $Author: richardp $
 ...
 */
static UTF16 OEM_code_page_437[] = {
                           ...
                           UTF16 *utf16_name)
{
  ...
  memcpy (sname, shortname->name, sizeof(sname));
...
struct unicode_conversion_ops fs_convert_utf8 = {
  utf8_to_utf16,
  utf8_from_utf16,
  utf16_to_shortname,
 ...
 */
struct unicode_conversion_ops fs_convert_utf8_sjis = {
  utf8_to_utf16,
  utf8_from_utf16,
