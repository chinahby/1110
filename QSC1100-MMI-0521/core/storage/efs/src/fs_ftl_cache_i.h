 ...
 *
 * Copyright (C) 2006, 2007, 2008 Qualcomm, Inc.  All Rights Reserved
 *
 *****************************************************************************/
...
/*=============================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_ftl_cache_i.h#1 $
  $DateTime: 2008/05/29 19:19:11 $
  $Author: richardp $
...
#ifndef FTL_CACHE_PAGE_COUNT
  /* This is in order to support 4k page device */
  #ifndef MAX_SECTORS_PER_DEV_PAGE
    #define MAX_SECTORS_PER_DEV_PAGE              8
  #endif

  #define MAX_SECTORS_PER_BLOCK   (FS_MAX_PAGES_PER_BLOCK  \
...
#define MAX_FTL_BUFFER_LIST      ( (FS_MAX_PAGES_PER_BLOCK * \
                                    MAX_SECTORS_PER_DEV_PAGE) + 1)
...
static
cached_page_type * lookup_sector_in_cache (ftl_cache_data *pt,
                                           uint32 sector);

static
block_cache_type * lookup_block_in_cache (ftl_cache_data *pt,
                                          uint32 block);
...
static
cached_page_type * get_free_cache_page (ftl_cache_data *pt);
...
static
block_cache_type * alloc_cached_block (ftl_cache_data *pt);

static
int flush_block_cache (ftl_cache_data *pt,
                       block_cache_type * blk_cache);

static
int add_page_to_cache (ftl_cache_data *pt,
                       cached_page_type * new_cached_page);

static
uint32 cache_sync_oldest_block (ftl_cache_data *pt);
