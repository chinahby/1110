...
$Header: //source/qcom/qct/multimedia/audio/6k/ver1/avs/main/latest/src/sndhwg2.c#31 $ $DateTime: 2009/05/19 01:56:25 $ $Author: mkiran $
...
void sndhw_voc_module_fetched(void)
{
	...
	/*while the Vocoder informed about module availability, sound settings changed*/
...
#ifdef FEATURE_AUDIO_FORMAT
    	 rex_set_sigs( &snd_tcb, SND_VOC_MODULE_STATUS );
#endif
    	break;
