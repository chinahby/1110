#ifndef CUSTUIM_HW_6290_H
#define CUSTUIM_HW_6290_H
/*===========================================================================

            " C U S T -  U I M - H W - 6290 "   H E A D E R   F I L E

DESCRIPTION
  Configuration for UIM hardware specifics for MSM6290.
...
$Header: //source/qcom/qct/modem/uim/su/cust/rel/07H1_2/custuim_hw_6290.h#2 $ $DateTime: 2009/01/13 01:39:08 $ $Author: viveks $

when       who    what, where, why
--------   ---    ----------------------------------------------------------
01/12/09   vs     Define UIM USB UICC feature only if HS-USB UICC is defined
09/17/08   js     Removed FEATURE_UIM_USB_UICC_RST_HIGH
...
06/03/08   rm     Enabling TA1=0x97 feature macros.
07/03/08   rm     Initial revision.

===========================================================================*/

/*
 *  Features specific to T_MSM6290 ONLY
 */
