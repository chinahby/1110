...
Copyright (c) 1998 to 2003 by QUALCOMM, Incorporated.  All Rights Reserved.
===========================================================================*/
...
$Header: //source/qcom/qct/modem/rfa/pmic/common/main/latest/app/inc/pmapp_rtc.h#2 $
...
{
   PM_RTC_ALARM_1      = 0x01,
   PM_RTC_ALL_ALARMS   = 0x01       // This is used for referring collectively
