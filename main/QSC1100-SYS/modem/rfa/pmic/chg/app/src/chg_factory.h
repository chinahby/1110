...
/* =======================================================================
  ...
  $Header: //source/qcom/qct/modem/rfa/pmic/chg_task/main/latest/app/src/chg_factory.h#7 $
...
public:
    ...
    /*! \brief This static member function returns if the charger hardware is
     *  charging the battery in the current state
     *  \note This function should get called when there is a need to know
     *  if the charger hardeare is charging the battery or not. 
     */
    static bool                          IsCharging();
    /*! \brief This static member function returns if the battery is valid
     *  \note This function should get called when there is a need to know
     *  if the battery is valid or not 
     */
    static bool                          IsBatteryValid();
    /*! \brief This static member function returns if the charger hardware is valid
     *  \note This function should get called when there is a need to know
     *  if the charger hardware is valid or not 
     */
    static bool                          IsChargerValid();
    /*! \brief This static member function returns the UI (User Interface) status
     *  for the current state
     *  \note This function should get called when there is a need to know
     *  the UI status of the current state. 
     */
    static chg_ui_event_type             UiEventRead();
private:
    /*! \brief This static member function returns a single instance of class  
