...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/data/1x/707/main/lite/src/ds707_so_g3fax.c#5 $ $DateTime: 2009/01/27 05:42:02 $ $Author: nsivakum $
...
===========================================================================*/
const ds707_so_type ds707_so_g3fax_list[] =
{
...
---------------------------------------------------------------------------*/
LOCAL const snm_config_type  ds707_so_g3fax5_default_cfg =
{
  {
...
---------------------------------------------------------------------------*/
LOCAL const snm_config_type  ds707_so_g3fax4101_default_cfg =
{
  {
    /* Forward link defaults */
    CAI_MUX1,                      /* Default forward multiplex option = 1 */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  for( i = 0; i < DS707_SO_G3FAX_NUM; i++ )
  {
                   ...
                   ds707_so_g3fax_param[i].default_cfg) == SNM_SUCCESS )
    {
      ...
      ---------------------------------------------------------------------*/
      snm_set_cont_msg_handler((word)ds707_so_g3fax_list[i],
...
DEPENDENCIES  Uses the global variable dsat707_qcso_val to determine the
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  for( i = 0; i < DS707_SO_G3FAX_NUM; i++ )
  {
    ...
    if (ds707_so_g3fax_tbl[dsat707_qcso_val][i] == TRUE)
    {
      /*---------------------------------------------------------------------
...
#else
  return(ds707_so_g3fax_orig_tbl[dsat707_qcso_val]
                                [rateset]);
#endif
} /* ds707_so_g3fax_get_orig() */
