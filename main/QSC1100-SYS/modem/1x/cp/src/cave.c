...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/1x/cp/rel/1h08/src/cave.c#1 $ $DateTime: 2009/05/29 03:54:56 $ $Author: prabhuk $
...
if (do_VPM)
  ...
  MSG_MED("VPM calculated",0,0,0); /*lint !e539 */
...
MSG_HIGH("Private LCM: High %0x, Low %0x", lcm.high, lcm.low, 0);
