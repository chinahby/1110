...
$PVCSPath$
$Header: //source/qcom/qct/modem/1x/cp/rel/1h08/src/mccnp.c#1 $
...
/*lint -e766*/
#include "customer.h"
#include "mccdma.h"     /* IMSI constants and mcc_default_imsi_s1() */
...
)
{
  ...
  MSG_HIGH("mcc %d, mnc %d", imsi_mcc, imsi_11_12,0);
  MSG_HIGH("imsi_s1 %1x, imsi_s2 %d", imsi_s1, imsi_s2,0);
  MSG_HIGH("imsi_s1 def %1x ",mcc_default_imsi_s1() ,0,0);
