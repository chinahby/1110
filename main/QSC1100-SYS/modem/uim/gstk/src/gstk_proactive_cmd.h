...
Copyright (c) 2003-2005 QUALCOMM, Incorporated and its licensors.  All Rights
...
$Header: //source/qcom/qct/modem/uim/gstk/rel/07H1_2/src/gstk_proactive_cmd.h#1 $
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_find_expected_proactive_cmd_rsp(
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_end_proactive_session(gstk_proactive_cmd_type* cmd);
