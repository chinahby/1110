...
$Header: //source/qcom/qct/modem/uim/gstk/rel/07H1_2/src/gstkpacker.c#2 $
       ...
       gstk_sms_tpdu_tag_tlv_type          *tpdu_tlv)
{
  ...
  if(is_cdma_tpdu) {
#if defined FEATURE_UIM_TOOLKIT_UTK || (defined FEATURE_CAT_REL6 && defined FEATURE_CCAT)
  ...
  memcpy(tpdu_tlv->sms_tpdu, data->tpdu, data->length);
