...
$Header: //source/qcom/qct/modem/uim/mmgsdi/rel/07H1_2/src/gsdi_perso_sec.c#12 $$ $DateTime: 2009/05/04 19:34:26 $
...
)
{
    ...
    if(err_num == E_SUCCESS)
    {
      ...
      {
        data_p[index] = (random[index] % 9) + 0x30;       /* Convert random value to ascii 0-9*/
        index++;
      }
    }
    else
