#ifndef __A1LITEAPPGEN_H__
#define __A1LITEAPPGEN_H__
/*===========================================================================

FILE:      A1LiteAppGen.h
                 
 
SERVICES:  Header file for the AEEApplet implementation for A1Lite
...
#include "A1LiteModGen.h"  // A1LiteModGen.h - REQUIRED!
...
//This function is invoked from within the applications A1LiteClsCreateInstance() to
