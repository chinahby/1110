...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/inc/fs_diag_access.h#4 $ $DateTime: 2008/10/29 18:04:54 $ $Author: richardp $
...
#ifndef FEATURE_EFS2
  #error "FEATURE_DIAG_FS_ACCESS_VALIDATION requires EFS2"
#endif
...
/* Number of validation clients allowed  */
  ...
  #define FS_DIAG_MAX_ACCESS_VALIDATOR_CLIENTS 5
#endif
