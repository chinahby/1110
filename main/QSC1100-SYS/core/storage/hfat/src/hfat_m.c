...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/hfat/main/latest/src/hfat_m.c#1 $ $DateTime: 2008/05/29 19:19:11 $ $Author: richardp $
...
int
fm_seek (FN_FILE * filehandle, long offset, long whence)
{
  int ret;
  F_MULTI *fm;
...
int
fm_gettimedate (const char *filename, unsigned short *pctime,
...
#ifdef HCC_UNICODE
int
fm_wgettimedate (const wchar * filename, unsigned short *pctime,
                 unsigned short *pcdate)
{
  int ret;
  F_MULTI *fm;
...
int
fm_settimedate (const char *filename, unsigned short ctime,
...
#ifdef HCC_UNICODE
int
fm_wsettimedate (const wchar * filename, unsigned short ctime,
                 unsigned short cdate)
{
  int ret;
  F_MULTI *fm;
