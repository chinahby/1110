...
$Header: //depot/asic/qsc1100/drivers/tlmm/gpio_1100.c#6 $
...
GPIO_SignalType gpio_sleep_changes[] =
{
  ...
  */
  /* GPIO 16-19 (UART usage) configure to input, pull down , spi is not support
   * at this point.
   */
#ifdef FEATURE_GSBI1_UART
  GPIO_IN(16,GROUP_GPIO_0,GPIO_PULL_DOWN), // UART1_RFR_N
  GPIO_IN(17,GROUP_GPIO_0,GPIO_PULL_DOWN), // UART1_CTS_N
  GPIO_IN(18,GROUP_GPIO_0,GPIO_PULL_DOWN), // UART1_RX_DATA
  GPIO_IN(19,GROUP_GPIO_0,GPIO_PULL_DOWN), // UART1_TX_DAT
#endif
