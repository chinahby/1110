#ifndef BOOTHWI_60X5_H
#define BOOTHWI_60X5_H
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*

      B O O T    H A R D W A R E    M S M 6 0 X 5    S P E C I F I C
...
$Header: //depot/asic/qsc6055/drivers/boot/boothwi_60x5.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/28/07   gmy     Add conditional support for TMD20 QVGA to SC2x
...
#else
  EBI_LCD_TYPE_EPSON_OPTREX_176x220
#endif
...
#else /* !FEATURE_TMD_20_QVGA */

#define EBI2_CS2_EPSON_OPTREX_176x220_COLOR_LCD                                \
{                                                                           \
  EBI_MEM_TYPE_PSRAM,                           /* Memory type        */    \
  EBI_ACCESS_TYPE_ASYNC,                        /* Access type        */    \
  EBI_DATA_WIDTH_16_BITS,                       /* Data width         */    \
...
#define EBI2_LCD_TYPE                                                       \
{                                                                           \
 EBI_LCD_TYPE_EPSON_OPTREX_176x220,             /* Display type       */    \
 EBI_LCD_DATA_WIDTH_18_BITS,                    /* Data width         */    \
   0,                                           /* CS setup time      */    \
   0,                                           /* CS recovery time   */    \
 100,                                           /* Read access time   */    \
...
/* EBI2 - 176x220 Color LCD - Epson TBD - SURF and FFA targets. */
#define EBI2_EPSON_OPTREX_176x220_COLOR_LCD                                    \
{                                                                           \
 EBI_LCD_TYPE_EPSON_OPTREX_176x220,             /* Display type       */    \
 EBI_LCD_DATA_WIDTH_16_BITS,                    /* Data width         */    \
   0,                                           /* CS setup time      */    \
      ...
      {                                          \
        ...
        EBI1_CS_UNUSED       \
         ...
         {                                          \
           ...
           EBI2_SURF_FPGA,                          \
           EBI2_CS_UNUSED,                          \
           EBI2_CS2_EPSON_OPTREX_176x220_COLOR_LCD, \
           EBI2_LCD_TYPE                            \
         }
