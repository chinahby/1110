...
#define TM_SCTN128x128_DISPLAY_ON_C  0x29
#define TM_SCTN128x128_DISPLAY_OFF_C  0x28
#define TM_SCTN128x128_SET_START_ADDRESS_C   0x2a
#define TM_SCTN128x128_SET_END_ADDRESS_C   0x2b
#define TM_SCTN128x128_RAM_WRITE_C 0x2c
#define TM_SCTN128x128_SOFT_RESET_C 0x01
