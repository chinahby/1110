...
$Header: //source/qcom/qct/multimedia/ipl/transformation/main/latest/src/ipl_downSize.c#4 $
...
/*------------------------------------------------------------------------*/
      ...
      (i_img_ptr->dy < o_img_ptr->dy))
  {
    ...
    IPL2_MSG_FATAL( "ipl2_downsize failed for invalid diemnsions /\
       i_img_ptr->dx= %d, o_img_ptr->dx = %d", i_img_ptr->dx,
       o_img_ptr->dx, 0 );

    IPL2_MSG_FATAL( "ipl2_downsize failed for invalid diemnsions /\
       i_img_ptr->dy = %d, o_img_ptr->dy = %d", i_img_ptr->dy,
       o_img_ptr->dy, 0 );
