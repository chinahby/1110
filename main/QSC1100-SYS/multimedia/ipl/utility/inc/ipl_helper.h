...
$Header: //source/qcom/qct/multimedia/ipl/utility/main/latest/inc/ipl_helper.h#3 $
===========================================================================*/
...
DESCRIPTION
  This function frees the memory allocated by ipl_malloc
