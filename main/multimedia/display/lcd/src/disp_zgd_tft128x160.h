#ifndef __DISP_ZGD_TFT128X160_H__
#define __DISP_ZGD_TFT128X160_H__




#define ZGD_TFT128x160_DISPLAY_ON_C  0x29
#define ZGD_TFT128x160_DISPLAY_OFF_C  0x28
#define ZGD_TFT128x160_SET_START_ADDRESS_C   0x2a
#define ZGD_TFT128x160_SET_END_ADDRESS_C   0x2b
#define ZGD_TFT128x160_RAM_WRITE_C 0x2c
#define ZGD_TFT128x160_SOFT_RESET_C 0x01
