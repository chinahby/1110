...
#ifdef __GNUC__
static uint32 MDP_DISP_SCR_ZC948[MDP_LCD_SCR_SIZE][MDP_LCD_SCR_LEN]
__attribute__ ((aligned (16))) =
#else
__align(16) static uint32 MDP_DISP_SCR_ZC948[MDP_LCD_SCR_SIZE][MDP_LCD_SCR_LEN] =
#endif
{
    NOP,               //0
    NOP,               //1
...
boolean disp_zc948_tft177(disp_drv_ic_type *pdispic)
{
