...
static void disp_ic_init(void)
{
	...
	LCD_WRITE_CMD(0x0014); LCD_WRITE_DATA16(0x4B5d); //0x6b64 // Set VCOMH/VCOML voltage   //4d5f  0x4B50  0x5150
	//Vcom=Vcom+0x100;
	//------------- Set GRAM area ------------------//
	LCD_WRITE_CMD(0x0030); LCD_WRITE_DATA16(0x0000);
	LCD_WRITE_CMD(0x0031); LCD_WRITE_DATA16(0x00DB);
	...
	LCD_WRITE_CMD(0x00D0); LCD_WRITE_DATA16(0x0003); 
    LCD_WRITE_CMD(0x00EB); LCD_WRITE_DATA16(0x0B00); 
    LCD_WRITE_CMD(0x00EC); LCD_WRITE_DATA16(0x000F);  
    LCD_WRITE_CMD(0x00C7); LCD_WRITE_DATA16(0x030F); 
    ...
    LCD_WRITE_CMD(0x0003); LCD_WRITE_DATA16(0x1030);  
    LCD_WRITE_CMD(0x0008); LCD_WRITE_DATA16(0x0808); 
    LCD_WRITE_CMD(0x000F); LCD_WRITE_DATA16(0x0901);  
    LCD_DELAY(10); 
    LCD_WRITE_CMD(0x0010); LCD_WRITE_DATA16(0x0000); 
    LCD_WRITE_CMD(0x0011); LCD_WRITE_DATA16(0x1B41); //The register setting is suitable for VCI=2.8V 
    LCD_DELAY(120); 
    LCD_WRITE_CMD(0x0012); LCD_WRITE_DATA16(0x200E);//The register setting is suitable for VCI=2.8V 
    LCD_WRITE_CMD(0x0013); LCD_WRITE_DATA16(0x0052); //The register setting is suitable for VCI=2.8V 
    LCD_WRITE_CMD(0x0014); LCD_WRITE_DATA16(0x4B5C); //The register setting is suitable for VCI=2.8V   
 
    LCD_WRITE_CMD(0x0050); LCD_WRITE_DATA16(0x0000); 
    LCD_WRITE_CMD(0x0051); LCD_WRITE_DATA16(0x0705); 
    LCD_WRITE_CMD(0x0052); LCD_WRITE_DATA16(0x0C0A); 
    LCD_WRITE_CMD(0x0053); LCD_WRITE_DATA16(0x0401); 
    LCD_WRITE_CMD(0x0054); LCD_WRITE_DATA16(0x040C); 
    LCD_WRITE_CMD(0x0055); LCD_WRITE_DATA16(0x0608); 
    LCD_WRITE_CMD(0x0056); LCD_WRITE_DATA16(0x0000); 
    LCD_WRITE_CMD(0x0057); LCD_WRITE_DATA16(0x0104); 
    LCD_WRITE_CMD(0x0058); LCD_WRITE_DATA16(0x0E06); 
    LCD_WRITE_CMD(0x0059); LCD_WRITE_DATA16(0x060E);    
