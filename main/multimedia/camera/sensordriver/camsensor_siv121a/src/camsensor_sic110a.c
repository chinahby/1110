...
#define CAMSENSOR_SIC110A_QTR_SIZE_WIDTH     176
#define CAMSENSOR_SIC110A_QTR_SIZE_HEIGHT    144
...
static boolean camsensor_sic110a_snapshot_config( camsensor_static_params_type  *camsensor_params)
{
    if(camera_dx > CAMSENSOR_SIC110A_QTR_SIZE_WIDTH)
    {
    	...
    	/* CAMIF Window */
    	camsensor_params->camif_window_width_config.firstPixel = camsensor_params->camsensor_width-camera_dx; //按CLK
...
static boolean camsensor_sic110a_video_config(camsensor_static_params_type *camsensor_params)
{
	if(camera_preview_dx > CAMSENSOR_SIC110A_QTR_SIZE_WIDTH)
	{
	    ...
	    /* CAMIF Window */
	    camsensor_params->camif_window_width_config.firstPixel = camsensor_params->camsensor_width-camera_preview_dx; //按CLK
