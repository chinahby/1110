...
typedef enum
{
  ...
  GPIO_SDCC_CLK         = GPIO_OUP(24,GROUP_GPIO_0,GPIO_NO_PULL),
  ...
  GPIO_SDCC_DAT_0_OUT   = GPIO_OUP(25,GROUP_GPIO_0,GPIO_NO_PULL),
  GPIO_SDCC_DAT_0_IN    = GPIO_IN (25,GROUP_GPIO_0,GPIO_NO_PULL),
  ...
  GPIO_SDCC_DATOUT_1_OUT= GPIO_OUP(26,GROUP_GPIO_0,GPIO_NO_PULL),
  GPIO_SDCC_DATOUT_1_IN = GPIO_IN (26,GROUP_GPIO_0,GPIO_NO_PULL),
  ...
  GPIO_SDCC_DATOUT_2_OUT= GPIO_OUP(27,GROUP_GPIO_0,GPIO_NO_PULL),
  GPIO_SDCC_DATOUT_2_IN = GPIO_IN (27,GROUP_GPIO_0,GPIO_NO_PULL),
  ...
  GPIO_SDCC_DATOUT_3_OUT= GPIO_OUP(28,GROUP_GPIO_0,GPIO_NO_PULL),
  GPIO_SDCC_DATOUT_3_IN = GPIO_IN (28,GROUP_GPIO_0,GPIO_NO_PULL),
  ...
  GPIO_SDCC_CMD_OUT     = GPIO_OUP(29,GROUP_GPIO_0,GPIO_NO_PULL),
  GPIO_SDCC_CMD_IN      = GPIO_IN (29,GROUP_GPIO_0,GPIO_NO_PULL),
  ...
  GPIO_INPUT_31         = GPIO_IN (31,GROUP_GPIO2_0,GPIO_PULL_DOWN),
...
//#if defined(FEATURE_PROJECT_W203) || defined(FEATURE_PROJECT_W204) 
  ...
  GPIO_INPUT_32         = GPIO_IN (32,GROUP_GPIO2_1,GPIO_PULL_DOWN),
