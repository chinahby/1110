...
typedef enum
{
  ...
  KYPD_EX1              = GPIO_OUP(41,GROUP_GPIO_1,GPIO_PULL_UP),/* <----- same as GPIO_OUTPUT_41 but with PULL_UP */
  ...
  KYPD_EX2              = GPIO_OUP(42,GROUP_GPIO2_1,GPIO_PULL_UP),/* <----- same as GPIO_OUTPUT_42 but with PULL_UP */
  ...
  KYPD_EX3              = GPIO_OUP(44,GROUP_GPIO2_1,GPIO_PULL_UP),/* <----- same as GPIO_OUTPUT_44 but with PULL_UP */
