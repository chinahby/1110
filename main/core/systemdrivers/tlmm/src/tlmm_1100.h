...
#else
#define GPIO_10_SIGNAL GPIO_OUTPUT_10
#endif
/* GPIO 11 */
...
#if defined (FEATURE_GPIO_32_SIGNAL_OUPUT_32)
#define GPIO_32_SIGNAL GPIO_OUTPUT_32
#else
#ifdef FEATURE_LCD_TOUCH_ENABLE
#define GPIO_32_SIGNAL GPIO_INPUT_32
#else
...
//#if defined(FEATURE_PROJECT_W203) || defined(FEATURE_PROJECT_W204) 
#if defined (FEATURE_GPIO_33_AND_34_KYPD_EX)
...
/* GPIO 36 */
#ifdef FEATURE_LCD_TOUCH_ENABLE
#define GPIO_36_SIGNAL GPIO_OUTPUT_36
#else
...
/* GPIO 47 */
//#if defined(FEATURE_PROJECT_W203) || defined(FEATURE_PROJECT_W204) 
#if defined (FEATURE_GPIO_47_SIGNAL_EQUAL_OUTPUT_47)
