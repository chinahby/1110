...
--------   ---     ----------------------------------------------------------
04/24/10   pmuthe  Version Q1100ASBNAALZ3.3.75 Q1100_SURF_BurstNOR_NonPBoot_Lowtier_StripAndPacked
...
NOTICE_TYPE ver_modelbuiletime[] = MODELBUILDTIME;
#endif /*CUST_EDITION*/
...
*/
const word NOTICE_SEG_TYPE mob_firm_rev = 4413;
