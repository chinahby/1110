...
static const hs_key_type keys[ KEYPAD_ROWS ][ KEYPAD_COLUMNS ] = {
   ...
   /* 9,17          9,15        9,11        9,9          9,Memo*/
   { HS_3_K,   HS_LEFT_K,   HS_INFO_K,     HS_RIGHT_K,     HS_MUSIC_K}
   #elif defined(FEATURE_VERSION_K212_12832)||defined(FEATURE_VERSION_K232_Y100)||defined(FEATURE_VERSION_K232_Y100A)
		 #if defined(FEATURE_VERSION_K212_20D)
		   { HS_PAUSE_K,   HS_6_K,  HS_9_K,  HS_POUND_K,  HS_FFWD_K},
		   /* KEYSENSE_1 */
		   /* 3,17          3,15        3,11        3,9          3,Memo*/
		   { HS_RWD_K,  HS_SEL_K,    HS_UP_K, HS_CLR_K,      HS_FM_K},
		   ...
		   { HS_3_K,   HS_LEFT_K,   HS_INFO_K,     HS_RIGHT_K,     HS_NONE_K}
		#elif defined(FEATURE_VERSION_K212_HUALU)||defined(FEATURE_VERSION_K232_Y100)||defined(FEATURE_VERSION_K232_Y100A)
			   { HS_3_K,   HS_6_K,  HS_9_K,  HS_POUND_K,  HS_NONE_K},
 			   /* KEYSENSE_1 */
 			   /* 3,17          3,15        3,11        3,9          3,Memo*/
 			   { HS_LEFT_K,  HS_SEL_K,    HS_UP_K, HS_CLR_K,      HS_VOL_UP_K},
			   ...
			   /* KEYSENSE_1 */
			   /* 3,17          3,15        3,11        3,9          3,Memo*/
			   { HS_RWD_K,  HS_SEL_K,    HS_UP_K, HS_CLR_K,      HS_NONE_K},
			   ...
			   /* KEYSENSE_4 */
			   /* 9,17          9,15        9,11        9,9          9,Memo*/
			   { HS_3_K,   HS_LEFT_K,   HS_INFO_K,     HS_RIGHT_K,     HS_FM_K}
		#endif
   #elif defined(FEATURE_VERSION_K202)   //ADD BY YANGDECAI 2012-0202
   ...
   /* KEYSENSE_4 */
   /* 9,17          9,15        9,11        9,9          9,Memo*/
   { HS_CLR_K,   HS_RIGHT_K,   HS_UP_K,     HS_INFO_K,     HS_MUSIC_K}
...
#if defined(FEATURE_VERSION_K212) || defined(FEATURE_VERSION_K212_12832) || defined(FEATURE_VERSION_IC241A_MMX)||defined(FEATURE_VERSION_K292)||defined(FEATURE_VERSION_K232_Y100A)
/* '1' Key */
...
#else
#if defined(FEATURE_VERSION_K212)||defined(FEATURE_VERSION_K212_12832)||defined(FEATURE_VERSION_K232_Y100A)
