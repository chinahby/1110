...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/mmode/cm/rel/08H1/src/cmclient.h#2 $
...
02/13/02   ic      Removed const modifier from cm_inband_cmd_s_type  *inband_cmd_ptr
...
===========================================================================*/
extern void cmclient_list_del( cm_client_s_type *client_ptr );
