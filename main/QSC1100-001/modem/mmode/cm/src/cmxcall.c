...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/mmode/cm/rel/08H1/src/cmxcall.c#12 $
...
#error code not present
    ...
    case CM_MMGSDI_REFRESH_FCN_IND_F:
         ...
         cm_mc_rpt_ptr->voting_mmgsdi.refresh.stage == MMGSDI_REFRESH_STAGE_WAIT_FOR_OK_TO_INIT)
      {
        ...
        {
          if ((cm_mc_rpt_ptr->voting_mmgsdi.refresh.refresh_files.file_list_ptr != NULL)
              &&
              (cmmmgsdi_is_refresh_list_used_by_cm (
                cm_mc_rpt_ptr->voting_mmgsdi.refresh.refresh_files.file_list_ptr,
                (uint8)cm_mc_rpt_ptr->voting_mmgsdi.refresh.refresh_files.num_files)             
              ))
          {
          ...
          {
             CM_MSG_MED ("cmmmgsdi_ok_to_refresh is TRUE",0, 0, 0);
             cmmmgsdi_ok_to_refresh(
                              MMGSDI_SLOT_1,
                              TRUE
                              );
