...
$Header: //source/qcom/qct/modem/wms/wms/rel/qsc1100_05.04.00/src/WMSE/wmsruim.h#2 $ $DateTime: 2008/12/02 13:02:59 $ $Author: pyaramad $
...
#define WMS_RUIM_SERVICE_TABLE_SMSCAP_ALLOC     0x10
#define WMS_RUIM_SERVICE_TABLE_SMSCAP_ACTIVE    0x20
...
#define WMS_RUIM_SERVICE_TABLE_HAS_SMSCAP( x ) \
  ( ( (x) & WMS_RUIM_SERVICE_TABLE_SMSCAP_ALLOC) && \
    ( (x) & WMS_RUIM_SERVICE_TABLE_SMSCAP_ACTIVE) )
