...
$Header: //source/qcom/qct/modem/wms/wms/rel/qsc1100_05.04.00/src/WMSE/wmsmsg.c#8 $ $DateTime: 2009/06/01 12:51:30 $ $Author: nguyenh $
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  if( rec_ptr != NULL )
  {
    MSG_HIGH("clr msg rec %d (tid 0x%lx)",
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  seq_num = start_seq_num = tl_ptr->bearer_reply_seq_num;
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  */
  ...
  if( st == WMS_OK_S )
  {
    wms_cmd_err_e_type cmd_err = wms_msg_cdma_send_MO(
          FALSE,
                            cmd_ptr,
                            cmd_ptr->cmd.msg_send.send_mode,
                            & cmd_ptr->cmd.msg_send.message.msg_hdr,
