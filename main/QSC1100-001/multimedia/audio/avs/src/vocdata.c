...
$Header: //source/qcom/qct/multimedia/audio/6k/ver1/avs/main/latest/src/vocdata.c#52 $ $DateTime: 2009/06/22 09:07:57 $ $Author: mkiran $
...
#ifdef QDSP_IMAGE_AAC_H264_DEFINED
#error code not present
#endif
#ifdef QDSP_IMAGE_QTV_AAC_DEFINED
    case QDSP_IMAGE_QTV_AAC:
...
#error code not present
  ...
  {
    if(voc_data_aud_process_override_enabled) {
      return( (qdsp_cmd_pcm_iir_filter_type*) &voc_data_aud_override_iir_filter );
    } else {
