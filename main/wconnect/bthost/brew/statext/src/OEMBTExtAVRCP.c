...
static const OEMBTExtAVRCP_error_map_type OEMBTExtAVRCP_error_map[] = 
{
    {BT_CS_PF_CONFIG_FAIL_INVALID_PARAMETERS,
         AEEBT_AVRCP_ERR_CONFIG_PARAMS_NOT_AGREEABLE},
    {BT_CS_PF_CONNECT_REFUSED_NO_RESOURCES,
        AEEBT_AVRCP_ERR_CONNECT_REFUSED_NO_RESOURCES},
    {BT_CS_PF_DISCONNECT_LOWER_LAYER,
        AEEBT_AVRCP_ERR_LINK_LOST},
    {BT_CS_PF_CONNECT_REFUSED_SECURITY,
        AEEBT_AVRCP_ERR_AUTHENTICATION_FAILED},
    {BT_CS_PF_DISCONNECT_REMOTE_REQUEST,
        AEEBT_AVRCP_ERR_NORMAL_DISCONNECT},
    {BT_BE_PAGE_TIMEOUT,
        AEEBT_AVRCP_ERR_PAGE_FAILED},
    {BT_BE_CMD_DISALLOWED,
      AEEBT_AVRCP_ERR_WRONG_COMMAND},
    {BT_BE_AUTHENTICATION_FAILURE,
        AEEBT_AVRCP_ERR_AUTHENTICATION_FAILED},
    {BT_CS_PF_DISCONNECT_LOWER_LAYER,
        AEEBT_AVRCP_ERR_LINK_LOST},
