...
{		
    ...
    pMe->m_IconTitle[4]     = IDS_MAIN_MENU_USERPROFILE; 
    pMe->m_IconTitle[5]     = IDS_MAIN_MENU_GAMES;
    pMe->m_IconTitle[6]     = IDS_MAIN_MENU_SETTINGS;   
    pMe->m_IconTitle[7]     = IDS_MAIN_MENU_TOOLS;       
    //pMe->m_IconTitle[8]     = IDS_MAIN_WAPBROWSER;    
...
static void DrawMatrix(MainMenu *pMe)
{
    ...
    */
    ...
    if(pMe->m_pImageSelectEC99 != NULL)
    {
        //IIMAGE_Start(pMe->m_pImageSelectEC99, 0, 0);
        IIMAGE_Start(pMe->m_pImageSelectEC99, 0, 0);
    }
...
//#if defined(FEATURE_PROJECT_SMART) || defined(FEATURE_PROJECT_M8)
	...
	pMe->m_IconTitle[1]     = IDS_MAIN_MENU_CONTACTS;	
    pMe->m_IconTitle[2]     = IDS_MAIN_MENU_RECENTCALLS;	//IDS_MAIN_MENU_RECENTCALLS;
    pMe->m_IconTitle[3]     = IDS_MAIN_WAPBROWSER;	//IDS_MAIN_WAPBROWSER;
    pMe->m_IconTitle[4]     = IDS_MAIN_MENU_MESSAGES;
    pMe->m_IconTitle[5]     = IDS_MAIN_MENU_MEDIAGALLERY;	//IDS_MAIN_MENU_MEDIAGALLERY;
    pMe->m_IconTitle[6]     = IDS_MAIN_MENU_UTK;
    pMe->m_IconTitle[7]     = IDS_MAIN_MENU_APPLICATION;	//IDS_MAIN_MENU_APPLICATION;
    pMe->m_IconTitle[8]     = IDS_MAIN_MENU_MUSICPLAYER;
    pMe->m_IconTitle[9]     = IDS_MAIN_MENU_USERPROFILE;	//IDS_MAIN_MENU_USERPROFILE;	//IDS_MAIN_MENU_APPLICATION;
    pMe->m_IconTitle[10]    = IDS_MAIN_MENU_GAMES;
    pMe->m_IconTitle[11]    = IDS_MAIN_MENU_SETTINGS;
    ...
    pMe->m_IconTitle[0]     = IDS_MAIN_MENU_CONTACTS;
    pMe->m_IconTitle[1]     = IDS_MAIN_MENU_MUSICPLAYER;
    pMe->m_IconTitle[2]     = IDS_MAIN_MENU_MESSAGES;
    pMe->m_IconTitle[3]     = IDS_MAIN_MENU_RECENTCALLS;
    pMe->m_IconTitle[4]     = IDS_MAIN_MENU_SETTINGS;
    pMe->m_IconTitle[5]     = IDS_MAIN_MENU_APPLICATION;
    pMe->m_IconTitle[6]     = IDS_MAIN_MENU_GAMES;
    pMe->m_IconTitle[7]     = IDS_MAIN_MENU_SCHEDULER;
    pMe->m_IconTitle[8]     = IDS_MAIN_MENU_CALCULATOR;
    #else
    pMe->m_IconTitle[0]     = IDS_MAIN_MENU_MEDIAGALLERY;
    pMe->m_IconTitle[1]     = IDS_MAIN_MENU_CONTACTS;
    pMe->m_IconTitle[2]     = IDS_MAIN_MENU_UTK;
...
#elif defined (FEATURE_VERSION_LEC_6) // add by pyuangui 20121224
	pMe->m_IconTitle[0] 	= IDS_MAIN_MENU_CONTACTS;
