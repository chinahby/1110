...
typedef enum DLGRetValue
{
    ...
    DLGRET_NETWORK_SETTINGS,    //IDD_NETWORK_SETTINGS
    DLGRET_NETWORK_PARAMS_EDIT, //IDD_NETWORK_PARAMS_EDIT
...
//    ,DLGRET_SMSRESTRICT_SEND
    ...
    ,DLGRET_PHONE_GENERAL_INFO
#endif	
    ,DLGRET_PHONE_SAR_VALUE
#ifdef FEATURE_SOUND_BO
    ,DLGRET_SPEECH_SETTINGS   //IDD_SPEECH_MENU
#endif 
#if defined(FEATURE_VERSION_K212_ND)
	,DLGRET_SOS_SETTINGS   //IDD_SPEECH_MENU
#endif
...
typedef enum _SettingMenuState
{
   ...
   SETTINGMENUST_AKG,
   SETTINGMENUST_NETWORK_SETTINGS,
   SETTINGMENUST_NETWORK_PARAMS_EDIT,
...
#ifdef FEATURE_INTERNATIONAL_PREFIX
   SETTINGMENUST_PREFIX,
   SETTINGMENUST_PREFIX_EDIT,
#endif
...
#ifdef FEATURE_CALL_RESTRICT
   ,SETTINGMENUST_RESTRICTNUMBERS
   ,SETTINGMENUST_RESTRICTOPT
#endif
   ,SETTINGMENUST_PROMPT
   ,SETTINGMENUST_NUMEDIT
   ,SETTINGMENUST_VIEW_DETAIL
#ifdef FEATURE_PLANEMODE
...
//   ,SETTINGMENUST_SMSRESTRICT_SEND
   ...
   ,SETTINGMENUST_PHONE_GENERAL_INFO
#endif   
   ,SETTINGMENUST_PHONE_SAR_VALUE
#ifdef FEATURE_SOUND_BO
