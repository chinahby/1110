...
#if defined(FEATURE_VERSION_SMART) || defined(FEATURE_VERSION_M8) || defined(FEATURE_VERSION_M8P) || defined(FEATURE_VERSION_M8021)||defined(FEATURE_VERSION_W516)||defined(FEATURE_VERSION_C11)|| defined(FEATURE_VERSION_C180)
#else
