...
//
        ...
        case EVT_LOAD_DATA:
        {
            ...
            {
#if defined(FEATURE_VERSION_C337)  || defined(FEATURE_VERSION_IC241A_MMX) || defined(FEATURE_VERSION_K212_HUALU)||defined(FEATURE_VERSION_K232_Y100A) || defined(FEATURE_VERSION_KK5)
