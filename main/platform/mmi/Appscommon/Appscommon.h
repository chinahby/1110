...
#define RGB_WHITE_NO_TRANS MAKE_RGB(0xFF, 0xFF, 0xFF)
    ...
    #define STATEBAR_HEIGHT         21
    #define BOTTOMBAR_HEIGHT        21
    #define TITLEBAR_HEIGHT         21
    #define MENUITEM_HEIGHT         24
    #define SCROLLBAR_WIDTH         5
...
#define TEXT_GRAPHIC_FONT_COLOR     (RGB_BLACK) //(RGB_WHITE)
#define TEXT_GRAPHIC_BG_COLOR       (RGB_WHITE) //(RGB_BLACK)
