...
static boolean InitWorldTime(CWorldTime *pme)
{
...

    {
        ...
        for(i=0;i<=25;i++)
        {
           ...
           #if defined(FEATURE_VERSION_W515V3) || defined(FEATURE_VERSION_S1000T) || defined(FEATURE_VERSION_C337) || defined(FEATURE_VERSION_C316)||defined(FEATURE_VERSION_W021_CT100_HINDI)
            if(i == 4)
            {
            	(void)IMENUCTL_AddItem( pme->m_pMenuCity,
                                                WORLDTIME_RES_FILE_LANG,
