...
static boolean InitWorldTime(CWorldTime *pme)
{
...

    {
        ...
        for(i=0;i<=25;i++)
        {
           ...
           #if defined(FEATURE_VERSION_W515V3)|| defined(FEATURE_VERSION_K232_Y100A) || defined(FEATURE_VERSION_S1000T) || defined(FEATURE_VERSION_C337) || defined(FEATURE_VERSION_C316)||defined(FEATURE_VERSION_REGION_INDIA) || defined(FEATURE_VERSION_IC241A_MMX)|| defined (FEATURE_VERSION_KK5)
            if(i == 4)
            {
            	(void)IMENUCTL_AddItem( pme->m_pMenuCity,
                                                WORLDTIME_RES_FILE_LANG,
...
static void Draw_TimeZone(CWorldTime *pme)
{
    ...
    #if defined(FEATURE_VERSION_W515V3) || defined(FEATURE_VERSION_S1000T) || defined(FEATURE_VERSION_C337) || defined(FEATURE_VERSION_C316)||defined(FEATURE_VERSION_REGION_INDIA) || defined(FEATURE_VERSION_IC241A_MMX)|| defined(FEATURE_VERSION_K232_Y100A)|| defined (FEATURE_VERSION_KK5)
    else if (pme->m_isIndia)
    {
