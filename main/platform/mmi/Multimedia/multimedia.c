...
#if defined (FEATURE_VERSION_W208S) || defined (FEATURE_VERSION_C337)||defined(FEATURE_VERSION_C316) || defined(FEATURE_VERSION_IC241A_MMX) || defined(FEATURE_VERSION_W021_C11)|| defined(FEATURE_VERSION_K212_HUALU)|| defined (FEATURE_VERSION_KK5)
...
#if defined(FEATURE_VERSION_W208S)|| defined(FEATURE_VERSION_W317A)|| defined(FEATURE_VERSION_S600S)||defined(FEATURE_VERSION_ESIA)||defined(FEATURE_VERSION_K212)||defined(FEATURE_VERSION_V3C137)||defined(FEATURE_VERSION_K212_BH)|| defined(FEATURE_VERSION_K232_Y100A)	         
#else
            IMENUCTL_AddItem(pMenu, MULTIMEDIA_RES_FILE_LANG,IDS_MULTIMEDIA_CAMERA, IDS_MULTIMEDIA_CAMERA, NULL, 0);
#endif
#endif
#if defined(FEATURE_VERSION_W027_HC_KK3_CAM)
			IMENUCTL_AddItem(pMenu, MULTIMEDIA_RES_FILE_LANG,IDS_MULTIMEDIA_CAMERA, IDS_MULTIMEDIA_CAMERA, NULL, 0);
#endif
...
#endif
//#endif
#if defined	(FEATURE_VERSION_FLEXI203) || defined (FEATURE_VERSION_IVIO203) ||defined (FEATURE_VERSION_FLEXI203P)|| defined (FEATURE_VERSION_C500BE)||defined (FEATURE_VERSION_VG68)||defined (FEATURE_VERSION_K212)||defined (FEATURE_VERSION_EC99) || defined (FEATURE_VERSION_K212_20D)||defined(FEATURE_VERSION_K212_ND)||defined(FEATURE_VERSION_W516_C260)||defined(FEATURE_VERSION_K212_BH)
            IMENUCTL_AddItem(pMenu, MULTIMEDIA_RES_FILE_LANG,IDS_MULTIMEDIA_MUSICPLAYER, IDS_MULTIMEDIA_MUSICPLAYER, NULL, 0);
#endif

#if defined(FEATURE_VERSION_K212)||defined(FEATURE_QQ_APP)//def FEATURE_VERSION_K212
...
#endif
#if !defined(FEATURE_VERSION_K232_Y100)&&!defined(FEATURE_VERSION_K232_Y100A)&&!defined(FEATURE_VERSION_W021_GD821)
...
#endif
#if defined (FEATURE_VERSION_VG68) ||defined(FEATURE_VERSION_C01)||defined(FEATURE_VERSION_K292_WSF_CN)
