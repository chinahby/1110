...
static NextFSMAction Handler_STATE_INIT(CMusicPlayer *pMe)
{
    ...
    {
	#if defined (FEATURE_VERSION_C337)||defined (FEATURE_VERSION_K232_Y105A)|| defined (FEATURE_VERSION_W317A) || defined(FEATURE_VERSION_IC241A_MMX)|| defined (FEATURE_VERSION_KK5)//|| defined (FEATURE_VERSION_K212)
