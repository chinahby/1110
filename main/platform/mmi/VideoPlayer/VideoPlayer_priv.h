...
// Use the .bid file if compiling as dynamic applet
   ...
   #endif
#endif
#if defined(FEATURE_VERSION_C316) || defined(FEATURE_VERSION_C337) || defined(FEATURE_VERSION_IC241A_MMX)|| defined (FEATURE_VERSION_KK5)
#else
...
//文件名
#define VIDEOPLAYER_NAMEPART_W SCREEN_WIDTH//47
#define VIDEOPLAYER_NAMEPART_H 32
#define VIDEOPLAYER_NAMEPART_X 0
#define VIDEOPLAYER_NAMEPART_Y 0

//时间
#define VIDEOPLAYER_TIME_W 74
#ifdef FEATURE_VERSION_IN50A
#define VIDEOPLAYER_TIME_H 30
#else
#define VIDEOPLAYER_TIME_H 22
#endif
#define VIDEOPLAYER_TIME_X (SCR_W-146)>>1//50
