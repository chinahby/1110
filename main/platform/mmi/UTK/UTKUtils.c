            ...
            (ui_uim_rpt_buf.rpt_status == UIM_PASS))
        {
            ...
            if ( svc.activated && svc.allocated )
            {
                ...
                if ((uim_cmd_ptr = (uim_cmd_type*) q_get( &uim_free_q )) != NULL)
                {
					...
					#if defined(FEATURE_VERSION_W515V3)||defined(FEATURE_VERSION_S1000T)||defined(FEATURE_VERSION_W027)||defined(FEATURE_VERSION_C316)||defined(FEATURE_VERSION_REGION_INDIA)||defined(FEATURE_VERSION_W516_C260)
