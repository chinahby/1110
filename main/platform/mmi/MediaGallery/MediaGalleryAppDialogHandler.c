   ...
   case IDS_MG_PLAY:
      if(pItemData->attrib != AEE_FA_DIR)
      {
         bRet = MediaGalleryApp_OnDefaultOperate(pMe,
                                                 ...
                                                 wParam,
                                                 dwParam); 
		 // add by pyuangui 2013-08-29  K212需求防闪屏
#if defined(FEATURE_VERSION_K212)||defined(FEATURE_QVGA_INHERIT_K212)||defined(FEATURE_VERSION_K212_BH)//||defined(FEATURE_LOW_MEM_BIGFONT)
         {
