...
#elif defined(FEATURE_VERSION_K232_JST)
#define    PWRON_ANI_FILE                        "fs:/image/pwronoffani/poweron.gif"
#define    PWRON_ANI_FRAME_COUNT                 (1)
#define    PWRON_ANI_RATE                        (6500)
#define    PWROFF_ANI_FILE                       "fs:/image/pwronoffani/poweroff.gif"
#define    PWROFF_ANI_FRAME_COUNT                PWRON_ANI_FRAME_COUNT
#define    PWROFF_ANI_RATE                       (6500)
#else
...
#endif
#endif
#elif defined(FEATURE_VERSION_K212_BIHEE)
#define    PWRON_ANI_FILE                        "fs:/image/pwronoffani/poweron.gif"
#define    PWRON_ANI_FRAME_COUNT                 (1)
#define    PWRON_ANI_RATE                        (8000)
#define    PWROFF_ANI_FILE                       "fs:/image/pwronoffani/poweroff.gif"
...
#define    PWRON_ANI_FILE                        "fs:/image/pwronoffani/poweronoff.gif"
#define    PWRON_ANI_FRAME_COUNT                 (1)
#define    PWRON_ANI_RATE                        (2000)
#define    PWROFF_ANI_FILE                       "fs:/image/pwronoffani/poweronoff.gif"
#define    PWROFF_ANI_FRAME_COUNT                PWRON_ANI_FRAME_COUNT
#define    PWROFF_ANI_RATE                       (2000)
#else
#define    PWRON_ANI_FILE                        "fs:/image/pwronoffani/poweronoff.gif"
#define    PWRON_ANI_FRAME_COUNT                 (1)
#define    PWRON_ANI_RATE                        (7000)
...
#define    PWRON_ANI_FILE                        "fs:/image/pwronoffani/poweron.gif"
#define    PWRON_ANI_FRAME_COUNT                 (1)
#define    PWRON_ANI_RATE                        (3300)
#define    PWROFF_ANI_FILE                       "fs:/image/pwronoffani/poweroff.gif"
#define    PWROFF_ANI_FRAME_COUNT                PWRON_ANI_FRAME_COUNT
#define    PWROFF_ANI_RATE                       (3300)
#else
#define    PWRON_ANI_FILE                        "fs:/image/pwronoffani/poweron.gif"
#define    PWRON_ANI_FRAME_COUNT                 (1)
#define    PWRON_ANI_RATE                        (6000)
...
#define    PWRON_ANI_FILE                        "fs:/image/pwronoffani/poweron.gif"
#define    PWRON_ANI_FRAME_COUNT                 (1)
#define    PWRON_ANI_RATE                        (7000) //(9000)
#define    PWROFF_ANI_FILE                       "fs:/image/pwronoffani/poweron.gif"
#define    PWROFF_ANI_FRAME_COUNT                PWRON_ANI_FRAME_COUNT
#define    PWROFF_ANI_RATE                       (7000) //(9000)
...
#define    PWRON_ANI_FILE                        "fs:/image/pwronoffani/poweron.gif"
#define    PWRON_ANI_FRAME_COUNT                 (1)
#define    PWRON_ANI_RATE                        (15500)
#define    PWROFF_ANI_FILE                       "fs:/image/pwronoffani/poweroff.gif"
#define    PWROFF_ANI_FRAME_COUNT                PWRON_ANI_FRAME_COUNT
#define    PWROFF_ANI_RATE                       (15000)
#elif defined(FEATURE_VERSION_K292_WSF_K8C)
#define    PWRON_ANI_FILE                        "fs:/image/pwronoffani/poweron.gif"
#define    PWRON_ANI_FRAME_COUNT                 (1)
#define    PWRON_ANI_RATE                        (6200)
#define    PWROFF_ANI_FILE                       "fs:/image/pwronoffani/poweroff.gif"
#define    PWROFF_ANI_FRAME_COUNT                PWRON_ANI_FRAME_COUNT
#define    PWROFF_ANI_RATE                       (6200)
...
#define MUSIC_WIDTH            (SCREEN_HEIGHT-53) //78
#define MUSIC_START_WIDTH      (SCREEN_HEIGHT-51) //80
#elif defined(FEATURE_VERSION_W516_C260)
...
typedef struct _CCoreApp
{
    ...
    **********************************/
	...
	#endif
    #if defined(FEATURE_VERSION_C11)|| defined(FEATURE_VERSION_W021_C11)||defined(FEATURE_VERSION_K292)||defined(FEATURE_VERSION_W317A)||defined(FEATURE_VERSION_W021_CT100)||defined(FEATURE_VERSION_K212_20D)||defined(FEATURE_VERSION_V3CM301)||defined(FEATURE_VERSION_K212_ND)   
