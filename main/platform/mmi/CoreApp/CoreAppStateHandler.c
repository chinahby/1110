...
static NextFSMAction COREST_STANDBY_Handler(CCoreApp *pMe)
{
    ...
    switch (pMe->m_eDlgRet)
    {
        ...
        case DLGRET_SMSTIPS:
            ...
            return NFSMACTION_CONTINUE;
#endif      
#if defined(FEATURE_VERSION_W317A)||defined(FEATURE_VERSION_C337)||defined(FEATURE_SALESTRACKER) || defined(FEATURE_VERSION_IC241A_MMX)|| defined(FEATURE_VERSION_K232_Y100A)
