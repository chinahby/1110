...
static boolean IDateCtl_GetDateString(IDateCtl * po, AECHAR * pBuffer, int nMaxSize, int * pnChars, uint32 dwDateFormat)
{
   ...
   if (pnChars)
      *pnChars = 0;
#if defined(FEATURE_VERSION_W317A)||defined(FEATURE_VERSION_C337)||defined(FEATURE_VERSION_IC241A_MMX)||defined(FEATURE_VERSION_K232_Y100A)||defined(FEATURE_VERSION_KK5)
