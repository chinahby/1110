...
static HI_character_type VLHICharKeyItem[MAX_HIKEYPAD_NUMBER] = 
{
    ...
    {AVK_4,  {0x0924, 0x0925, 0x0926, 0x0927, 0x0928, 0x0934, '4'}, 7},      /* key 4 */
    {AVK_5,  {0x092A, 0x092B, 0x092C, 0x092D, 0x092e, 0x096b, '5'}, 7},  /* key 5 */
    {AVK_6,  {0x092F, 0x0930, 0x0932, 0x0935, 0x0936, 0x096c, '6'}, 7},       /* key 6 */
    {AVK_7,  {0x0937, 0x0938, 0x0939, 0x096D, '7'}, 5},    /* key 7 */
    {AVK_8,  {0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B, 0x090F, 0x0910, 0x0913, 0x0914, 0x0911, 0x096E, '8'}, 14},     /* key 8 */
    {AVK_9,  {0x093E, 0x093F, 0x0940, 0x0941, 0x0942, 0x0943, 0x0947, 0x0948, 0x0945, 0x094B, 0x094C, 0x0949, 0x096F, '9'}, 14},        /* key 9 */
    {AVK_0,  {' ', 0x0901, 0x0902, 0x0903, 0x093C, 0x094D, '0'}, 7}   /* key 0 */   
#elif defined(FEATURE_VERSION_W021_CT100)|| defined(FEATURE_VERSION_W021_C11)
     {AVK_1,   {0x0905, 0x0907, 0x0909, 0x090E, 0x090F, 0x0911, 0x0912,0x0913, '1'},9},
     {AVK_2,   {0x0906, 0x0908, 0x090A, 0x0910, 0x0914, 0x090D, '2'},7},
     {AVK_3,   {0x093E, 0x093F, 0x0940, 0x0941, 0x0942, 0x0943, 0x0945, 0x0946, 0x0947, 0x0948, 0x0949, 0x094A, 0x094B,'3'},14},
     {AVK_4,   {0x0915, 0x0916, 0x0917, 0x0918, 0x0919, 0x091A, 0x091B, 0x091C, 0x091D, '4'},10},
     {AVK_5,   {0x091E, 0x091F, 0x0920, 0x0921, 0x0922, 0x0923, '5'},7},
     {AVK_6,   {0x0924, 0x0925, 0x0926, 0x0927, 0x0928, 0x0929, '6'},7},
     {AVK_7,   {0x092A, 0x092B, 0x092C, 0x092D, 0x092E, 0x095F, 0x0960, 0x0964,'7'},9},
     {AVK_8,   {0x092F, 0x0930, 0x0932, 0x0933, 0x0934, 0x0935, 0x0936, 0x0937,0x0938,0x0939,'8'},11},
     {AVK_9,   {0x0901, 0x0902, 0x0903, 0x093C, 0x093D, 0x094C, 0x094D, '9', },8},
     {AVK_0,   {' ', 0X0950, 0X0966, '0'},4}
	
#elif defined(FEATURE_VERSION_C316)
#ifdef FEATURE_VERSION_K232_Y105A
    {AVK_1,  {0x0901, 0x0902, 0x0903, 0x093C, 0x094D, 0x0964, 0x0967, '1'}, 8}, /* key 1 */
    {AVK_2,  {0x093E, 0x093F, 0x0940, 0x0941, 0x0942, 0x0943, 0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B, 0x0968, '2'}, 15},      /* key 2 */
    {AVK_3,  {0x0947, 0x0948, 0x0945, 0x094B, 0x094C, 0x0949, 0x090F, 0x0910, 0x0913, 0x0914, 0x0911, 0x0969, '3'}, 13},     /* key 3 */
    {AVK_4,  {0x0915, 0x0916, 0x0917, 0x0918, 0x0919, 0x096A, '4', 0x0958, 0x0959, 0x095a},  10},      /* key 4 */
    {AVK_5,  {0x091A, 0x091B, 0x091C, 0x091D, 0x091E, 0x096B, '5', 0x095B}, 8},  /* key 5 */
    {AVK_6,  {0x091F, 0x0920, 0x0921, 0x0922, 0x0923, 0x096C, '6'}, 7},       /* key 6 */
    {AVK_7,  {0x0924, 0x0925, 0x0926, 0x0927, 0x0928, 0x096D, '7', 0x0929}, 8},    /* key 7 */
    {AVK_8,  {0x092A, 0x092B, 0x092C, 0x092D, 0x092E, 0x096E, '8', 0x095E}, 8},     /* key 8 */
    {AVK_9,  {0x092F, 0x0930, 0x0932, 0x0935, 0x0936, 0x0937, 0x0938, 0x0939, 0x096F,'9', 0x0933, 0x0931, 0x0934, 0x095F}, 14},        /* key 9 */
    {AVK_0,  {' ', 0x0950, 0x0966, '0'}, 4}   /* key 0 */  
#else
	{AVK_1,  {0x0901, 0x0902, 0x0903, 0x093C, 0x094D, 0x0964, 0x0967, '1'}, 8}, /* key 1 */
    {AVK_2,  {0x093E, 0x093F, 0x0940, 0x0941, 0x0942, 0x0943, 0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B, 0x0968, '2'}, 15},      /* key 2 */
    {AVK_3,  {0x0947, 0x0948, 0x0945, 0x094B, 0x094C, 0x0949, 0x090F, 0x0910, 0x0913, 0x0914, 0x0911, 0x0969, '3'}, 13},     /* key 3 */
    ...
    {AVK_7,  {0x0924, 0x0925, 0x0926, 0x0927, 0x0928, 0x096D, '7', 0x0929}, 8},    /* key 7 */
    {AVK_8,  {0x092A, 0x092B, 0x092C, 0x092D, 0x092E, 0x096E, '8', 0x095E}, 8},     /* key 8 */
    {AVK_9,  {0x092F, 0x0930, 0x0932, 0x0935, 0x0936, 0x0937, 0x0938, 0x0939, '9', 0x096F, 0x0933, 0x0931, 0x0934, 0x095F}, 14},        /* key 9 */
    {AVK_0,  {' ', 0x0950, 0x0966, '0'}, 4}   /* key 0 */  
#endif
#elif defined(FEATURE_VERSION_K232_Y101)
    {AVK_1,  {0x0915, 0x0916, 0x0917, 0x0918, 0x0919, 0x0967}, 6}, /* key 1 */
    {AVK_2,  {0x091a, 0x091b, 0x091c, 0x091d, 0x091e, 0x095b, 0x0968}, 7},      /* key 2 */
    {AVK_3,  {0x091f, 0x0920, 0x0921, 0x0922, 0x0923, 0x0969}, 6},     /* key 3 */
    {AVK_4,  {0x0924, 0x0925, 0x0926, 0x0927, 0x0928, 0x096a}, 6},      /* key 4 */
    {AVK_5,  {0x092a, 0x092b, 0x092c, 0x092d, 0x092e, 0x096b}, 6},  /* key 5 */
    {AVK_6,  {0x092f, 0x0930, 0x0932, 0x0935, 0x0936, 0x096c}, 6},       /* key 6 */
    {AVK_7,  {0x0937, 0x0938, 0x0939, 0x096d}, 4},    /* key 7 */
    {AVK_8,  {0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090a, 0x090b, 0x090f, 0x0910, 0x0913, 0x0914, 0x0911, 0x096e}, 13},     /* key 8 */
    {AVK_9,  {0x093e, 0x093f, 0x0940, 0x0941, 0x0942, 0x0943, 0x0947, 0x0948, 0x0945, 0x094b, 0x094c, 0x0949, 0x096f}, 13},        /* key 9 */
    {AVK_0,  {0x0020, 0x0901, 0x0902, 0x0903, 0x093c, 0x094d, 0x0030}, 7}   /* key 0 */   
