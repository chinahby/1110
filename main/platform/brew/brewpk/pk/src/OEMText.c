...
#define SELECTION_BUFFER_SIZE   (6)
#define CAUDB_SIZE              (140)
#define T9KEYTYPE_NORMAL        (0)
#define T9KEYTYPE_SELECT        (1)
#define T9KEYTYPE_CONTROL       (2)
#define T9KEYTYPE_UNKNOWN       (6)
#define T9_FONT_WIDTH           (24)
...
static boolean T9_CJK_CHINESE_DisplayText(TextCtlContext *pContext)
{
    ...
    {
        MSG_FATAL("***T9_CJK_CHINESE_DisplayText---pContext->rectDisplay.dy=%d----pContext->rectChineseTextInput.dy=%d",pContext->rectDisplay.dy,pContext->rectChineseTextInput.dy,0);
