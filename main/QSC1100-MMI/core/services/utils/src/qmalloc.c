...
$Header: //depot/asic/msmshared/services/common/qmalloc.c#1 $ $DateTime: 2006/02/23 15:00:31 $ $Author: chenroid $
...
===========================================================================*/
  ...
  #define Q_DISP_TASK_HEAP_SIZE (DISP_TASK_BUF_WIDTH  *         \
                                ...
                                DISP_NUM_PACKETS)
#else
  #define Q_DISP_TASK_HEAP_SIZE 0
#endif
...
#define Q_HEAP_SIZE (65536 + Q_DISP_TASK_HEAP_SIZE + \
