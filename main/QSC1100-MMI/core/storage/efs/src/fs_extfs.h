 ...
 *
 * EFS2
 * Copyright (C) 2004-2006,2008 Qualcomm, Inc.
 *
 ...
 * EDIT HISTORY
 *
 * $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_extfs.h#1 $ $DateTime: 2008/05/29 19:19:11 $ $Author: richardp $
 *
