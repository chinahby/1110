...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/inc/fs_config.h#8 $ $DateTime: 2009/01/29 17:35:24 $ $Author: richardp $
 ...
 */
  ...
  #ifdef FEATURE_EFS_LARGE_TRANSACTIONS
    #define FS_BUFFER_NUMBER_BUFFERS        100
  #else
 ...
 */
  ...
  #ifdef FEATURE_EFS_LARGE_TRANSACTIONS
    #define FS_BUFFER_NUMBER_MASK           127
  #else
 ...
 * log page. */
#ifdef FEATURE_EFS_LARGE_TRANSACTIONS
  #define FS_MAX_TRANSACTION_DATA_PAGES (EFS_PAGE_SIZE / 32)
#else
