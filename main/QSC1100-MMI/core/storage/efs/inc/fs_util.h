 ...
 * Copyright (C) 2003-2005, 2007-2008, Qualcomm, Inc.
 *
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/inc/fs_util.h#2 $ $DateTime: 2008/06/03 15:15:30 $ $Author: richardp $
 ...
 *                an equivalent number of elapsed seconds since the base date.
 *
...
/***********************************************************************
 * Safer string utilities.  There are multiple conflicting versions of
 * these available, and since they're so short, just provide our own
 * implementations. */
size_t fs_strlcpy (char *dest, const char *src, size_t dest_size);
size_t fs_strlcat (char *dest, const char *src, size_t dest_size);
