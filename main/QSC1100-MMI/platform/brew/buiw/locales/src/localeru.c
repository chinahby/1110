...
// Format variables, strings, characters and patterns for Russian (Russia)
...
static const AECHAR Currency_NegativePattern []           = { '-','#',' ',0x440,'.',0 };
static const AECHAR Currency_PositivePattern[]            = { '#',' ',0x440,'.',0 }; 
static const AECHAR Currency_CurrencySymbol[]             = { 0x440,'.',0 }; 
...
static const AECHAR DateTime_FullDateLongTimePattern[]    = { 'd',' ','M','M','M','M',' ','y','y','y','y',' ','\'',0x433,'.','\'',' ','H',':','m','m',':','s','s', 0 };  
static const AECHAR DateTime_FullDateShortTimePattern[]   = { 'd',' ','M','M','M','M',' ','y','y','y','y',' ','\'',0x433,'.','\'',' ','H',':','m','m',' ',0 };  
...
static const AECHAR DateTime_LongDatePattern[]            = { 'd',' ','M','M','M','M',' ','y','y','y','y',' ','\'',0x433,'.','\'', 0 };
...
0x43f,0x43e,0x43d,0x435,0x434,0x435,0x43b,0x44c,0x43d,0x438,0x43a , 0,
0x432,0x442,0x43e,0x440,0x43d,0x438,0x43a , 0,
0x441,0x440,0x435,0x434,0x430, 0,
0x447,0x435,0x442,0x432,0x435,0x440,0x433 , 0,
0x43f,0x44f,0x442,0x43d,0x438,0x446,0x430 , 0,
0x441,0x443,0x431,0x431,0x43e,0x442,0x430 , 0,
0x432,0x43e,0x441,0x43a,0x440,0x435,0x441,0x435,0x43d,0x44c,0x435, 0,
   0 };

static const AECHAR DateTime_MonthNames[] = {
0x42f,0x43d,0x432,0x430,0x440,0x44c , 0,
0x424,0x435,0x432,0x440,0x430,0x43b,0x44c , 0,
0x41c,0x430,0x440,0x442 , 0,
0x410,0x43f,0x440,0x435,0x43b,0x44c , 0,
0x41c,0x430,0x439 , 0,
0x418,0x44e,0x43d,0x44c , 0,
0x418,0x44e,0x43b,0x44c , 0,
0x410,0x432,0x433,0x443,0x441,0x442 , 0,
0x421,0x435,0x43d,0x442,0x44f,0x431,0x440,0x44c , 0,
0x41e,0x43a,0x442,0x44f,0x431,0x440,0x44c , 0,
0x41d,0x43e,0x44f,0x431,0x440,0x44c , 0,
0x414,0x435,0x43a,0x430,0x431,0x440,0x44c , 0,
   0 };
...
/* -----------------------------------------------------------------------
    LocaleRU_Ctor 
   --- */
static void LocaleRU_Ctor(LocaleRU *pMe, AEEVTBL(ILocale) *pvt, IShell *piShell, IModule *piModule)
{
...
/* -----------------------------------------------------------------------
    LocaleRU_New  
   --- */
int LocaleRU_New(ILocale **ppo, IShell *piShell, IModule *piModule)
{
   LocaleRU *pMe;
   ...
   pMe = MALLOCREC_VTBL(LocaleRU, ILocale);
   if (!pMe) {
      return ENOMEMORY;
   }
   LocaleRU_Ctor(pMe,GETVTBL(pMe,ILocale),piShell,piModule);
...
int LocaleRU_CreateInstance(IModule *module, IShell *shell, AEECLSID idClass, void **pp)
{
   if (idClass == AEECLSID_LOCALERU) {
      return LocaleRU_New((ILocale **)pp, shell, module);
   }
   *pp = 0;
