...
Copyright (c) 2001,2007-2009 by QUALCOMM, Incorporated.  All Rights Reserved.
...
$Header: //source/qcom/qct/modem/uim/uimdrv/rel/07H1_2/src/uimgen.c#12 $ $DateTime: 2009/05/11 12:03:29 $ $Author: shanmugh $
...
#if defined( FEATURE_UIM_SUPPORT_MULTIPLE_VOLTAGE_CLASSES )  && !defined (FEATURE_UIM_USB_UICC)
            /* Determine the current voltage on the interface */
            switch (uim_current_voltage_class[uim_drv_slot])
            {
              case UIM_VOLTAGE_1_8V:
...
#endif /* if defined (FEATURE_UIM_SUPPORT_MULTIPLE_VOLTAGE_CLASSES) && !defined (FEATURE_UIM_USB_UICC)*/
          } /* protocol is GSM */
#endif /* FEATURE_UIM_UICC */
    ...
    case UIM_READ_ICCID_ST:
      {
        ...
        if (rsp_ptr->cmd_status != UIM_DONE)
        {
#ifdef FEATURE_UIM_HANDLE_ICCID_READ_FAILURE
          if(cmd->hdr.protocol == UIM_UICC)
          {
            /* Toggle the instruction class */
...
#else /* not FEATURE_UIM_HANDLE_ICCID_READ_FAILURE */
          return(UIM_CMD_ERR);
#endif /* FEATURE_UIM_HANDLE_ICCID_READ_FAILURE */
        } /* end if - there was a problem with the APDU */
