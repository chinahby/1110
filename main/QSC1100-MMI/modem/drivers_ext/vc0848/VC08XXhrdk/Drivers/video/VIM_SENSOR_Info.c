...
void SensorGetET_DUMMY(UINT8 index,UINT32 *t,UINT8 *Ggain, UINT8 *AWB)
{
	
}

void SensorSetET_DUMMY(UINT8 index,UINT32 t,UINT8 Ggain,UINT8 *AWB)
{
...
void SensorGetET_OV2640_BAYER(UINT8 index,UINT32 *t,UINT8 *Ggain, UINT8 *AWB)
{
...
void SensorSetET_OV2640_BAYER(UINT8 index,UINT32 t,UINT8 Ggain,UINT8 *AWB)
{
    UINT8 i,uVal1,uVal2;
    UINT16 uTemp, vBlank;
    TI2cBatch AeData[3];
...
void SensorGetET_OV3630_BAYER(UINT8 index,UINT32 *t,UINT8 *Ggain, UINT8 *AWB)
{
#if (BOARD_TYPE==VC0820_FPGA)
    UINT8 pclkrate;
#else
...
void SensorSetET_OV3630_BAYER(UINT8 index,UINT32 t,UINT8 Ggain,UINT8 *AWB)
{
#if (BOARD_TYPE==VC0820_FPGA)
    UINT8 uVal1,uVal2;
#else
...
void SensorGetET_MT9T012_BAYER(UINT8 index,UINT32 *t,UINT8 *Ggain, UINT8 *AWB)
{
#if (BOARD_TYPE==VC0820_FPGA)
#else
    UINT8 i;
...
void SensorSetET_MT9T012_BAYER(UINT8 index,UINT32 t,UINT8 Ggain,UINT8 *AWB)
{
#if (BOARD_TYPE==VC0820_FPGA)
#else
    UINT8 i;
...
void SensorGetET_MT9M112_BAYER(UINT8 index,UINT32 *t,UINT8 *Ggain, UINT8 *AWB)
{
    UINT8 i;
    UINT16 uTemp;
    VIM_SIF_I2cWriteWord(0xf0,0,1);
...
void SensorSetET_MT9M112_BAYER(UINT8 index,UINT32 t,UINT8 Ggain,UINT8 *AWB)
{
    UINT8 i;
    UINT16 uTemp;
    TI2cBatch AeData;
...
void SensorGetET_MT9M112_YUV(UINT8 index,UINT32 *t,UINT8 *Ggain, UINT8 *AWB)
{
	
}

void SensorSetET_MT9M112_YUV(UINT8 index,UINT32 t,UINT8 Ggain,UINT8 *AWB)
{
...
void SensorGetET_OV9650_YUV(UINT8 index,UINT32 *t,UINT8 *Ggain, UINT8 *AWB)
{
	
}

void SensorSetET_OV9650_YUV(UINT8 index,UINT32 t,UINT8 Ggain,UINT8 *AWB)
{
...
void SensorGetET_MT9M112_YUV_NEW(UINT8 index,UINT32 *t,UINT8 *Ggain, UINT8 *AWB)
{
	
}

void SensorSetET_MT9M112_YUV_NEW(UINT8 index,UINT32 t,UINT8 Ggain,UINT8 *AWB)
{
