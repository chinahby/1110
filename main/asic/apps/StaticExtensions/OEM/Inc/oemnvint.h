...
#define PROFILENUMBER                     6                          // «Èæ∞ƒ£ Ω÷÷¿‡
#else
*/
#define PROFILENUMBER                     5                          // «Èæ∞ƒ£ Ω÷÷¿‡
//#endif
//ƒ¨»œµƒ∂Ã–≈¡Â…
...
#define OEMNV_BACKLIGHT_LEVEL_7      (OEMNV_BACKLIGHT_BASE + 7 * OEMNV_BACKLIGHT_OFFSET + OEMNV_BACKLIGHT_OFFSET) //‘ˆº”≤Ó±£¨∑Ò‘Ú≤ª√˜œ‘°£
#else
#if defined(FEATURE_VERSION_C500BE)                /*Œ™∫£∑Àµƒ∆¡–ﬁ∏ƒ*/
...
#elif defined(FEATURE_VERSION_C337) || defined(FEATURE_VERSION_W317A) || defined(FEATURE_VERSION_IC241A_MMX)
#define OEMNV_EMERT_SEZE                       4
#define OEMNV_EMERG_NUM_LEN                    3
#define OEMNV_EMERG_NUM_ONE                    "100"
#define OEMNV_EMERG_NUM_TWO                    "101"
...
#ifdef FEATURE_USES_MMS
#define MAX_MMS_STORED 5//◊Ó∂‡÷ªƒ‹¥Ê10Ãı≤ 
...
{
    AECHAR          szName[MAX_FMRADIO_NAME_CHAR + 1];              //π„≤•Ã®√˚
    uint16          wChannel;                                       //–≈µ¿∫≈
} sChanInfo;

#ifdef FEATURE_VERSION_W208S
#define MAX_SMS_RESTRICT 40//◊Ó∂‡÷ªƒ‹…Ë40∏ˆ∫⁄√˚µ•
