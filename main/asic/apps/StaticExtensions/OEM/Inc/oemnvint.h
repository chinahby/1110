...
#define OEMNV_ALERT_TYPE_INIT {OEMNV_ALERTTYPE_VIBANDRINGER,OEMNV_ALERTTYPE_OFF,OEMNV_ALERTTYPE_VIB,OEMNV_ALERTTYPE_VIBRINGER,OEMNV_ALERTTYPE_VIBANDRINGER} 
#elif defined(FEATURE_NO_VIBRATE) //xxzhen
...
#define OEMNV_ALERT_TYPE_INIT {OEMNV_ALERTTYPE_RINGER,OEMNV_ALERTTYPE_OFF,OEMNV_ALERTTYPE_OFF,OEMNV_ALERTTYPE_RINGER,OEMNV_ALERTTYPE_RINGER} 
#else
#define OEMNV_ALERT_TYPE_INIT {OEMNV_ALERTTYPE_RINGER,OEMNV_ALERTTYPE_VIB,OEMNV_ALERTTYPE_VIB,OEMNV_ALERTTYPE_VIBRINGER,OEMNV_ALERTTYPE_VIBANDRINGER} 
#endif
...
// 短信提示  
#if defined(FEATURE_NO_VIBRATE) //xxzhen
#define OEMNV_SMS_RINGER_INIT {OEMNV_ALERTTYPE_RINGER,OEMNV_ALERTTYPE_OFF,OEMNV_ALERTTYPE_OFF,OEMNV_ALERTTYPE_RINGER,OEMNV_ALERTTYPE_RINGER} 
#elif defined (FEATURE_VERSION_C260_IC18) || defined (FEATURE_VERSION_IC241A_MMX)
#ifdef FEATURE_VERSION_C260_IC19
...
#if defined(FEATURE_VERSION_W021_CT100) || defined(FEATURE_VERSION_W021_C11)|| defined(FEATURE_VERSION_K232_Y100A)
// 铃声音量     
...
#else
#if defined(FEATURE_VERSION_C500BE)                /*为海匪的屏修改*/
#define OEMNV_BACKLIGHT_LEVEL_DARK        1
#define OEMNV_BACKLIGHT_LEVEL_NORMAL      2
#define OEMNV_BACKLIGHT_LEVEL_BRIGHT      3
#elif defined(FEATURE_DISP_160X128)|| defined(FEATURE_DISP_128X160)
#define OEMNV_BACKLIGHT_LEVEL_DARK        1
#define OEMNV_BACKLIGHT_LEVEL_NORMAL      3
#define OEMNV_BACKLIGHT_LEVEL_BRIGHT      4
#else
#define OEMNV_BACKLIGHT_LEVEL_DARK        1
#define OEMNV_BACKLIGHT_LEVEL_NORMAL      5
#define OEMNV_BACKLIGHT_LEVEL_BRIGHT      6
#endif
#endif

#if defined(FEATURE_VERSION_EC99)
#define OEMNV_BACKLIGHT_LEVEL       (OEMNV_BACKLIGHT_LEVEL_BRIGHT)
#elif defined(FEATURE_VERSION_W516_C260)||defined(FEATURE_VERSION_K232_Y100A)||defined(FEATURE_VERSION_K232_Y105A)
#define OEMNV_BACKLIGHT_LEVEL       (OEMNV_BACKLIGHT_LEVEL_BRIGHT)
#elif defined(FEATURE_VERSION_K212_ND)
...
#define OEMNV_ESN_TRACK_NUM    			"51718" 
#define OEMNV_ESN_TRACK_NUM_TWO    		"51718" 
#else
...
#elif defined (FEATURE_VERSION_K212_ND)
#define   OEMNV_DEFAULTRINGER       10 
#elif defined(FEATURE_VERSION_W516_C260)||defined(FEATURE_VERSION_W021_GD821)
#define   OEMNV_DEFAULTRINGER       12  
#elif defined(FEATURE_VERSION_EC99)
#define   OEMNV_DEFAULTRINGER       11
#elif defined(FEATURE_VERSION_K212_20D)
...
#define   OEMNV_SHUTDOWN_MUSIC 11 
#elif defined FEATURE_VERSION_K232_Y101
#define   OEMNV_STARTUP_MUSIC 8 
#define   OEMNV_SHUTDOWN_MUSIC 8 
...
#endif
#else
#if defined(FEATURE_USES_LOWMEM)
...
#define   OEMNV_SHUTDOWN_MUSIC 5
#endif
#elif defined(FEATURE_VERSION_W021_GD821)
#define   OEMNV_STARTUP_MUSIC 10
#define   OEMNV_SHUTDOWN_MUSIC 11
#else
#define   OEMNV_STARTUP_MUSIC 11
...
#define OEMNV_CAMERA_SIZE_DEFAULT OEMNV_CAMERA_SIZE_INDEX_2
#else
