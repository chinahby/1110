...
#if defined (FEATURE_VERSION_EC99)||defined(FEATURE_VERSION_K212_ND)||defined(FEATURE_VERSION_IC241A_MMX)|| defined(FEATURE_VERSION_K232_Y100A)||defined(FEATURE_VERSION_K292_WSF_CN)
...
//Add By zzg 2010_11_23
                ...
                case AVK_CLR:
#endif
					#if ((defined FEATURE_VERSION_C337) || (defined FEATURE_VERSION_C316) || defined(FEATURE_VERSION_IC241A_MMX)|| defined(FEATURE_VERSION_K232_Y100A)|| defined (FEATURE_VERSION_KK5)||defined(FEATURE_VERSION_K292_WSF_CN))
					m_bEnabled = FALSE;
                ...
                case AVK_STAR:
                    ...
                    if (UNLOCKSTATE_1PRESSED == sUnlockState)
                    {
                        ...
                        #if defined(FEATURE_VERSION_W027) || defined(FEATURE_VERSION_M74)||defined(FEATURE_VERSION_W516_C260)
                        {
                            IBacklight  *Backlight;
                            (void)ISHELL_CreateInstance(sgpShell,AEECLSID_BACKLIGHT,(void **)&Backlight);
                            if(IBACKLIGHT_IsEnabled(Backlight))
                    ...
                    else
                    {
                        if(!bDrawMessage)
                        {
                        	#if defined( FEATURE_VERSION_S1000T)||defined( FEATURE_VERSION_W515V3)||defined( FEATURE_VERSION_K212)||defined(FEATURE_LOW_MEM_BIGFONT)
                        	#else
...
boolean OEMKeyguard_HandleEvent(AEEEvent  evt,    uint16    wParam,uint32     dwParam)
{
...
#endif		
#if defined(FEATURE_LEFT_SOFTKEY_AND_STAR_UNLOCK)|| defined(FEATURE_VERSION_K212)|| defined(FEATURE_VERSION_EC99)||defined(FEATURE_VERSION_K212_BH)|| defined(FEATURE_VERSION_W516_C260)
	if((wParam == AVK_CLR)||(wParam == AVK_END)||(wParam == AVK_INFO)||(wParam == AVK_SEND)||(wParam == AVK_1)||
		   ...
		   (wParam == AVK_RIGHT)||(wParam == AVK_DOWN)||(wParam == AVK_UP)||(wParam == AVK_LEFT)||(wParam == AVK_CAMERA)||(wParam == AVK_MUSIC)||(wParam == AVK_SELECT)||(wParam == AVK_SOFT1))
	{
		IBacklight  *Backlight;
        (void)ISHELL_CreateInstance(sgpShell,AEECLSID_BACKLIGHT,(void **)&Backlight);
        if(!IBACKLIGHT_IsEnabled(Backlight))
...
#endif
#if  defined(FEATURE_VERSION_W515V3)|| defined(FEATURE_VERSION_C11)|| defined(FEATURE_VERSION_C180)|| defined(FEATURE_VERSION_1110W516) || defined(FEATURE_VERSION_W027)||defined(FEATURE_LEFT_SOFTKEY_AND_STAR_UNLOCK)|| defined(FEATURE_VERSION_K212)||defined(FEATURE_VERSION_K212_HUALU)|| defined(FEATURE_VERSION_EC99)||defined(FEATURE_VERSION_W516_C260)
...
#else
#if defined (FEATURE_VERSION_EC99)||defined(FEATURE_VERSION_K212)||defined(FEATURE_VERSION_K212_HUALU)
		if(0)
#else
        if(wParam == AVK_CLR)	
#endif
...
#if defined(FEATURE_VERSION_W515V3) || defined(FEATURE_VERSION_C11) || defined(FEATURE_VERSION_C180)|| defined(FEATURE_VERSION_1110W516) || defined(FEATURE_VERSION_W027)||defined(FEATURE_LEFT_SOFTKEY_AND_STAR_UNLOCK)||defined(FEATURE_VERSION_W516_C260)
        if(wParam== AVK_CLR||wParam == AVK_END || wParam == AVK_POWER || wParam == AVK_HEADSET_CONNECT || wParam == AVK_HEADSET_DISCONNECT)
#elif defined (FEATURE_VERSION_EC99) || defined(FEATURE_VERSION_K212)||defined(FEATURE_VERSION_K212_BH)
