...
{    
	...
	#if defined(FEATURE_VERSION_SMART) || defined(FEATURE_VERSION_M8) || defined(FEATURE_VERSION_M8P)|| defined(FEATURE_VERSION_W027)||defined(FEATURE_VERSION_K212_ND)
...
static void OEMALERT_HandleRingerAlertTimer(void *pUser)
{
    ...
    MSG_FATAL("***zzg OEMALERT_HandleRingerAlertTimer 111 m_ringCurVol=%x***", pMe->m_ringCurVol, 0, 0);
