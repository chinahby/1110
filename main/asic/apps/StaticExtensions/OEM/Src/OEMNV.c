                             ...
                             uint32      nWStrSize)
{
   ...
   for (i = 0; i < nAlphaSize; i++) {
      if(0xFF == alpha[i])
      {
         ...
         {
            // Èç¹ûµ±Ç°µÄ³¤¶ÈÊÇÅ¼ÊýÎ»£¬ÔòÖ¤Ã÷µ±Ç°ÅÐ¶ÏµÄÊÇÒ»¸ö×Öµ±ÖÐ
            // µÄÁíÒ»¸ö×Ö½Ú£¬ÄÇÃ´Ö±½ÓÌø¹ý²¢Ôö¼Ó³¤¶È
            if((len&0x1) == 0x0)
            {
                len++;
                continue;
            ...
            // Èç¹ûÊÇUnicodeÂë£¬ÔòÐèÒª½øÒ»²½ÅÐ¶ÏÊÇ·ñµ½´ï½áÎ²£¬ÒòÎª
            // UnicodeÊÇË«×Ö½Ú£¬¿ÉÄÜº¬ÓÐ0xff(Èç:0x51ff)£¬Í¬Ê±Ò²ÓÐ¿ÉÄÜ
            // ÒÑ¾­µ½´ïbufferµÄ½áÎ²£¨0x0£©
