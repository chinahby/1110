...
void OEM_RestoreFactorySetting( void )
{
   ...
   //键盘音量
  {
   ...
   STRCPY(oemi_cache.NOCONNECT_ENABLE,OEMNV_CALLFORWARD_NOCONNECT_ENABLE);  //CFGI_CALLFORWARD_NOCONNECT_ENABLE
   STRCPY(oemi_cache.NOCONNECT_DISABLE,OEMNV_CALLFORWARD_NOCONNECT_DISABLE); //CFGI_CALLFORWARD_NOCONNECT_DISABLE
   STRCPY(oemi_cache.ANYWAY_ENABLE,OEMNV_CALLFORWARD_ANYWAY_ENABLE);  //CFGI_CALLFORWARD_ANYWAY_ENABLE
   STRCPY(oemi_cache.ANYWAY_DISABLE,OEMNV_CALLFORWARD_ANYWAY_DISABLE); //CFGI_CALLFORWARD_ANYWAY_DISABLE
