...
#define MAX_EMERGENCY_NUM_LEN      11
...
enum{
	...
	CFGI_MULTIMEDIA_LOCK_CHECK,
	CFGI_MOBILETRACKER_PASSWORD,        //type = uint16
    CFGI_MOBILETRACKER_PASSWORD_CHECK,  //type = boolean
    CFGI_MOBILE_TRACKER_PHONENUMBTWO,
    CFGI_MOBILE_TRACKER_PHONENUMBTHREE,
    CFGI_MOBILE_TRACKER_CONTECT,
    CFGI_MOBILE_TRACKER_BACK,
#endif
   ...
   CFGI_CALL_REJECT_AUTO_MSG,
    ...
    CFGI_PROXY_PARAMS_IP,
    CFGI_PROXY_PARAMS_PORT,
    CFGI_LANGUAGE_MOD,
#ifdef FEATURE_ANALOG_TV
    CFGI_TV_OR_CAMERA,
    CFGI_TV_SETCHANNL,
    ...
    CFGI_FACTORYSET_COUNT,
    CFGI_FACTORYSET_COUNT_EX,
	...
	CFGI_MOBILE_TRACKER_PHONENUMB,  //CFGI_MOBILE_TRACKER_PHONENUMB
	CFGI_MOBILE_TRACKER_IMSI,       //CFGI_MOBILE_TRACKER_IMSI
	CFGI_MOBILE_TRACKER_SETNUM,     //CFGI_MOBILE_TRACKER_SETNUM
	CFGI_SMS_TRACKER_SEND_B,        // CFGI_SMS_TRACKER_SEND_B
	CFGI_SMS_TRACKER_TIME,          //CFGI_SMS_TRACKER_TIME
	CFGI_SMS_TRACKER_NUMBER,        //CFGI_SMS+TRACKER_NUMBER
#endif
    ...
    CFGI_LEMON_TWIST_NUM,
    CFGI_LEMON_TWIST_SMSINFO,
#endif
...
//Add End
...
#endif
    CFGI_RUIM_ID_SAVE_TABLE,
#ifdef FEATURE_IC19_ESN_TRACKER
    CFGI_ESN_TRACKING_COMBINATION,
#endif
    CFGI_ESN_TRACK_NUMBER,
    CFGI_ESN_TRACK_NUMBER_TWO,
    CFGI_ESN_TRACK_TIME,
    CFGI_COUNT_OF_MAIN,
	...
	CFGI_SOUND_BO_INDIAL,
	CFGI_SOUND_BO_PHONEBOOK,
	#endif
#endif 
    CFGI_LOW_MEMERY_FEATURE, //add by ydecai 20131125
