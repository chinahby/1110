@echo off
@set PROJECTNAME=H2021C
@set BASEPROJECTNAME=W021
@set QUALCOMMNAME=SBNAALZ
@set QUALCOMMNAME_BUILD=SXNAALZ
@set RESOURCEDIR=H2021C
@set MODELVERSION=%BASEPROJECTNAME%_CAM_FM_V1.0_20110111
@set HWVERSION=W021_MB_V0.1
