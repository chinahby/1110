@echo off
@set PROJECTNAME=W203P
@set BASEPROJECTNAME=W203P
@set QUALCOMMNAME=SBNAALZ
@set QUALCOMMNAME_BUILD=SXNAALZ
@set RESOURCEDIR=common
@set MODELVERSION=%PROJECTNAME%_CAM_FM_BT_V1.0
@set HWVERSION=W203_MB_V1.0
