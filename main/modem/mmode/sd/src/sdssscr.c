...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/mmode/sd/rel/08H1/src/sdssscr.c#16 $
...
static const sdssscr_elem_u_type  ssscr_called_cdma_acq_micro[] = {
  ...
  NEW_ACQ                             /*   Start a new acquisition */
  ACQ_CNT( TEMP_LST, BEST_PREF, 0, 1) /* Try acquiring an available sys */
...
#error code not present
  ...
  ssscr_called_cdma_acq_micro,        /* SDSSSCR_CDMA_ACQ_MICRO */
