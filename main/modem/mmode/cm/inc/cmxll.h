...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/mmode/cm/rel/08H1_QSC1110_3.X/inc/cmxll.h#1 $
...
#include "cmll.h"                          /* Common lower layer interface */
...
===========================================================================*/
static snd_packets_type *cm_snd_get_buf_else_err_fatal
(
  void
);
...
=========================================================================*/
extern void cm_wms_bc_partial_addr_match
(
