...
$Header: //source/qcom/qct/modem/wms/wms/rel/qsc1100_05.04.00/src/WMSE/wmsdc.c#3 $ $DateTime: 2010/02/23 11:51:47 $ $Author: rajang $
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
  ...
  else if (TRUE != dc_s_ptr->is_traffic_channel_enabled) 
  {
