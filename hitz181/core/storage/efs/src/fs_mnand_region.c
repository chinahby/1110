...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_mnand_region.c#1 $ $DateTime: 2008/12/12 11:11:10 $ $Author: richardp $
...
fs_mnand_region_create (efs_device_t dev, fs_mnand_super_t super)
{
  ...
  uint32 tmp;
  const uint32 SECT_PER_CLUST = FS_MNAND_SECTORS_PER_CLUSTER;
  ...
  super->data->page_size = EFS_PAGE_SIZE;
  super->data->sect_per_clust = SECT_PER_CLUST;
  super->data->block_size = FS_MNAND_CLUSTERS_PER_BLOCK;
