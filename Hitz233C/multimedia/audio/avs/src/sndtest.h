...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/multimedia/audio/6k/ver1/avs/main/latest/src/sndtest.h#10 $ $DateTime: 2009/10/23 05:48:44 $ $Author: kmodak $
...
#endif /* FEATURE_AUDIO_CALIBRATION */
/* Row 24                       */
    byte adie_reg;              /* ADIE register to write to            */
    byte adie_mask;             /* ADIE mask                            */
    byte adie_val;              /* Value to write through mask to ADIE  */
    byte adie_exec;             /* Command to execute write/read        */
...
/* FM over BT AG */
  ...
  */
  ...
  9 : 48K
  */
  byte    file_pb_smpl_rate;

  byte    qcp_file_rec_op;
  byte    qcp_file_rec_format;
