...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/securemsm/crypto/main/latest/src/secencarm.h#1 $ $DateTime: 2007/06/26 13:17:46 $ $Author: jmiera $
...
/*---------------------------------------------------------------------------
  Dummy type for a cipher ARM instance when the ARM platform is not supported
---------------------------------------------------------------------------*/
struct secencarm_instance_s
{
  void*  dummy;
