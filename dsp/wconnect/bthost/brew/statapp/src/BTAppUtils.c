...
{
  pItem->pImage       = NULL;
  pItem->pszResImage  = BTAPP_RES_FILE;
  pItem->pszResText   = BTAPP_RES_FILE;
  ...
  AECHAR*       pwName )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_BT_NAME, 
                        wBuf1, sizeof( wBuf1 ) );
  ...
  uint8         linkKeyType )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_LINK_KEY, 
                        wBuf1, sizeof( wBuf1 ) );
  ...
  AECHAR*       wIdleTimeout)
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_IDLE_TIMEOUT, 
                        wBuf1, sizeof( wBuf1 ) );
  ...
  AECHAR*       wMaxLatency)
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_MAX_LATENCY, 
                        wBuf1, sizeof( wBuf1 ) );
  ...
  AEEBTBDAddr*  pAddr )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_BD_ADDR, 
                        wBuf1, sizeof( wBuf1 ) );
  ...
  AEEBTSecurity sec )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_SECURITY, 
                        wBuf1, sizeof( wBuf1 ) );
  switch ( sec )
  {
    case AEEBT_SEC_NONE:
  ...
  AEEBTServiceClass svcCls )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_SVC_CLS, 
                        wBuf1, sizeof( wBuf1 ) );
  ...
  uint8*  pLMPFeatures )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_LMP_FEAT, 
                        wBuf1, sizeof( wBuf1 ) );
  if ( (pLMPFeatures[0] == 0) && 
       (pLMPFeatures[1] == 0) && 
       (pLMPFeatures[2] == 0) )
  {
    ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_NOT_AVAIL, 
                          wBuf2, sizeof( wBuf2 ) );
  }
  else
  {
  ...
  uint16  uLen )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_PORT_STATUS, 
                        wBuf1, sizeof( wBuf1 ) );
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, strID, 
                        wBuf2, sizeof(wBuf2) );
  WSPRINTF( pwStr, uLen*sizeof( AECHAR ), wBuf1, wBuf2 );
  wBuf1[ 0 ] = (AECHAR)(unsigned char) ('\n');
  wBuf1[ 1 ] = (AECHAR)(unsigned char) ('\0');
  ...
  uint16  uLen )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_BYTES_SENT, 
                        wBuf1, sizeof( wBuf1 ) );
  ...
  uint16  uLen )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_BYTES_RCVD, 
                        wBuf1, sizeof( wBuf1 ) );
  ...
  boolean bMaster )
{
  ...
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, IDS_LABEL_DEV_ROLE, 
                        wBuf1, sizeof( wBuf1 ) );
  ISHELL_LoadResString( pMe->a.m_pIShell, BTAPP_RES_FILE, 
...
)
{
  ...
  ai.pszResImage = ai.pszResText = BTAPP_RES_FILE;
  ai.pImage = NULL;
  ai.wImage = imageID;
