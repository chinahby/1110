...
$Header: //source/qcom/qct/multimedia/qtv/utils/list/main/latest/inc/deeplist.h#1 $
...
public:
   ...
   { 
      ...
      bool *used = QTV_New_Array( bool, size() );
   ...
   virtual void append(const T& element) 
   {
      if (_size == 0) {          
         ...
         ListPair<T> *lastPair = QTV_New_Args( ListPair<T>, (element) );
