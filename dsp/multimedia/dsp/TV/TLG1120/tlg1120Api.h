...
#define TLG_VERSION_MINOR   (2)
#define TLG_VERSION_PATCH   (0)
#define TLG_VERSION_BUILD   (0)
#define TLG_VERSION_CUSTM	("ZABC")
...
#define TLG_InitCheckAddr                   (0xF945UL)
...
... //If you compile to here, that is wrong, you should check the macro TLG_EMBEDDED_TIMERS!!!
#define TLG_Delay(a)
