...
#define OEMCAMERA_RSP_COMMAND_MAX         15  // CAM_CMD_SETPARM can have 2 pending callbacks (Two sets allowed)
...
#define OEMCAMCORDER_BITRATE_MIN_VALUE 32000
#define OEMCAMCORDER_BITRATE_MAX_VALUE 512000
#define OEMCAMCORDER_BITRATE_DEFAULT_VALUE 64000 
