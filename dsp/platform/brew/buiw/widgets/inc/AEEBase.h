...
#include "AEE.h"  // AEEVTBL()  (include AEEComDef.h)
...
//
//   Note that 'me' (the base interface) should derive from IQueryInterface
...
//   object's primary vtable being a superset of IQueryInterface.
//
//
// Usage Example:
//
