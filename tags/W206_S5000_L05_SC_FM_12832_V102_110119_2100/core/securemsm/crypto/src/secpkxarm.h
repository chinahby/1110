...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/securemsm/crypto/main/latest/src/secpkxarm.h#3 $ 
  $DateTime: 2009/04/23 12:31:05 $ $Author: etarolli $
...
#define SECPKXARM_MAX_BITS      (SECCRYPT_PKX_MAX_MOD_SIZE * 8) 
