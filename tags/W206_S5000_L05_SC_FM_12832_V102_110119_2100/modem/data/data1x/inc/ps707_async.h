...
/*===========================================================================
    ...
    $Header: //source/qcom/qct/modem/data/1x/707/main/lite/inc/ps707_async.h#1 $ $DateTime: 2008/04/11 08:25:15 $ $Author: nsivakum $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
10/22/03    sv     Added PS707_ASYNC_DEF_MSS declaration.
...
typedef struct
{
  ...
  -------------------------------------------------------------------------*/
  int ptcl_cleanup_timeout_handle;
  /*-------------------------------------------------------------------------
...
/*---------------------------------------------------------------------------
  Structure that holds state info for async call w.r.t PS task.
---------------------------------------------------------------------------*/
extern ps707_async_state_type   ps707_async_state;
