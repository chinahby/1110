...
/*===========================================================================
  ...
  $Header: //depot/asic/qsc1100/services/dsm/dsm_init.c#6 $
...
---------------------------------------------------------------------------*/
  ...
  #define DSMI_DIAG_ITEM_SIZ                   1024
      ...
      #define DSMI_DIAG_ITEM_DONT_EXCEED          2
      #define DSMI_DIAG_ITEM_FEW_MARK             5
      #define DSMI_DIAG_ITEM_MANY_MARK           10 
