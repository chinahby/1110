...
$Header: //source/qcom/qct/wconnect/bthost/pf/rel/00.00.26/src/oi_bt_assigned_nos.h#1 $ 
...
*
*    #3        23 Apr 2004            JH
* Remove BIT22 and BIT23 which conflicts with the definition of the same name
*  in .../services/1x/cp/distreg.h
*
...
/**
  @file  
    ...
    Last updated October 31st 2002
*/
 ...
 * @note BIT14 and BIT15 are reserved.
 * @{
 */

#define OI_SERVICE_CLASS_LIMITED_DISCOVERABLE  BIT13
//BIT14 and BIT15 reserved
#define OI_SERVICE_CLASS_POSITIONING           BIT16
#define OI_SERVICE_CLASS_NETWORKING            BIT17
#define OI_SERVICE_CLASS_RENDERING             BIT18
#define OI_SERVICE_CLASS_CAPTURING             BIT19
#define OI_SERVICE_CLASS_OBJECT_TRANSFER       BIT20
#define OI_SERVICE_CLASS_AUDIO                 BIT21
#ifdef OI_CODE /* conflict with definition in .../services/1x/cp/distreg.h */
#error code not present
#else
#define OI_SERVICE_CLASS_TELEPHONY             0x00400000
#define OI_SERVICE_CLASS_INFORMATION           0x00800000
#endif /* OI_CODE */
/**@}*/
...
#define OI_BT_MINOR_DEVICE_CLASS_KEYBOARD           BIT6
#define OI_BT_MINOR_DEVICE_CLASS_POINTING_DEVICE    BIT7
#define OI_BT_MINOR_DEVICE_CLASS_COMBO_KEYBOARD_POINTING  (BIT6 | BIT7)
...
#define OI_BT_MINOR_DEVICE_CLASS_DISPLAY  BIT4
#define OI_BT_MINOR_DEVICE_CLASS_CAMERA   BIT5
#define OI_BT_MINOR_DEVICE_CLASS_SCANNER  BIT6
#define OI_BT_MINOR_DEVICE_CLASS_PRINTER  BIT7
 ...
 * The Open Interface base UUID, OI_UUID128, is defined in oi_bt_spec.h
 */
...
#ifndef OI_CODE
#define OI_UUID_PhoneBookAccess_Client                0x112E  /**< See Phone Book Access Profile (PBAP) */
#define OI_UUID_PhoneBookAccess_Server                0x112F  /**< See Phone Book Access Profile (PBAP) */
#endif /* OI_CODE */
...
#define OI_UUID_MAX_VALUE                             0x1302  /**< The current maximum UUID value */
...
#define OI_ATTRID_SupportedRepositories             0x0314  /**< [BPAP] */
 ...
 * For the primary language, this is 0x0100, as described in section E.5.1.7 of 
...
/**
 * @def OI_ATTRID_RANGE
 * This macro constructs an attribute range as defined in the SDP section (part E) of 
...
#define OI_CHARSET_ISO_8859_1       BIT0        /**< Latin alphabet No. 1 */
#define OI_CHARSET_ISO_8859_2       BIT1        /**< Latin alphabet No. 2 */
#define OI_CHARSET_ISO_8859_3       BIT2        /**< Latin alphabet No. 3 */
#define OI_CHARSET_ISO_8859_4       BIT3        /**< Latin alphabet No. 4 */
#define OI_CHARSET_ISO_8859_5       BIT4        /**< Latin/Cyrillic alphabet */
#define OI_CHARSET_ISO_8859_6       BIT5        /**< Latin/Arabic alphabet */
#define OI_CHARSET_ISO_8859_7       BIT6        /**< Latin/Greek alphabet */
#define OI_CHARSET_ISO_8859_8       BIT7        /**< Latin/Hebrew alphabet */
#define OI_CHARSET_ISO_8859_9       BIT8        /**< Latin alphabet No. 5 */
#define OI_CHARSET_ISO_8859_10      BIT9        /**< Latin alphabet No. 6 */
#define OI_CHARSET_ISO_8859_13      BIT10       /**< Latin alphabet No. 7 */
#define OI_CHARSET_ISO_8859_14      BIT11       /**< Latin alphabet No. 8 */
#define OI_CHARSET_ISO_8859_15      BIT12       /**< Latin alphabet No. 9 */
#define OI_CHARSET_GB_2312_80       BIT13       /**< Chinese (People's Republic of China) */
#define OI_CHARSET_SHIFT_JIS        BIT14       /**< Japanese */
#define OI_CHARSET_KS_C_5601_1987   BIT15       /**< Korean */
#define OI_CHARSET_BIG5             BIT16       /**< Chinese (Taiwan) */
#define OI_CHARSET_TIS_620          BIT17       /**< Thai */
