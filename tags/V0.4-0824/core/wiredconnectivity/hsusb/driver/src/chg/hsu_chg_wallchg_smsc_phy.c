...
in case the USB PHY is SMSC External PHY. 
...
$Header: //source/qcom/qct/core/hsusb/driver/main/latest/src/chg/hsu_chg_wallchg_smsc_phy.c#8 $
$DateTime: 2009/04/03 13:40:22 $ $Author: jaychoi $
