...
$Header: //source/qcom/qct/modem/1x/cp/rel/1h08/inc/mctrans.h#1 $ $DateTime: 2009/05/29 03:54:56 $ $Author: prabhuk $
...
#error code not present
  ...
  #else
  fch;                          /* Indicates if RC info is included. */
  #endif
...
/* Maximum number of transaction objects available to be put in outstanding 
   or active queues
*/
#define MCTRANS_MAX_TRANSACTIONS  10
#else
...
typedef struct
{
  ...
  */
  ...
  /* During initializing of this array please make sure that all actions 
     are initialized.
  */
  mctrans_action_handler_type action_handler[MCTRANS_MAX_ACTION+1];
...
SIDE EFFECTS
===========================================================================*/
void mctrans_process_default_action_time_tick(void);
