...
Copyright (c) 2003,2008 - 2009 QUALCOMM, Incorporated and its licensors.  All 
...
$Header: //source/qcom/qct/modem/uim/gstk/rel/07H1_2/src/gstk_terminal_rsp.h#2 $
...
SEE ALSO
  None
===========================================================================*/
extern gstk_status_enum_type gstk_provide_local_information_cnf(
  const gstk_provide_local_info_cnf_type* provide_local_info_cnf);
