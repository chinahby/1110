...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/securemsm/crypto/main/latest/src/seccryptarm.h#1 $ $DateTime: 2007/06/26 13:17:46 $ $Author: jmiera $
...
/* ARM task watchdog timer */
extern rex_timer_type    seccryptarm_rpt_timer;
