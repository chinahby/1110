...
/*============================================================================
  ...
  $Header: //depot/asic/qsc1100/tools/hostdl/HOSTDL.14.00/ap_usb.c#1 $ $DateTime: 2008/01/21 21:01:41 $ $Author: opham $
  Integrated from P402:  //depot/common-sw/armprg/armprg-9.0/MSM6275/ap_usb.c#3 
...
/*===========================================================================
 FUNCTION usb_ep_get_descriptor_addr
...
/*===========================================================================
FUNCTION usb_ep_clear_done_status
DESCRIPTION
...
FUNCTION usb_ep_enable_done_int
...
/*===========================================================================  
FUNCTION usb_ep_enable_endpoint 
...
/*===========================================================================  
FUNCTION usb_ep_disable_endpoint 
...
/*===========================================================================
FUNCTION usb_ep_set_toggle_bit
...
/*===========================================================================
FUNCTION usb_ep_clear_toggle_bit
...
/*===========================================================================
FUNCTION usb_ep_enable_xfilled
...
/*===========================================================================
FUNCTION usb_clear_DMA_channel
...
FUNCTION usb_disable_ep_done_int
...
/*===========================================================================  
FUNCTION usb_ep_clear_xbuf_int_status 
...
/*===========================================================================  
FUNCTION usb_ep_clear_ybuf_int_status 
...
/*===========================================================================
FUNCTION usb_send_zero_length_pkt
...
/*===========================================================================
FUNCTION usb_wait_for_dma_done
...
FUNCTION usb_do_handle_setup_msgs
...
FUNCTION usb_process_ctrl_done
...
)
{
  ...
  if (HWIO_USB_INT_STATUS_INM(HWIO_USB_INT_STATUS_FUNC_INTR_STATUS_BMSK)
      == 0)
  {
...
)
{
  ...
  DPRINTF(("usb_init: entry\n"));

  /* Check if USB is configured */
  if (HWIO_IN(USB_DEVICE_ADDRESS) == 0)
  {
    DPRINTF(("usb_init: NO USB exit\n"));
