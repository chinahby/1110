...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_efs2_names.c#1 $ $DateTime: 2008/05/29 19:19:11 $ $Author: richardp $
    ...
    unsigned *is_long)
{
  ...
  if (len > FS_SHORTNAME_THRESHOLD) {
    ...
    ASSERT (pos + 16 < sizeof(static_name_key));
    ...
    memcpy (static_name_key + pos, name, len);
    pos += len;
