...
/* =======================================================================
  ...
  $Header: //source/qcom/qct/modem/rfa/pmic/chg_task/main/latest/app/src/chg_autocharging.h#20 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/07/09   hs      Removed unnecessary header file inclusion.
09/17/09   hs      Added support in the AutoChargingManager class to save the
                   charging status.
08/05/09   hs      Added support for bad battery detection.
06/15/09   hs      Added supported for charging after battery removed/re-inserted.
...
public:
     ...
     */
    boolean IsCharging(){ return mGeneralStatus.is_charging; };
    /*! \brief This static member function returns if the charger hardware is valid
     *  \note This function should get called when there is a need to know
     *  if the charger hardware is valid or not 
     */
    boolean IsChargerValid(){ return mGeneralStatus.is_charger_valid; };
    /*! \brief This member function returns if the battery is valid or not
     *  \note This function should get called when there is a need to know
     *  if the battery is valid or not 
     */
    boolean IsBatteryValid(){ return mGeneralStatus.is_battery_valid; };
    /*! \brief This member function returns the UI (User Interface) status
     *  for the current state
     *  \note This function should get called when there is a need to know
     *  the UI status of the current state. 
     */
    chg_ui_event_type GetUiEvent(){ return mGeneralStatus.ui_event; };
    /*! \brief This member function returns the general charging status
     *  for the current state
     *  \note This function should get called when there is a need to know
     *  the general charging stastus. 
     */
    chg_general_status_type GetGeneralStatus() { return mGeneralStatus; };
protected:
...
protected:
     ...
     *  \li getCurrentState()
     */
    pm_auto_chg_state_name_type        mPreviousState;
    ...
    /*! \brief The status of the BATT_TEMP interrupt 
     *  \details This variable will be updated by the following member function(s): 
     *  \li EventFired()
     */
    bool                                 mBattTemptIrqTriggered;
    /*! \brief The status of the BATT_CONNECT interrupt 
     *  \details This variable will be updated by the following member function(s): 
     *  \li EventFired()
     */
    bool                                 mBattConnectIrqTriggered;
    ...
    /*! \brief The status of charging failure 
     *  \details This variable will be updated by the following member function(s): 
     *  \li getCurrentState()
     *  \li EventFired()
     */
    bool                                 mIsChargingFailed;
    ...
    /*! \brief The general charging status
     *  \details This variable will be updated by the following member function(s): 
     *  \li getCurrentState()
     *  \li stopAutoCharging()
     */
    chg_general_status_type              mGeneralStatus;
protected:
    /*! \brief A contructor.
     *  \param none
     *  \return NA
