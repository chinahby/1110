...
$Header: //source/qcom/qct/modem/uim/su/baselines/qsc1110/rel/3.3.71/uim/gstk/src/gstk.c#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/22/10   dd      Provide local time and time zone in PLI
07/21/09   dd      Adding Time Zone information
07/07/09   sg      Assigned gstk_mmgsdi_client_id inside gstk_mmgsdi_cmd_cb
06/19/09   dd      Featurized NVMEM to not be used in test framework
...
)
{
  ...
  gstk_mmgsdi_client_id = cnf_ptr->client_id_reg_cnf.response_header.client_id;
  switch(cnf)
  {
