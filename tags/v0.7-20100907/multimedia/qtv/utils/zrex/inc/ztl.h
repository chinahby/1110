...
$Header: //source/qcom/qct/multimedia/qtv/utils/zrex/main/latest/inc/ztl.h#7 $
...
SIDE EFFECTS:
  None.
========================================================================== */
	virtual ~ZArrayBase () {	if (m_pBuffer) QTV_Free( m_pBuffer );}
/* ======================================================================
FUNCTION:
  ZArrayBase::Clear
...
SIDE EFFECTS:
  None.
========================================================================== */
	int32 GetLength () const {return m_nLength;}
};
