...
/*===========================================================================
  ...
  $Header: //depot/asic/msmshared/services/diag/MSMSHARED_DIAG_1.2/msgcfg.h#28 $
...
#define MSG_SSID_QDSP6_LAST    8500
...
/* To will be initialized by msg_init() */
static uint32 msg_rt_masks_qdsp6[sizeof (msg_bld_masks_qdsp6) /
