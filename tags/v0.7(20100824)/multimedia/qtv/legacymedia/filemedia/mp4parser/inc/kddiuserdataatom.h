...
$Header: //source/qcom/qct/multimedia/qtv/legacymedia/filemedia/mp4parser/main/latest/inc/kddiuserdataatom.h#9 $
...
========================================================================== */
#if (defined(FEATURE_MP4_KDDI_META_DATA) || defined(FEATURE_MP4_KDDI_TELOP_TEXT))
...
public:
    ...
    OSCL_STRING getContentPropertyTitle() { return _title; }
    OSCL_STRING getContentPropertyCopyRight() { return _copyRight; }
    OSCL_STRING getContentPropertyAuthor() { return _author; }
    OSCL_STRING getContentPropertyMemo() { return _memo; }
    uint32      getAuthorDLLVersion() { return _dllVersion; }

private:
    OSCL_STRING _title;
    OSCL_STRING _copyRight;
    OSCL_STRING _author;
    OSCL_STRING _memo;
    uint32      _dllVersion;
};
...
public:
    ...
    OSCL_STRING getGPSSurveyData() { return _gpsGeodeticSurveyData; }
    
    OSCL_STRING getPositoningMethod() { return _positioningMethod; }
    
    OSCL_STRING getPositioningName() { return _positioningPointName; }
    
    OSCL_STRING getGPSDate() { return _gpsDate; }
...
private:
    ...
    OSCL_STRING              _gpsGeodeticSurveyData;
    OSCL_STRING              _positioningMethod;
    OSCL_STRING              _positioningPointName;
    OSCL_STRING              _gpsDate;
