...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/mmode/sd/rel/08H1/src/sd.c#22 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/25/09   rk      When service status is limited reginal and for pref reason
                   multimode scan or orig_resume just update pref and continu
...
#error code not present
  ...
  ** service aquisition in be case of multimode scan cases
  ** and PS data resume 
  */
