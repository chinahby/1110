...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/data/1x/1xrlp/main/lite/src/dsrlprsq.h#1 $ $DateTime: 2007/11/06 01:21:33 $ $Author: nsivakum $
...
SIDE EFFECTS   NONE
===========================================================================*/
#define DSRLPRSQ_CNT(rscb_ptr)\
  (q_cnt( &rscb_ptr->state.reseq_q ))
