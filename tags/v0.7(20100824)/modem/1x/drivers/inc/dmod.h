...
$Header: //source/qcom/qct/modem/1x/drivers/rel/1h08/inc/dmod.h#3 $
...
/* this file does not need any of these includes, but files that include
   this file need these includes.... so put them back in for now, and
