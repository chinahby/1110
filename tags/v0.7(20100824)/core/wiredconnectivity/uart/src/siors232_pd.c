...
/*===========================================================================
  ...
  $Header: //depot/asic/msmshared/drivers/uart/02.00.XX/siors232_pd.c#10 $ $DateTime: 2009/06/15 11:44:09 $ $Author: cmihalik $
...
#if(( defined( FEATURE_FIRST_UART  ) && ( SIORS_FIRST_UART_TYPE  == HW_UART ))  ||\
    ( defined( FEATURE_SECOND_UART ) && ( SIORS_SECOND_UART_TYPE == HW_UART ))  ||\
    ( defined( FEATURE_THIRD_UART  ) && ( SIORS_THIRD_UART_TYPE  == HW_UART ))) //{ 
...
static void siors_pd_dp_rx_isr1(void)
{
...
static void siors_pd_dp_rx_isr2(void)
{
...
static void siors_pd_dp_rx_isr3(void)
{
...
#ifdef FEATURE_SECOND_UART
static void siors_pd_isr2(void)
{
...
#ifdef FEATURE_THIRD_UART
static void siors_pd_isr3(void)
{
