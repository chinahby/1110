...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/securemsm/crypto/main/latest/inc/secrndtask.h#2 $ 
  $DateTime: 2008/11/26 12:08:06 $ $Author: hvimadal $
...
#define SECRND_DOG_RPT_TIMER_SIG  0x0001   /* signal set when watchdog expires*/
