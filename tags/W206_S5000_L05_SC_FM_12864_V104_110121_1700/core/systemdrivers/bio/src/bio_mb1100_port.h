...
$Header: //depot/asic/qsc1100/drivers/bio/bio_mb1100_port.h#2 $
$DateTime: 2009/09/18 00:05:45 $
$Author: kmaliped $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/18/09    km     Bio Changes to Support UART Data Call.
...
#ifdef FEATURE_BIO_SUPPORT_FOR_UART_DC

#define BIO_DCD_REG                   GPIO_REG_0
#define BIO_DCD_M                     0x10000000
#define BIO_DCD_ON_V                  0x10000000
#define BIO_DCD_OFF_V                 0x0001

#define BIO_RI_REG                    GPIO_REG_0
#define BIO_RI_O_25_M                 0x20000000
#define BIO_RI_ON_V                   0x20000000
#define BIO_RI_OFF_V                  0x0000

#define BIO_DTR_REG                   GPIO2_REG_0
#define BIO_DTR_M                     0x00000400
#define BIO_DTR_ON_V                  0x0400
#define BIO_DTR_OFF_V                 0x0000
#define BIO_DTR_GPIO_INT              44

#define BIO_DSR_REG                   GPIO_REG_1
#define BIO_DSR_M                     0x00000040
#define BIO_DSR_ON_V                  0x00000040
#define BIO_DSR_OFF_V                 0x0000

#else /* FEATURE_BIO_SUPPORT_FOR_UART_DC */
...
#endif /* FEATURE_BIO_SUPPORT_FOR_UART_DC */
