...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/inc/fs_unicode.h#2 $ $DateTime: 2008/06/03 15:15:30 $ $Author: richardp $
...
#include "customer.h"           /* For the default conversion assignment */
...
extern struct unicode_conversion_ops *fs_convert;
