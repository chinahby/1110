...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_mnand_pcache.c#1 $ $DateTime: 2008/12/12 11:11:10 $ $Author: richardp $
                      ...
                      fs_mnand_super_t super, int fresh_start)
{
  ...
  fs_paranoia_register (mnand_pcache_pages, sizeof(mnand_pcache_pages),
                        "mnand_pcache_pages");
