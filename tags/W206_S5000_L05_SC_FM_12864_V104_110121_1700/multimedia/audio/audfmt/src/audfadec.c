...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/multimedia/audio/6k/ver1/audfmt/main/latest/src/audfadec.c#6 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/08/09   bk      Fixed lint error.
...
{//block for fixing lint errors.
            audmain_song_config_type *aac_config;
            aac_config = &adec_ptr->aac_config;
	    memset((void *)aac_config, 0, sizeof(audmain_song_config_type));
}
#endif
}
