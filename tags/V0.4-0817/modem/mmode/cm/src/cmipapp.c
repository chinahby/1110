...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/mmode/cm/rel/08H1/src/cmipapp.c#2 $
...
)
{
  ...
  app_cb_ptr->cmipapp_cmd_simple_flash_func_ptr           =   NULL;
...
)
{
  ...
  /* Answer function assigment */
  cmipapp_arr[app_id].app_cb.cmipapp_cmd_simple_flash_func_ptr = 
                                simple_flash_func_ptr;
