#ifndef __DISP_TM_SCTN128X128_H__
#define __DISP_TM_SCTN128X128_H__




#define TM_CSTN128x128_DISPLAY_ON_C  0x29
#define TM_CSTN128x128_DISPLAY_OFF_C  0x28
#define TM_CSTN128x128_SET_START_ADDRESS_C   0x2a
#define TM_CSTN128x128_SET_END_ADDRESS_C   0x2b
#define TM_CSTN128x128_RAM_WRITE_C 0x2c
#define TM_CSTN128x128_SOFT_RESET_C 0x01
