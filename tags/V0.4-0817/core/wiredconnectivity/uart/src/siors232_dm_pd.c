...
/*===========================================================================
  ...
  $Header: //depot/asic/msmshared/drivers/uart/02.00.XX/siors232_dm_pd.c#12 $ $DateTime: 2009/06/15 11:44:09 $ $Author: cmihalik $
...
#if(( defined( FEATURE_FIRST_UART  ) && ( SIORS_FIRST_UART_TYPE  == HW_UARTDM ))  ||\
    ( defined( FEATURE_SECOND_UART ) && ( SIORS_SECOND_UART_TYPE == HW_UARTDM ))  ||\
    ( defined( FEATURE_THIRD_UART  ) && ( SIORS_THIRD_UART_TYPE  == HW_UARTDM ))) //{ 
...
static void siors_dm_dp_rx_isr(void)
{
...
static void siors_dm_dp_rx_isr2(void)
{
...
===========================================================================*/
static void siors_dm_set_uart_clock_freq
(
    siors_port_type *rs_port,           /* Port                         */
...
#ifdef FEATURE_SECOND_UART
static void siors_dm_isr2(void)
{
