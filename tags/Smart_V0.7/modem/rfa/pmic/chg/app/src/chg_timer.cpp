...
/* =======================================================================
  ...
  $Header: //source/qcom/qct/modem/rfa/pmic/chg_task/main/latest/app/src/chg_timer.cpp#13 $
...
void TimerEventGenerator::AddListenerForMaxChargeTimeDetection(ChargingEventListener*)
{

}
void TimerEventGenerator::RemoveListenerForMaxChargeTimeDetection(ChargingEventListener*)
{
   ...
   /* Iterate the queue */
    while( item_ptr != NULL )
    {
        ...
        if( item_ptr2 != NULL )
        {
            ...
            #ifndef T_WINNT
            /* Stop the timer */
            (void)timer_clr( (timer_type*)item_ptr->mTimerToken, T_NONE );
            #endif
...
void RexTimerEventGenerator::AddListenerForMaxChargeTimeDetection(ChargingEventListener *listener)
{
    AddListener(listener, 
                AUTO_CHARGING_MAX_CHARGE_T*60000,
                0,
                false);
}
void RexTimerEventGenerator::RemoveListenerForMaxChargeTimeDetection(ChargingEventListener *listener)
{
    RemoveListener(listener,
                   AUTO_CHARGING_MAX_CHARGE_T*60000,
                   0);
