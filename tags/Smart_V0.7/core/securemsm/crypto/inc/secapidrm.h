...
/*=========================================================================
  ...
  $Header: //source/qcom/qct/core/securemsm/crypto/main/latest/inc/secapidrm.h#1 $DateTime: $ $Author: jmiera $					  					  
...
typedef union secapidrm_key_storage_s
{
	...
	uint32  aes_unwrapped_key[SECCRYPT_ENC_AES256_KEY_SIZE >> 2];
