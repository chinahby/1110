...
$Header: //source/qcom/qct/multimedia/core/qdspservices/6k/ver1/qdspsvcs/main/latest/src/qdsp.h#6 $ $DateTime: 2009/08/13 21:56:32 $ $Author: pandiara $
...
FUNCTION qdsp_higher_app_module_enabled

DESCRIPTION
  Checks for whether apps higher than a given app has their modules
  enabled or not
...
RETURN VALUE
  boolean
===========================================================================*/
extern boolean qdsp_higher_app_module_enabled( qdsp_app_type app_id );
