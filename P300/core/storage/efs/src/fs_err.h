 ...
 * Copyright (C) 2002--2006, 2008--2009 Qualcomm, Inc.
 *
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_err.h#4 $ $DateTime: 2009/07/07 09:58:57 $ $Author: ebuller $
...
/* If we are compiling for boot redirect to oemsbl_error_handler */
  ...
  #include "oemsbl_error_handler.h"
  #define FS_ERR_FATAL(fmt,a,b,c) OEMSBL_ERR_FATAL()

  /* err_(en/dis)able_fs_log not available in boot */
  #define FS_ERR(fmt,a,b,c)  (void)0
