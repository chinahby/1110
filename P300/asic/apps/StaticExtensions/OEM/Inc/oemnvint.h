...
// 短信提示  
#define OEMNV_SMS_RINGER_INIT {OEMNV_ALERTTYPE_VIBANDRINGER,OEMNV_SMS_OFF,OEMNV_ALERTTYPE_VIBANDRINGER,OEMNV_ALERTTYPE_VIBANDRINGER,OEMNV_ALERTTYPE_VIBANDRINGER} 
// 来电铃声选择           
...
#else
#ifdef FEATURE_USES_LOWMEM
#define   OEMNV_STARTUP_MUSIC 0
#define   OEMNV_SHUTDOWN_MUSIC 0
#else
#define   OEMNV_STARTUP_MUSIC 11
#define   OEMNV_SHUTDOWN_MUSIC 12
#endif
