...
$Header: //source/qcom/qct/multimedia/ipl/common/main/latest/inc/ipl_types.h#4 $
===========================================================================*/
...
#ifndef IPL_DEBUG_STANDALONE                      /* set true when testing */
  #include "customer.h"
  #include "comdef.h"
  #include "msg.h"
#if (!((defined FEATURE_WINCE) || (defined __GNUC__)))
  #include "rex.h"
#endif /*!(FEATURE_WINCE || __GNUC__) */
#else
...
typedef enum
{
  ...
  IPL_PAD_RGB888,       /* RGB0 data (32 bit word, padded on low order)    */
