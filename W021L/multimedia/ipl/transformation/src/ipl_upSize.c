...
$Header: //source/qcom/qct/multimedia/ipl/transformation/main/latest/src/ipl_upSize.c#6 $
...
/*------------------------------------------------------------------------*/
  ...
  if( !i_img_ptr->imgPtr || !o_img_ptr->imgPtr )
  {
    IPL2_MSG_FATAL( "ipl2_upsize_crop failed for passing NULL  /\
     ...
     i_img_ptr->imgPtr,  o_img_ptr->imgPtr, 0 );
...
/*------------------------------------------------------------------------*/
  ...
  {
    IPL2_MSG_FATAL( "ipl2_rot_add_crop failed i_param = %x, /\
  ...
  else
  {
    ...
    if ( !i_img_ptr->imgPtr || !o_img_ptr->imgPtr )
    {
      IPL2_MSG_FATAL( "ipl2_upsize_QCIF failed  i_img_ptr->imgPtr = %x, /\
...
)
{
  ...
  if (i_param == NULL)
  {
    IPL2_MSG_FATAL( " ipl2_upsize_rot_crop_133 Bad i_param", 0, 0, 0);
    return( IPL_FAILURE );
  }
...
)
{
  ...
  if ( !i_param || !i_img_ptr || !o_img_ptr )
  {
    IPL2_MSG_FATAL( "ipl2_upsize_rot_crop_150x failed i_param = %x, /\
                   i_img_ptr = %x, o_img_ptr = %x", (uint32) i_param,
                   (uint32) i_img_ptr, (uint32) o_img_ptr);
    return( IPL_FAILURE );
  }
  else
  {
    ...
    if ( !i_img_ptr->imgPtr || !o_img_ptr->imgPtr )
    {
      IPL2_MSG_FATAL( "ipl2_upsize_rot_crop_150x failed i_img_ptr->imgPtr=%x, /\
                   o_img_ptr->imgPtr = %x", (uint32) i_img_ptr->imgPtr,
                   (uint32) o_img_ptr->imgPtr, 0);
...
)
{
  ...
  if ( !i_param || !i_img_ptr || !o_img_ptr )
  {
    IPL2_MSG_FATAL( "ipl2_upsize_rot_crop_2x failed i_param = %x, /\
                   i_img_ptr = %x, o_img_ptr = %x", (uint32) i_param,
                   (uint32) i_img_ptr, (uint32) o_img_ptr);
    return( IPL_FAILURE );
  }
  else
  {
    ...
    if ( !i_img_ptr->imgPtr || !o_img_ptr->imgPtr )
    {
      IPL2_MSG_FATAL( "ipl2_upsize_rot_crop_2x failed i_img_ptr->imgPtr=%x, /\
                   o_img_ptr->imgPtr = %x", (uint32) i_img_ptr->imgPtr,
                   (uint32) o_img_ptr->imgPtr, 0);
...
)
{
  ...
  if ( !i_param || !i_img_ptr || !o_img_ptr )
  {
    IPL2_MSG_FATAL( "ipl2_upsize_rot_crop_250x failed i_param = %x, /\
                   i_img_ptr = %x, o_img_ptr = %x", (uint32) i_param,
                   (uint32) i_img_ptr, (uint32) o_img_ptr);
    return( IPL_FAILURE );
  }
  else
  {
    ...
    if ( !i_img_ptr->imgPtr || !o_img_ptr->imgPtr )
    {
      IPL2_MSG_FATAL( "ipl2_upsize_rot_crop_250x failed i_img_ptr->imgPtr=%x, /\
                   o_img_ptr->imgPtr = %x", (uint32) i_img_ptr->imgPtr,
                   (uint32) o_img_ptr->imgPtr, 0);
...
)
{
  ...
  ocdx = ocrop->dx - 1; // the first pixel we do for free 
  ocdy = ocrop->dy; 
  icdx = icrop->dx - 1; // the first pixel we do for free
  icdy = icrop->dy; 
