...
$Header: //source/qcom/qct/multimedia/audio/6k/ver1/avs/main/latest/src/audadsp_vocoder.c#6 $ $DateTime: 2009/10/14 07:34:24 $ $Author: c_ypaida $

when       who     what, where, why
--------   ---    -------------------------------------------------------------
10/14/09   yp      CMI changes for SCMM 
07/30/09   kkm     AAC playback is not resumed after voice call end if mixing
                   is enabled. voc_state_adie_stall is modified to call in
                   mixer statemachine instead of vocoder statemachine.
06/30/09   kk      Added more F3 messages for incall code.
