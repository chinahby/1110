...
$Header: //source/qcom/qct/multimedia/audio/6k/ver1/avs/main/latest/src/qdspcmd.h#29 $ $DateTime: 2009/10/26 08:18:28 $ $Author: sudhirk $
...
#define QDSP_VOC_MODE_4GV_WB_VOIP_V  0x000F  /* CDMA 4GV WB VOIP Vocoder mode */
...
===========================================================================*/
extern void qdsp_cmd_set_4gv_wb_timewarp(
  boolean  enable,
  uint16   run_length,
  uint16   phase_offset
);
...
SIDE EFFECTS
  None
===========================================================================*/
extern void qdsp_cmd_dec_semaphore_flag_set(boolean flag);
