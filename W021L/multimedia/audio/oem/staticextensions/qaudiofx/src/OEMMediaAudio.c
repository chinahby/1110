...
Notice that changes are listed in reverse chronological order.
  ...
  $Header: //source/qcom/qct/multimedia/audio/oem/staticextensions/qaudiofx/main/latest/src/OEMMediaAudio.c#6 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/14/09    bk     Added code for missing timer definition in 
                   OEMMediaAudioEnvFX_New.
...
/* defining timer pme->cmxCmdTimer here so that it can be used in subsequent 
 functions like OEMMediaAudioFX_Release() and OEMMediaAudioFX_GetAndWait etc. 
*/
   rex_def_timer(&pme->cmxCmdTimer, &ui_tcb, AEE_MEDIA_SIG); 
