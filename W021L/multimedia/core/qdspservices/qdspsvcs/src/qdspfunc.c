...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/multimedia/core/qdspservices/6k/ver1/qdspsvcs/main/latest/src/qdspfunc.c#4 $ $DateTime: 2009/08/13 21:56:32 $ $Author: pandiara $
...
DESCRIPTION
  Checks for whether app higher than a given has its module enabled or not
...
RETURN VALUE
  boolean
===========================================================================*/
boolean qdsp_higher_app_module_enabled( qdsp_app_type app_id )
{  
  qdsp_app_type app;

  for(app = (qdsp_app_type)0; app < app_id; ++app)
  {
