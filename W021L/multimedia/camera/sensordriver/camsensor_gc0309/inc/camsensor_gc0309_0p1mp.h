#ifndef CAMSENSOR_GC0309_0P1MP_H
#define CAMSENSOR_GC0309_0P1MP_H
...
#define GC0309_0P1MP_SENSOR_ID       (0xa0)

#define GC0309_0P1MP_I2C_SLAVE_ID (0x42)
...
FUNCTION      CAMSENSOR_GC0309_0P1MP_INIT
...
FUNCTION      CAMSENSOR_GC0309_0P1MP_START
...
boolean camsensor_gc0309_0p1mp_start(camsensor_static_params_type *camsensor_params);


/*===========================================================================

FUNCTION      CAMSENSOR_GC0309_0P1MP_SNAPSHOT_CONFIG
...
FUNCTION      CAMSENSOR_GC0309_0P1MP_RAW_SNAPSHOT_CONFIG
...
FUNCTION      CAMSENSOR_GC0309_0P1MP_VIDEO_CONFIG
...
FUNCTION      CAMSENSOR_GC0309_0P1MP_POWER_UP
...
FUNCTION      CAMSENSOR_GC0309_0P1MP_POWER_DOWN
...
FUNCTION      CAMSENSOR_GC0309_0P1MP_WRITE_EXPOSURE_GAIN
...
===========================================================================*/
camera_ret_code_type camsensor_gc0309_0p1mp_write_exposure_gain(uint16 gain, uint32 line);


/*===========================================================================

FUNCTION      CAMSENSOR_GC0309_0P1MP_MOVE_FOCUS
...
===========================================================================*/
camera_ret_code_type camsensor_gc0309_0p1mp_move_focus(camsensor_move_focus_enum_type  direction,
                                                  int32                           num_steps);


/*===========================================================================

FUNCTION      CAMSENSOR_GC0309_0P1MP_SET_DEFAULT_FOCUS
...
===========================================================================*/
camera_ret_code_type camsensor_gc0309_0p1mp_set_default_focus(void);
