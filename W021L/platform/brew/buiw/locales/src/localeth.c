...
// Format variables, strings, characters and patterns for Thai
...
static const AECHAR Currency_NegativePattern []           = { 0xe3f,'-','#',0 }; 
static const AECHAR Currency_PositivePattern[]            = { 0xe3f,'#',0 }; 
static const AECHAR Currency_CurrencySymbol[]             = { 0xe3f,0 }; 
...
static const AECHAR DateTime_AMDesignator[]               = { 0x0E01,0x0E48,0x0E2D,0x0E19,0x0E40,0x0E17,0x0E35,0x0E48,0x0E22,0x0E07,0 };
static const AECHAR DateTime_DateSeparator[]              = { '/',0 };
static const AECHAR DateTime_PMDesignator[]               = { 0x0E2B,0x0E25,0x0E31,0x0E07,0x0E40,0x0E17,0x0E35,0x0E48,0x0E22,0x0E07,0 };
...
static const AECHAR DateTime_ShortMonthNames[] = {
	0x0E21,0x002E,0x0E04,0x002E,0,
	0x0E01,0x002E,0x0E1E,0x002E,0,
	0x0E21,0x0E35,0x002E,0x0E04,0x002E,0,
	0x0E40,0x0E21,0x002E,0x0E22,0x002E,0,
	0x0E1E,0x002E,0x0E04,0x002E,0,
	0x0E21,0x0E34,0x002E,0x0E22,0x002E,0,
	0x0E01,0x002E,0x0E04,0x002E,0,
	0x0E2A,0x002E,0x0E04,0x002E,0,
	0x0E01,0x002E,0x0E22,0x002E,0,
	0x0E15,0x002E,0x0E04,0x002E,0,
	0x0E1E,0x002E,0x0E22,0x002E,0,
	0x0E18,0x002E,0x0E04,0x002E,0, 
   0 };

static const AECHAR DateTime_DayNames[] = {
	0x0E27,0x0E31,0x0E19,0x0E08,0x0E31,0x0E19,0x0E17,0x0E23,0x0E4C,0,
	0x0E27,0x0E31,0x0E19,0x0E2D,0x0E31,0x0E07,0x0E04,0x0E32,0x0E23,0,
	0x0E27,0x0E31,0x0E19,0x0E1E,0x0E38,0x0E18,0,
	0x0E27,0x0E31,0x0E19,0x0E1E,0x0E24,0x0E2B,0x0E31,0x0E2A,0x0E1A,0x0E14,0x0E35,0,
	0x0E27,0x0E31,0x0E19,0x0E28,0x0E38,0x0E01,0x0E23,0x0E4C,0,
	0x0E27,0x0E31,0x0E19,0x0E40,0x0E2A,0x0E32,0x0E23,0x0E4C,0,
	0x0E27,0x0E31,0x0E19,0x0E2D,0x0E32,0x0E17,0x0E34,0x0E15,0x0E22,0x0E4C,0,
  0 };

static const AECHAR DateTime_MonthNames[] = {
	0x0E21,0x0E01,0x0E23,0x0E32,0x0E04,0x0E21,0,
	0x0E01,0x0E38,0x0E21,0x0E20,0x0E32,0x0E1E,0x0E31,0x0E19,0x0E18,0x0E4C,0,
	0x0E21,0x0E35,0x0E19,0x0E32,0x0E04,0x0E21,0,
	0x0E40,0x0E21,0x0E29,0x0E32,0x0E22,0x0E19,0,
	0x0E1E,0x0E24,0x0E29,0x0E20,0x0E32,0x0E04,0x0E21,0,
	0x0E21,0x0E34,0x0E16,0x0E38,0x0E19,0x0E32,0x0E22,0x0E19,0,
	0x0E01,0x0E23,0x0E01,0x0E0E,0x0E32,0x0E04,0x0E21,0,
	0x0E2A,0x0E34,0x0E07,0x0E2B,0x0E32,0x0E04,0x0E21,0,
	0x0E01,0x0E31,0x0E19,0x0E22,0x0E32,0x0E22,0x0E19,0,
	0x0E15,0x0E38,0x0E25,0x0E32,0x0E04,0x0E21,0,
	0x0E1E,0x0E24,0x0E28,0x0E08,0x0E34,0x0E01,0x0E32,0x0E22,0x0E19,0,
	0x0E18,0x0E31,0x0E19,0x0E27,0x0E32,0x0E04,0x0E21,0, 
   0 };
...
/* -----------------------------------------------------------------------
    LocaleTH_Ctor 
   --- */
static void LocaleTH_Ctor(LocaleTH *pMe, AEEVTBL(ILocale) *pvt, IShell *piShell, IModule *piModule)
{
...
/* -----------------------------------------------------------------------
    LocaleTH_New  
   --- */
int LocaleTH_New(ILocale **ppo, IShell *piShell, IModule *piModule)
{
   LocaleTH *pMe;
   ...
   pMe = MALLOCREC_VTBL(LocaleTH, ILocale);
   if (!pMe) {
      return ENOMEMORY;
   }
   LocaleTH_Ctor(pMe,GETVTBL(pMe,ILocale),piShell,piModule); 
...
int LocaleTH_CreateInstance(IModule *module, IShell *shell, AEECLSID idClass, void **pp)
{
   if (idClass == AEECLSID_LOCALETH) {
      return LocaleTH_New((ILocale **)pp, shell, module);
   }
   *pp = 0;
