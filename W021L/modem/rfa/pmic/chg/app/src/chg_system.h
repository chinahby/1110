...
/* =======================================================================
  ...
  $Header: //source/qcom/qct/modem/rfa/pmic/chg_task/main/latest/app/src/chg_system.h#8 $
...
public:
    ...
    /*! \brief This member function provides an interface for adding the specific listener, 
     *  passed by the parameter, for starting the USB valid events 
     *  (::CHG_SYSTEM__USB_VALID)
     *  \param listener A listener that wants to gets informed when a USB device is attached 
     *  \return void
     *  \note This function should be called when a class wants to be informed when a  
     *  USB device is attached.
     */ 
    void AddListenerForUsbValid(ChargingEventListener *listener);
    /*! \brief This member function provides an interface for removing the specific listener, 
     *  passed by the parameter, for USB valid events 
     *  (::CHG_SYSTEM__USB_VALID)
     *  \param listener A listener that no longer wants to gets informed when a USB device
     *  is attached
     *  \return void
     *  \note This function should be called when a class no longer wants to be informed 
     *  when a USB device is attached.
     */ 
    void RemoveListenerForUsbValid(ChargingEventListener *listener);     
    /*! \brief This member function provides an interface for adding the specific listener, 
     *  passed by the parameter, for starting the USB invalid events 
     *  (::CHG_SYSTEM__USB_INVALID)
     *  \param listener A listener that wants to gets informed when a USB device is removed 
     *  \return void
     *  \note This function should be called when a class wants to be informed when a  
     *  USB device is removed.
     */ 
    void AddListenerForUsbInvalid(ChargingEventListener *listener);
    /*! \brief This member function provides an interface for removing the specific listener, 
     *  passed by the parameter, for USB invalid events 
     *  (::CHG_SYSTEM__USB_INVALID)
     *  \param listener A listener that no longer wants to gets informed when a USB device
     *  is removed
     *  \return void
     ...
     */ 
    void RemoveListenerForUsbInvalid(ChargingEventListener *listener);     
    /*! \brief This member function provides an interface for adding the specific listener, 
