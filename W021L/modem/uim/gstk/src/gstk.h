...
$Header: //source/qcom/qct/modem/uim/su/baselines/qsc1110/rel/3.3.71/uim/gstk/src/gstk.h#2 $
...
/* Windows Mobile takes around 2 minutes to send TP */
...
#else
#define GSTK_TP_CMD_WAIT_TIME   5000
