...
$Header: //source/qcom/qct/modem/uim/uimdrv/rel/07H1_2/src/uimdrv.h#11 $ $DateTime: 2009/08/12 09:42:43 $ $Author: rmandala $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/10/09   rm      Error handling for T=1 protocol
06/18/09   sk      Removing error type UIM_INVALID_NEW_PIN from uim_apdu_status_type
06/05/09   sg      Update to include virtuim_qtf.h for test framework
06/02/09   sk      Fix for issue with change pin functionality
