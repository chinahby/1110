...
$Header: //source/qcom/qct/modem/1x/cp/rel/1h08/inc/tdso.h#1 $ $DateTime: 2009/05/29 03:54:56 $ $Author: prabhuk $
...
#define TDSO_RPT_TIMER_SIG       0x0001
  /* This signal is set when the tdso_rpt_timer expires   */
  /* This is used to enable TDSO to kick watchdog on time */
...
#define DOG_RPT() \
  ...
  (void) rex_set_timer ( &tdso_rpt_timer, DOG_TDSO_RPT_TIME ) 
