...
$Header: //source/qcom/qct/modem/1x/cp/rel/1h08/inc/cai.h#1 $ $DateTime: 2009/05/29 03:54:56 $ $Author: prabhuk $
...
#define CAI_ESN_ME_REC                0x26
  /* ESN_ME */
#endif /* FEATURE_IS2000_REL_C) || defined(FEATURE_HWID_SUPPORT */
...
#endif /* FEATURE_MEID_SUPPORT) && defined(FEATURE_HWID_SUPPORT */
...
#ifdef FEATURE_IS2000_REL_C
typedef PACKED struct  /* Fixed Part of Enhanced MC Extended Display record */
{
  byte display_type[7];
  byte num_displays[8];
} cai_enh_mc_ext_disp_fix_type;

typedef PACKED struct  /* Variable Part of Enhanced MC Extended Display record */
{
  byte display_tag[8];
  byte num_record[8];
...
#define CAI_SYSPARM_MIN                                    \
  ( FPOS( cai_sysparm_msg_type, global_redirect ) +        \
...
#define CAI_ACCPARM_MIN                          \
  ( FPOS( cai_accparm_msg_type, nom_pwr_ext ) -  \
...
#define CAI_EXT_NGHBR_MIN                                           \
   ( FPOS( cai_ext_nghbr_msg_type, pilot_inc ) +                    \
...
#define CAI_NGHBR_MIN                                       \
   ( FPOS( cai_nghbr_msg_type, pilot_inc ) +                    \
...
#define CAI_CHNLIST_MAX                                                \
  ( ( CAI_PC_BODY_SIZE - FPOS( cai_chnlist_msg_type, config_msg_seq )  \
...
#define CAI_EXT_SYSPARM_MIN                                    \
   ( FPOS( cai_ext_sysparm_msg_type, tmsi_zone_len )           \
...
#define CAI_UNIV_PAGE_NUM_REC_MAX CAI_UNIV_PAGE_TOTAL_REC_MAX	
#endif /* FEATURE_IS2000_REL_A_CC */
...
#define CAI_GEN_NGHBR_MIN                                \
  ( FPOS( cai_gen_nghbr_msg_type, num_analog_nghbr ) +   \
...
#define CAI_EXT_CHNLIST_MIN                              \
  ( FPOS( cai_ext_chnlist_msg_type, rc_qpch_sel_incl ) + \
    FSIZ( cai_ext_chnlist_msg_type, rc_qpch_sel_incl) ) 

#if defined(FEATURE_IS2000_REL_D_BCMCS) || defined(FEATURE_MSG_PACK_UNIT_TEST)
#error code not present
#endif /* FEATURE_IS2000_REL_D_BCMCS || FEATURE_MSG_PACK_UNIT_TEST */
