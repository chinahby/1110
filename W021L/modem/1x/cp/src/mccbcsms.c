...
$Header: //source/qcom/qct/modem/1x/cp/rel/1h08/src/mccbcsms.c#2 $ $DateTime: 2009/10/13 07:38:24 $ $Author: prabhuk $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/13/09   ag      Fix to increment the BCSMS records index to index of the 
