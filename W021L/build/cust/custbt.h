...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/wconnect/bthost/brew/target/rel/00.00.26/build/cust/custbt.h#7 $
  $DateTime: 2009/06/23 18:59:58 $
  $Author: c_bhatg $

when        who    what, where, why
--------    ---    ----------------------------------------------------------
2009-23-06   gb    Reverting the file back to version #5 
