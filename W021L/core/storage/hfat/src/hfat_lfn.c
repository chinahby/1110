...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/hfat/main/latest/src/hfat_lfn.c#15 $ $DateTime: 2009/07/06 18:31:57 $ $Author: ebuller $
  ...
  /* Check these are the same file */
  {
    ...
    for (i=0; ; i++)
    {
          ...
          _f_toupper (fsnewname->lname[i]))
      {
        ...
        if (_f_findfile (vi, fsnewname->lname, &pos, &temp_de, lfn))
        {
