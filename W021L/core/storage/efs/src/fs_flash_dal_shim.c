...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_flash_dal_shim.c#2 $ $DateTime: 2009/03/20 18:05:12 $ $Author: richardp $
...
flash_nand_write_page (fs_device_t self, page_id page, void *data)
{
  ...
  efs_flash_init_buffer_descriptor(write_type, (uint32) data, NULL,
  ...
  uint32 spare_udata_blen)
{
  ...
  /* Initialize buffer descriptors */
  efs_flash_init_buffer_descriptor(read_type, NULL,
                               (uint32) spare_udata,
                               (DALSysMemDescList *) &page_buff_desc,
                               &page_data_iovec);
  ...
  void *spare, uint32 spare_udata_blen)
{
  ...
  page_data_iovec.total_page_count = 1;
    ...
    /* Initialize buffer descriptors */
  efs_flash_init_buffer_descriptor(read_type,  (uint32) data,
  ...
  uint32 spare_offset, uint32 len, void *data)
{
  ...
  /* Initialize buffer descriptors */
  efs_flash_init_buffer_descriptor(read_type, NULL,  (uint32)data,
     (DALSysMemDescList *) &page_buff_desc, &page_data_iovec);
