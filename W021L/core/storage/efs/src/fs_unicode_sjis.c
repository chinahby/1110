...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_unicode_sjis.c#2 $ $DateTime: 2009/04/23 17:30:14 $ $Author: richardp $
...
#include "customer.h"           /* For FEATURE_EFS_CONVERT_SHIFT_JIS flag */
