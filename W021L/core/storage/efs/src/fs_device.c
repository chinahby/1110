...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_device.c#7 $ $DateTime: 2009/07/06 18:35:11 $ $Author: ebuller $
...
#include <string.h>
FS_ALIGN static byte verify_buffer[EFS_PAGE_SIZE];
#endif
