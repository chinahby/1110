 ...
 * Copyright (C) 2001-2009 Qualcomm, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_buffer.h#8 $ $DateTime: 2009/04/06 18:47:29 $ $Author: richardp $
...
/* FS_BUFFER_NUMBER_BUFFERS now in fs_config.h, so validate the values. */
