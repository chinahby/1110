 ...
 *
 *  $Header: //source/qcom/qct/core/storage/efs/main/latest/inc/fs_estdio.h#1 $ $DateTime: 2009/01/30 16:38:40 $ $Author: richardp $
 *
...
/** Initializes library for fist use.
 *
 ...
 *
 * When using append mode ('a' as the fist character of mode) all write will
 ...
 *
 * Returnt the current file position of the stream pointed by <b>stream</b>.
 *
 * @param stream Pointer to the stream object that handles the file.
 *
 * @return On success returns 0. On error returns -1 and efs_errno is set
 *         accordingly.
 */
 ...
 * called.
 *
 * If <b>buf</b> is a NULL pointer, setvbuf will assume no buffering mode
 ...
 * value of <b>EFS_CHUNK_SIZE</b> can be used instead. The maximum size of
...
int efs_esetvbuf (EFS_EFILE *stream, char *input_buf, int mode,
 ...
 /** Flushes the stream to the device.
 *
