 ...
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/inc/fs_sys_types.h#12 $ $DateTime: 2009/07/06 18:43:01 $ $Author: ebuller $
...
#else
  #include "fs_osal.h"
  #define efs_errno (fs_os_self()->err_num)
#endif
