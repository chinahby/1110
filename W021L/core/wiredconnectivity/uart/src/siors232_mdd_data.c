...
/*===========================================================================
  ...
  $Header: //depot/asic/msmshared/drivers/uart/02.00.XX/siors232_mdd_data.c#6 $
...
static void siors_mdd_esc_seq_guardtime_isr(int32 time_ms, timer_cb_data_type data)
{
...
void siors_mdd_setup_uart_autodetect
(
...
static void siors_mdd_ad_discard_recovery_isr
(
  sio_mdd_port_type     *mdd_port                /* Port                         */
)
{
...
static void siors_mdd_ad_setup_discard_recovery
(
  sio_mdd_port_type     *mdd_port                /* Port                         */
)
{
...
static void siors_mdd_ad_packetpause_check_isr
(
  sio_mdd_port_type     *mdd_port               /* Port                       */
)
{
...
static void siors_mdd_new_valid_packet
(
  sio_mdd_port_type     *mdd_port               /* Port                       */
)
{
