...
static device_params_t dev_param = {
    /* auto_enable */         1,
#ifndef CONFIG_FULL_SPEED_ONLY
    /* full_speed_only */     0,
#endif
    /* dev_info */            &dev_info,
    /* num_of_configs */      sizeof(config_param) / sizeof(config_param_t),
    /* config_param */        config_param,
    /* vendor string handler */ NULL,
    /* vendor IN cmd handler */ NULL,
    /* vendor OUT cmd handler */ NULL,
    /* vendor OUT_DATA cmd handler */ NULL,
...
#   ifdef CONFIG_MEMPOOL_EXTERN
    extern juint8_t _mempool[CONFIG_MEMPOOL_SIZE];
#   elif defined (CONFIG_MEMPOOL_ADDRESS)
    #define _mempool CONFIG_MEMPOOL_ADDRESS
#   else 
    static juint8_t _mempool[CONFIG_MEMPOOL_SIZE];
#   endif
#else
...
static uw_hw_core_param_t hw_core_param = {
    /* core_number */      0,
    _init_opt,
#ifdef CONFIG_JSLAVE
    &dev_param
...
#define FD_TEST_PRODUCT_ID         0x0010
...
#define FD_MASS_ZEROINST_PRODUCT_ID 0x2000
#define FD_AUDIO_PRODUCT_ID        0x4000
 ...
 * Scope: local
 **/
static juint16_t get_product_id(void)
{
    juint16_t product_id = 0;
    #ifdef CONFIG_FD_MASS
        #ifdef CONFIG_ZEROINST
            product_id |= FD_MASS_ZEROINST_PRODUCT_ID;
        #else
