...
typedef struct
{
    ...
    jint32_t logical_min;  /* Minimal logical value */
    jint32_t logical_max;  /* Maximal logical value */
    jint32_t physical_min; /* Minimal physical value */
    jint32_t physical_max; /* Maximal physical value */
    jint32_t usage_min;    /* Minimal usage value */
    jint32_t usage_max;    /* Maximal usage value */
 ...
 *  Usage Codes 
 * ////////////// */
/* Usage code creation macro - creates usage codes from the basic usages */
