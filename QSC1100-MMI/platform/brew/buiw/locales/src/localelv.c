...
LANGUAGE:      Latvian (Lettish) (Latvia)
...
// Format variables, strings, characters and patterns for Latvian (Lettish) (Latvia)
...
static const AECHAR Currency_NegativePattern []           = { '-','#',' ','L','s',0 }; 
static const AECHAR Currency_PositivePattern[]            = { '#',' ','L','s',0 }; 
static const AECHAR Currency_CurrencySymbol[]             = { 'L','s',0 }; 
...
static const AECHAR DateTime_FullDateLongTimePattern[]    = { 'd','d','d','d',',',' ','y','y','y','y','\'','.',' ','g','a','d','a',' ','\'','d','.',' ','M','M','M','M',' ','H',':','m','m',':','s','s', 0 };  
static const AECHAR DateTime_FullDateShortTimePattern[]   = { 'd','d','d','d',',',' ','y','y','y','y','\'','.',' ','g','a','d','a',' ','\'','d','.',' ','M','M','M','M',' ','H',':','m','m',' ',0 };  
...
static const AECHAR DateTime_LongDatePattern[]            = { 'd','d','d','d',',',' ','y','y','y','y','\'','.',' ','g','a','d','a',' ','\'','d','.',' ','M','M','M','M', 0 };
...
'p','i','r','m','d','i','e','n','a',0,
'o','t','r','d','i','e','n','a',0,
't','r','e',0x161,'d','i','e','n','a',0,
'c','e','t','u','r','t','d','i','e','n','a',0,
'p','i','e','k','t','d','i','e','n','a', 0,
's','e','s','t','d','i','e','n','a' ,0,
's','v',0x113,'t','d','i','e','n','a' ,0,
   0 };

static const AECHAR DateTime_MonthNames[] = {
'j','a','n','v',0x101,'r','i','s' ,0,
'f','e','b','r','u',0x101,'r','i','s' ,0,
'm','a','r','t','s' ,0,
'a','p','r',0x12b,'l','i','s' ,0,
'm','a','i','j','s' ,0,
'j',0x16b,'n','i','j','s' ,0,
...
/* -----------------------------------------------------------------------
    LocaleLV_Ctor 
   --- */
static void LocaleLV_Ctor(LocaleLV *pMe, AEEVTBL(ILocale) *pvt, IShell *piShell, IModule *piModule)
{
...
/* -----------------------------------------------------------------------
    LocaleLV_New  
   --- */
int LocaleLV_New(ILocale **ppo, IShell *piShell, IModule *piModule)
{
   LocaleLV *pMe;
   ...
   pMe = MALLOCREC_VTBL(LocaleLV, ILocale);
   if (!pMe) {
      return ENOMEMORY;
   }
   LocaleLV_Ctor(pMe,GETVTBL(pMe,ILocale),piShell,piModule); 
...
int LocaleLV_CreateInstance(IModule *module, IShell *shell, AEECLSID idClass, void **pp)
{
   if (idClass == AEECLSID_LOCALELV) {
      return LocaleLV_New((ILocale **)pp, shell, module);
   }
   *pp = 0;
