...
// Format variables, strings, characters and patterns for Hebrew
...
static const AECHAR Currency_NegativePattern []           = { 0x20aa,'-','#',0 }; 
static const AECHAR Currency_PositivePattern[]            = { 0x20aa,'#',0 }; 
static const AECHAR Currency_CurrencySymbol[]             = { 0x20aa,0 }; 
...
static const AECHAR DateTime_ShortMonthNames[] = {
	0x05D9,0x05E0,0x05D5,0,
	0x05E4,0x05D1,0x05E8,0,
	0x05DE,0x05E8,0x05E5,0,
	0x05D0,0x05E4,0x05E8,0,
	0x05DE,0x05D0,0x05D9,0,
	0x05D9,0x05D5,0x05E0,0,
	0x05D9,0x05D5,0x05DC,0,
	0x05D0,0x05D5,0x05D2,0,
	0x05E1,0x05E4,0x05D8,0,
	0x05D0,0x05D5,0x05E7,0,
	0x05E0,0x05D5,0x05D1,0,
	0x05D3,0x05E6,0x05DE,0,
   0 };

static const AECHAR DateTime_DayNames[] = {
	0x05D7,0x05DE,0x05D9,0x05E9,0x05D9,0x0020,0x05D9,0x05D5,0x05DD,0,
	0x05E8,0x05D1,0x05D9,0x05E2,0x05D9,0x0020,0x05D9,0x05D5,0x05DD,0,
	0x05E9,0x05DC,0x05D9,0x05E9,0x05D9,0x0020,0x05D9,0x05D5,0x05DD,0,
	0x05E9,0x05E0,0x05D9,0x0020,0x05D9,0x05D5,0x05DD,0,
	0x05E8,0x05D0,0x05E9,0x05D5,0x05DF,0x0020,0x05D9,0x05D5,0x05DD,0,
	0x05D9,0x05D5,0x05DD,0,
	0x05E9,0x05D9,0x05E9,0x05D9,0x0020,0x05E9,0x05D1,0x05EA,0,
	0 };

static const AECHAR DateTime_MonthNames[] = {
   0x05D9,0x05E0,0x05D5,0x05D0,0x05E8,0,
   0x05E4,0x05D1,0x05E8,0x05D5,0x05D0,0x05E8,0,
   0x05DE,0x05E8,0x05E5,0,
   0x05D0,0x05E4,0x05E8,0x05D9,0x05DC,0,
   0x05DE,0x05D0,0x05D9,0,
   0x05D9,0x05D5,0x05E0,0x05D9,0,
   0x05D9,0x05D5,0x05DC,0x05D9,0,
   0x05D0,0x05D5,0x05D2,0x05D5,0x05E1,0x05D8,0,
   0x05E1,0x05E4,0x05D8,0x05DE,0x05D1,0x05E8,0,
   0x05D0,0x05D5,0x05E7,0x05D8,0x05D5,0x05D1,0x05E8,0,
   0x05E0,0x05D5,0x05D1,0x05DE,0x05D1,0x05E8,0,
   0x05D3,0x05E6,0x05DE,0x05D1,0x05E8, 0,
   0 };
/*---------------------------------------------------------------------------------
      Function Prototypes
---------------------------------------------------------------------------------*/
...
/* -----------------------------------------------------------------------
    LocaleHE_Ctor 
   --- */
static void LocaleHE_Ctor(LocaleHE *pMe, AEEVTBL(ILocale) *pvt, IShell *piShell, IModule *piModule)
{
...
/* -----------------------------------------------------------------------
    LocaleHE_New  
   --- */
int LocaleHE_New(ILocale **ppo, IShell *piShell, IModule *piModule)
{
   LocaleHE *pMe;
   ...
   pMe = MALLOCREC_VTBL(LocaleHE, ILocale);
   if (!pMe) {
      return ENOMEMORY;
   }
   LocaleHE_Ctor(pMe,GETVTBL(pMe,ILocale),piShell,piModule);
...
int LocaleHE_CreateInstance(IModule *module, IShell *shell, AEECLSID idClass, void **pp)
{
   if (idClass == AEECLSID_LOCALEHE) {
      return LocaleHE_New((ILocale **)pp, shell, module);
   }
   *pp = 0;
