...
// Format variables, strings, characters and patterns for Turkish (Turkey)
...
static const AECHAR Currency_NegativePattern []           = { '-','#',' ','T','L',0 }; 
static const AECHAR Currency_PositivePattern[]            = { '#',' ','T','L',0 }; 
static const AECHAR Currency_CurrencySymbol[]             = { 'T','L',0 }; 
...
static const AECHAR DateTime_FullDateLongTimePattern[]    = { 'd','d',' ','M','M','M','M',' ','y','y','y','y',' ', 'd','d','d','d',' ','H','H',':','m','m',':','s','s', 0 };  
static const AECHAR DateTime_FullDateShortTimePattern[]   = { 'd','d',' ','M','M','M','M',' ','y','y','y','y',' ', 'd','d','d','d',' ','H','H',':','m','m',' ',0 };  
...
static const AECHAR DateTime_LongDatePattern[]            = { 'd','d',' ','M','M','M','M',' ','y','y','y','y',' ', 'd','d','d','d', 0 };
...
'P','a','z','a','r','t','e','s','i' , 0,
'S','a','l',0x131 , 0,
0xc7,'a','r',0x15f,'a','m','b','a' , 0,
'P','e','r',0x15f,'e','m','b','e' , 0,
'C','u','m','a' , 0,
'C','u','m','a','r','t','e','s','i', 0,
'P','a','z','a','r' , 0,
   0 };
...
/* -----------------------------------------------------------------------
    LocaleTR_Ctor 
   --- */
static void LocaleTR_Ctor(LocaleTR *pMe, AEEVTBL(ILocale) *pvt, IShell *piShell, IModule *piModule)
{
...
/* -----------------------------------------------------------------------
    LocaleTR_New  
   --- */
int LocaleTR_New(ILocale **ppo, IShell *piShell, IModule *piModule)
{
   LocaleTR *pMe;
   ...
   pMe = MALLOCREC_VTBL(LocaleTR, ILocale);
   if (!pMe) {
      return ENOMEMORY;
   }
   LocaleTR_Ctor(pMe,GETVTBL(pMe,ILocale),piShell,piModule);
...
int LocaleTR_CreateInstance(IModule *module, IShell *shell, AEECLSID idClass, void **pp)
{
   if (idClass == AEECLSID_LOCALETR) {
      return LocaleTR_New((ILocale **)pp, shell, module);
   }
   *pp = 0;
