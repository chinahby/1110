...
// Format variables, strings, characters and patterns for Bulgarian (Bulgaria)
...
static const AECHAR Currency_NegativePattern []           = { '-','#',' ',0x43b,0x432,0 }; 
static const AECHAR Currency_PositivePattern[]            = { '#',' ',0x43b,0x432,0 }; 
static const AECHAR Currency_CurrencySymbol[]             = { 0x43b,0x432,0 }; 
...
static const AECHAR DateTime_FullDateLongTimePattern[]    = { 'd','d',' ','M','M','M','M',' ','y','y','y','y',' ','\'',0x433,'.','\'',' ','H','H',':','m','m',':','s','s', 0 };  
static const AECHAR DateTime_FullDateShortTimePattern[]   = { 'd','d',' ','M','M','M','M',' ','y','y','y','y',' ','\'',0x433,'.','\'',' ','H','H',':','m','m',' ',0 };  
...
static const AECHAR DateTime_LongDatePattern[]            = { 'd','d',' ','M','M','M','M',' ','y','y','y','y',' ','\'',0x433,'.','\'', 0 };
static const AECHAR DateTime_LongTimePattern[]            = { 'H','H',':','m','m',':','s','s',0 };
static const AECHAR DateTime_MonthDayPattern[]            = { 'd','.',' ','M','M','M',0 };
static const AECHAR DateTime_ShortDatePattern[]           = { 'd','d','.','M','.','y','y','y','y','\'',0x433,'.','\'',0 };
...
0x41f,0x43e,0x43d,0x435,0x434,0x435,0x43b,0x43d,0x438,0x43a , 0,
0x412,0x442,0x43e,0x440,0x43d,0x438,0x43a , 0,
0x421,0x440,0x44f,0x434,0x430 , 0,
0x427,0x435,0x442,0x432,0x44a,0x432,0x442,0x44a,0x43a , 0,
0x41f,0x435,0x442,0x44a,0x43a , 0,
0x421,0x44a,0x431,0x43e,0x442,0x430 , 0,
0x41d,0x435,0x434,0x435,0x43b,0x44f , 0,
   0 };

static const AECHAR DateTime_MonthNames[] = {
0x42f,0x43d,0x443,0x430,0x440,0x438 , 0,
0x424,0x435,0x432,0x440,0x443,0x430,0x440,0x438 , 0,
0x41c,0x430,0x440,0x442 , 0,
0x410,0x43f,0x440,0x438,0x43b , 0,
0x41c,0x430,0x439 , 0,
0x42e,0x43d,0x438, 0,
0x42e,0x43b,0x438, 0,
0x410,0x432,0x433,0x443,0x441,0x442 , 0,
0x421,0x435,0x43f,0x442,0x435,0x43c,0x432,0x440,0x438 , 0,
0x41e,0x43a,0x442,0x43e,0x43c,0x432,0x440,0x438 , 0,
0x41d,0x43e,0x435,0x43c,0x432,0x440,0x438, 0,
0x414,0x435,0x43a,0x435,0x43c,0x432,0x440,0x438 , 0,
   0 };
...
/* -----------------------------------------------------------------------
    LocaleBG_Ctor 
   --- */
static void LocaleBG_Ctor(LocaleBG *pMe, AEEVTBL(ILocale) *pvt, IShell *piShell, IModule *piModule)
{
...
/* -----------------------------------------------------------------------
    LocaleBG_New  
   --- */
int LocaleBG_New(ILocale **ppo, IShell *piShell, IModule *piModule)
{
   LocaleBG *pMe;
   ...
   pMe = MALLOCREC_VTBL(LocaleBG, ILocale);
   if (!pMe) {
      return ENOMEMORY;
   }
   LocaleBG_Ctor(pMe,GETVTBL(pMe,ILocale),piShell,piModule);
...
int LocaleBG_CreateInstance(IModule *module, IShell *shell, AEECLSID idClass, void **pp)
{
   if (idClass == AEECLSID_LOCALEBG) {
      return LocaleBG_New((ILocale **)pp, shell, module);
   }
   *pp = 0;
