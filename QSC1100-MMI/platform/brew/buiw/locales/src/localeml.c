...
// Format variables, strings, characters and patterns for Malayalam (India)
...
static const AECHAR Currency_NegativePattern []           = { 0xd15,'-','#',0 }; 
static const AECHAR Currency_PositivePattern[]            = { 0xd15,'#',0 }; 
static const AECHAR Currency_CurrencySymbol[]             = { 0xd15,0 }; 
...
static const AECHAR DateTime_PMDesignator[]               = { 'A','M',0 };
...
static const AECHAR DateTime_ShortMonthNames[] = {
	0x0D1C,0x0D28,0x0D41,0,
	0x0D2B,0x0D46,0x0D2C,0x0D4D,0,
	0x0D2E,0x0D3E,0x0D31,0x0D4D,0,
	0x0D0F,0x0D2A,0x0D4D,0x0D31,0x0D3F,0x0D32,0x0D4D,0,
	0x0D46,0x0D2E,0x0D2F,0x0D4D,0,
	0x0D1C,0x0D42,0x0D23,0x0D4D,0,
	0x0D1C,0x0D42,0x0D48,0x0D32,0,
	0x0D06,0x0D17,0,
	0x0D46,0x0D38,0x0D2A,0x0D4D,0x0D24,0x0D02,0,
	0x0D12,0x0D15,0x0D4D,0x0D48,0x0D1F,0,
	0x0D28,0x0D35,0x0D02,0,
	0x0D21,0x0D3F,0x0D38,0x0D02,0,  
   0 };

static const AECHAR DateTime_DayNames[] = {
	0x0D24,0x0D3F,0x0D19,0x0D4D,0x0D15,0x0D33,0x0D41,0x0D4D,0, 
	0x0D1A,0x0D4A,0x0D35,0x0D4D,0x0D35,0,
	0x0D2C,0x0D41,0x0D27,0x0D28,0x0D41,0x0D4D,0,
	0x0D35,0x0D4D,0x0D2F,0x0D3E,0x0D34,0x0D02,0,
	0x0D35,0x0D46,0x0D33,0x0D4D,0x0D33,0x0D3F,0,
	0x0D36,0x0D28,0x0D3F,0,
	0x0D1E,0x0D3E,0x0D2F,0x0D31,0x0D41,0x0D4D,0, 
   0 };
...
/* -----------------------------------------------------------------------
    LocaleML_Ctor 
   --- */
static void LocaleML_Ctor(LocaleML *pMe, AEEVTBL(ILocale) *pvt, IShell *piShell, IModule *piModule)
{
...
/* -----------------------------------------------------------------------
    LocaleML_New  
   --- */
int LocaleML_New(ILocale **ppo, IShell *piShell, IModule *piModule)
{
   LocaleML *pMe;
   ...
   pMe = MALLOCREC_VTBL(LocaleML, ILocale);
   if (!pMe) {
      return ENOMEMORY;
   }
   LocaleML_Ctor(pMe,GETVTBL(pMe,ILocale),piShell,piModule); 
...
int LocaleML_CreateInstance(IModule *module, IShell *shell, AEECLSID idClass, void **pp)
{
   if (idClass == AEECLSID_LOCALEML) {
      return LocaleML_New((ILocale **)pp, shell, module);
   }
   *pp = 0;
