...
FILE:      SSOperations_AEEModGen.h // singleton-change
...
/*-------------------------------------------------------------------
      Type Declarations
-------------------------------------------------------------------*/
// singleton-change -  Type of singleton
...
typedef struct _AEEMod                                     
{
   ...
   IShell *       m_pIShell;		// Pointer to IShell
    ...
    // singleton-change - Singleton member
    CSSAgentApp* pCSSAgentApp;
...
int      SSOperations_AEEStaticMod_New(int16 nSize, IShell *pIShell, void * ph, IModule ** ppMod,PFNMODCREATEINST pfnMC,PFNFREEMODDATA pfnMF);
