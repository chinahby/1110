...
#
#
# Copyright (c) 2006, 2007 QUALCOMM Incorporated. All Rights Reserved
#
...
#
# $Header: //source/qcom/qct/modem/mcs/stm/rel/1.0/tools/smcomp.pl#1 $
#
...
DONE
  ...
  foreach my $inputname ( @allinputs ) {
    $inputtable .= "  {$inputname, \"$inputname\"},\n";
  }
  $inputtable .= "};";
...
State Machine/Group Compiler, version 1.1
Copyright (c) Qualcomm, $currentyear
