...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/hfat/main/latest/src/hfat_fat.h#4 $ $DateTime: 2008/10/29 18:07:12 $ $Author: richardp $
 ...
 ***************************************************************************/
  ...
  extern int fn_seek (F_MULTI * fm, FN_FILE * filehandle, long offset,
                      long whence);
  ...
  extern int fn_gettimedate (F_MULTI * fm, const char *filename,
                             unsigned short *pctime, unsigned short *pcdate);
