...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_benchmark.h#1 $ $DateTime: 2008/12/15 13:58:28 $ $Author: richardp $
...
typedef int (*fs_benchmark_prepare_func) (char *);
typedef int (*fs_benchmark_cleanup_func) (char *);
