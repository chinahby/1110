...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_romfs.c#3 $ $DateTime: 2008/12/12 09:42:18 $ $Author: richardp $
...
r_creat_root (struct fs_mount *mpp)
{
  ...
  fs_efs2_inode_construct (&root->p.inode, S_IFDIR | 0755, FS_GROUP_ZERO,
      FS_CURR_UID);
    ...
    fs_inode_t inum)
{
  ...
  fs_efs2_inode_construct (&vp->p.inode, S_IFREG | 0444, FS_GROUP_ZERO,
      FS_CURR_UID);
