...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_device.h#7 $ $DateTime: 2009/01/29 17:39:06 $ $Author: richardp $
...
#include "fs_iovec.h"
  ...
  #ifndef FEATURE_EFS_HOTPLUG
    #error "MNAND needs hotplug..."
  #endif
  #ifndef FEATURE_EFS_HOTPLUG_SD
    #error "MNAND needs hotplug-sd support as well"
  #endif
#endif
...
struct efs_device
{
 ...
 /* Read the data and Spare bytes into buffers. */
  ...
  union
  {
    ...
    #ifdef FEATURE_EFS_EFS2_ON_MNAND
      struct hotplug_device       *mnand_hdev;
    #endif
