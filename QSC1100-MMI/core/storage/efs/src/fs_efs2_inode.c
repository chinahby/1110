...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_efs2_inode.c#2 $ $DateTime: 2008/12/12 09:42:18 $ $Author: richardp $
...
/* Construct new inode. */
void
fs_efs2_inode_construct (struct efs2_inode *ip, fs_mode_t mode,
