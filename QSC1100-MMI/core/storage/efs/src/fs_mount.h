/*===========================================================================
  ...
  Copyright (C) 2003, 2004, 2005, 2006 by QUALCOMM Incorporated.
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/src/fs_mount.h#1 $ $DateTime: 2008/05/29 19:19:11 $ $Author: richardp $
...
struct fs_mount_ops {
  ...
  int (*start) (struct fs_mount *mp, const char *args);
...
int fs_mount_root (const char *fstype, const char *arg);

/* Perform a submount. */
int fs_mount_mount (struct fs_vnode *mpoint,
    const char *fstype, const char *arg);
