...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/inc/custefs.example.h#5 $ $DateTime: 2009/01/30 12:47:45 $ $Author: richardp $
...
/*
 * MAX_SECTORS_PER_DEV_PAGE defines how many 512 byte sectors can be
 * accomodated in the supported biggest flash device's page. This is one of
 * the parameters that decides how big FTL cache will be. By modifying this
 * config bigger part can be supported or RAM can be saved by supporting only
 * small page device.
 *
 * For 512 page device value is 1
 * For 2k  page device value is 4
 * for 4k  page device value is 8
 * */
#define MAX_SECTORS_PER_DEV_PAGE   4

/*
 * MAX_DEV_PAGES_PER_BLOCK defines how many physical pages are there in
...
FEATURE_FS_MULTI_PROC
FEATURE_FS_REMOTE_APPS_PROC
FEATURE_REMOTE_EFS_RESET
