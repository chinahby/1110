 ...
 ***********************************************************************/
 ...
 /*===========================================================================
  ...
  $Header: //source/qcom/qct/core/storage/efs/main/latest/inc/fs_lib.h#2 $ $DateTime: 2008/06/03 15:15:30 $ $Author: richardp $
 ...
 *  recursively for every entry found inside the given path.
 *
 * @param path
...
PACKED struct fs_md5sum {
  uint8 hash[MD5_RESULT_SIZE_IN_BYTES];
};

typedef struct fs_md5sum *fs_md5sum_t;
/**
 * @par Name:
 ...
 *  @code
 *    #include "fs_lib.h"
 *    int efs_md5sum (const char *path, fs_md5sum_t
 *                      hash_out_data);
 *  @endcode
 *
 * @par Description:
 ...
 */
int
efs_md5sum (const char *path, fs_md5sum_t hash_result);
