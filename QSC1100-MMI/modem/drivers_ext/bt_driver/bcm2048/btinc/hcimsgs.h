...
HCI_API extern BOOLEAN btsnd_hcic_io_cap_resp (BD_ADDR bd_addr, UINT8 capability,
...
HCI_API extern void btsnd_hcic_enhanced_flush (void *buffer, UINT16 handle, UINT8 packet_type);
...
HCI_API extern void btsnd_hcic_refresh_encryption_key(void *buffer, UINT16 handle);       /* Refresh Encryption Key */

/**** end of Simple Pairing Commands ****/

#else   /* BTM_LISBON_INCLUDED == FALSE */

#define btsnd_hcic_sniff_sub_rate(buffer, handle, max_lat, min_remote_lat, min_local_lat)
#define btsnd_hcic_write_ext_inquiry_response(buffer, fec_req)
#define btsnd_hcic_read_ext_inquiry_response() FALSE
#define btsnd_hcic_write_simple_pairing_mode(mode) FALSE  
#define btsnd_hcic_read_simple_pairing_mode() FALSE
#define btsnd_hcic_write_simp_pair_debug_mode(debug_mode) FALSE  
#define btsnd_hcic_io_cap_resp(bd_addr, capability, oob_present, auth_req) FALSE
#define btsnd_hcic_io_cap_req_neg_reply(bd_addr, err_code) FALSE
#define btsnd_hcic_read_local_oob_data() FALSE
#define btsnd_hcic_user_conf_reply(bd_addr, is_yes) FALSE
#define btsnd_hcic_user_passkey_reply(bd_addr, value) FALSE
#define btsnd_hcic_user_passkey_neg_reply(bd_addr) FALSE
#define btsnd_hcic_rem_oob_reply(bd_addr, p_c, p_r) FALSE
#define btsnd_hcic_rem_oob_neg_reply(bd_addr) FALSE
#define btsnd_hcic_read_inq_tx_power() FALSE
#define btsnd_hcic_write_inq_tx_power(level) FALSE
#define btsnd_hcic_refresh_encryption_key(buffer, handle) FALSE
#define btsnd_hcic_send_keypress_notif(bd_addr, notif) FALSE

#endif  /* BTM_LISBON_INCLUDED */


HCI_API extern void btsnd_hcic_set_event_mask(void *buffer, BT_EVENT_MASK evt_mask);
