...
#define BTA_JV_NO_DATA             2            /* no data. */
...
#define BTA_JV_MAX_RFC_CONN     MAX_PORTS
...
#define BTA_JV_SERVICE_LMTD_DISCOVER    COD_SERVICE_LMTD_DISCOVER   /* 0x0020 */
#define BTA_JV_SERVICE_POSITIONING      COD_SERVICE_POSITIONING     /* 0x0100 */
#define BTA_JV_SERVICE_NETWORKING       COD_SERVICE_NETWORKING      /* 0x0200 */
#define BTA_JV_SERVICE_RENDERING        COD_SERVICE_RENDERING       /* 0x0400 */
#define BTA_JV_SERVICE_CAPTURING        COD_SERVICE_CAPTURING       /* 0x0800 */
#define BTA_JV_SERVICE_OBJ_TRANSFER     COD_SERVICE_OBJ_TRANSFER    /* 0x1000 */
#define BTA_JV_SERVICE_AUDIO            COD_SERVICE_AUDIO           /* 0x2000 */
#define BTA_JV_SERVICE_TELEPHONY        COD_SERVICE_TELEPHONY       /* 0x4000 */
#define BTA_JV_SERVICE_INFORMATION      COD_SERVICE_INFORMATION     /* 0x8000 */
...
#define BTA_JV_SET_SERVICE_EVT      5  /* not used */
...
#define BTA_JV_L2CAP_OPEN_EVT       15 /* open status of L2CAP connection */
#define BTA_JV_L2CAP_CLOSE_EVT      16 /* L2CAP connection closed */
#define BTA_JV_L2CAP_START_EVT      17 /* L2CAP server started */
#define BTA_JV_L2CAP_CL_INIT_EVT    18 /* L2CAP client initiated a connection */
#define BTA_JV_L2CAP_DATA_IND_EVT   19 /* L2CAP connection received data */
#define BTA_JV_L2CAP_CONG_EVT       20 /* L2CAP connection congestion status changed */
#define BTA_JV_L2CAP_READ_EVT       21 /* the result for BTA_JvL2capRead */
#define BTA_JV_L2CAP_WRITE_EVT      22 /* the result for BTA_JvL2capWrite*/

/* events received by tBTA_JV_RFCOMM_CBACK */
#define BTA_JV_RFCOMM_OPEN_EVT      23 /* open status of RFCOMM connection */
#define BTA_JV_RFCOMM_CLOSE_EVT     24 /* RFCOMM connection closed */
#define BTA_JV_RFCOMM_START_EVT     25 /* RFCOMM server started */
#define BTA_JV_RFCOMM_CL_INIT_EVT   26 /* RFCOMM client initiated a connection */
#define BTA_JV_RFCOMM_DATA_IND_EVT  27 /* RFCOMM connection received data */
#define BTA_JV_RFCOMM_CONG_EVT      28 /* RFCOMM connection congestion status changed */
#define BTA_JV_RFCOMM_READ_EVT      29 /* the result for BTA_JvRfcommRead */
#define BTA_JV_RFCOMM_WRITE_EVT     30 /* the result for BTA_JvRfcommWrite*/

#define BTA_JV_MAX_EVT              31 /* max number of JV events */
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvGetServicesLength(UINT16 *p_services_len);
...
**
*******************************************************************************/
BTA_API extern INT32 BTA_JvGetServicesResult(UINT8 **TLVs);
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvL2capRead(UINT32 handle, UINT8 *p_data, UINT16 len);
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvL2capWrite(UINT32 handle, UINT8 *p_data, UINT16 len);
...
BTA_API extern tBTA_JV_STATUS BTA_JvRfcommStartServer(tBTA_SEC sec_mask,
                           tBTA_JV_ROLE role, UINT8 local_scn,
                           tBTA_JV_RFCOMM_CBACK *p_cback);
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvRfcommRead(UINT32 handle, UINT8 *p_data, UINT16 len);
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvRfcommWrite(UINT32 handle, UINT8 *p_data, UINT16 len);
