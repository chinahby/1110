...
#define USERIAL_OP_TX_LINE_HIGH   13    /* H4IBSS */
#define USERIAL_OP_TX_LINE_LOW    14    /* H4IBSS */
#define USERIAL_OP_RX_AS_WAKEUP   15    /* H4IBSS */
#define USERIAL_OP_RX_AS_DATA     16    /* H4IBSS */
#define USERIAL_OP_GET_CTS        17
#define USERIAL_OP_SET_RTS        18
#define USERIAL_OP_CLEAR_RTS      19
#define USERIAL_OP_NO_FLOW_CTRL   20
...
UDRV_API extern UINT16  USERIAL_Ioctl(tUSERIAL_PORT, tUSERIAL_OP, tUSERIAL_IOCTL_DATA *);
