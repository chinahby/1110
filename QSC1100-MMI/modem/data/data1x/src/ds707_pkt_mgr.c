...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/data/1x/707/main/lite/src/ds707_pkt_mgr.c#14 $ $DateTime: 2009/06/10 22:01:08 $ $Author: msankar $
...
---------------------------------------------------------------------------*/
LOCAL ds707_pkt_state_type            ds707_pkt_state[DS707_MAX_PKT_CALLS];
