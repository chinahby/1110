...
$Header: //source/qcom/qct/modem/uim/istk/rel/07H1_2/inc/AEESTK.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/28/08   sk      Fixed warnings
02/13/08   yb      Removed compilation warning enumeration value is out of 
                   int range
...
typedef enum
{
  ...
  //Unused.
  AEESTK_MAX_PROACTIVE_REQ = 0x7FFFFFFF
...
typedef enum
{
  ...
  //Unused.
  AEESTK_EVENT_MAX_ENVELOPE_REQ = 0x7FFFFFFF
...
typedef enum {
    ...
    AEESTK_CH_UNAVAILABLE                                             = 0x01,
    AEESTK_ACTION_NOT_ALLOWED                                         = 0x01,
    AEESTK_BEARER_UNAVAILABLE                                         = 0x01,

    AEESTK_ME_CURRENTLY_BUSY_ON_CALL                                  = 0x02,
    AEESTK_CH_CLOSED                                                  = 0x02,
    AEESTK_REQUEST_CHANGED                                            = 0x02,
    AEESTK_BROWSER_UNAVAILABLE                                        = 0x02,

    AEESTK_ME_CURRENTLY_BUSY_ON_SS_TRANSACTION                        = 0x03,
    AEESTK_CH_ID_INVALID                                              = 0x03,
    AEESTK_ME_UNABLE_TO_READ_PROVISIONING_DATA                        = 0x03,

    AEESTK_NO_SERVICE_AVAILABLE                                       = 0x04,
    AEESTK_BUFFER_SIZE_UNAVAILABLE                                    = 0x04,

    AEESTK_ACCESS_CONTROL_CLASS_BAR                                   = 0x05,
    AEESTK_SECURITY_ERROR_UNSUCCESSFUL_AUTH                           = 0x05,

    AEESTK_RADIO_RESOURCE_NOT_GRANTED                                 = 0x06,
    AEESTK_SIM_ME_INTERFACE_TRANSPORT_LV_UNAVAILABLE                  = 0x06,
    ...
    AEESTK_MAX_ADDITIONAL_INFO_CODE                                   = 0x7FFFFFFF
}
...
typedef enum {
    ...
    AEESTK_MAX_LAUNCH_BROWSER_MODE        = 0x7FFFFFFF
}
...
typedef enum {
    ...
    AEESTK_MAX_INPUT_FORMAT_MODE          = 0x7FFFFFFF
}
...
typedef enum {
    ...
    AEESTK_MAX_TONE_TYPE                   = 0x7FFFFFFF
...
typedef enum {
    ...
    AEESTK_MAX_MENUP_PRESENT_TYPE         = 0x7FFFFFFF
}
...
typedef enum {
    ...
    AEESTK_MAX_CALL_SETUP_REQ_TYPE        = 0x7FFFFFFF
}
...
typedef enum {
    ...
    AEESTK_MAX_nCallType                  = 0x7FFFFFFF
}
AEESTKCallType;
...
typedef enum {
    ...
    AEESTK_MAX_BC_REPEAST_TYPE         = 0x7FFFFFFF
}
...
typedef enum {
    ...
    AEESTK_MAX_BEARER_CODE_TYPE   = 0x7FFFFFFF
}
