...
$Header: //source/qcom/qct/modem/uim/mmgsdi/rel/07H1_2/src/mmgsdi_icc.c#3 $$ $DateTime: 2009/03/26 02:41:37 $
...
)
{
  ...
  MSG_HIGH("Sending down SELECT command to MMGSDI UIM %d",
