...
/*===========================================================================
  ...
  $Header: //source/qcom/qct/modem/rfa/pmic/chg_task/main/latest/app/inc/chg_config.h#19 $
...
#else
#define AUTO_CHARGING_UCP_IMAX_MAXIMUM                     750
#endif
#endif /* FEATURE_BATTERY_CHARGER_USE_NIMH */
 ...
 *  \brief The VBATDET (in milli volt), in automatic charigng
 */
#define AUTO_CHARGING_VBATDET                              4100
#endif /* FEATURE_BATTERY_CHARGER_USE_NIMH */
/*! \def AUTO_CHARGING_VBATDET
...
/*! \def AUTO_CHARGING_TRICKLE_IMAX
 *  \brief The charging current (in milli amp) for the trickle recovery, in 
 *  automatic charigng
 */
#define AUTO_CHARGING_TRICKLE_IMAX                         60
#ifdef FEATURE_BATTERY_CHARGER_USE_NIMH
...
/*! \def AUTO_CHARGING_END_FAST_CHARGE_DETECTION_T
 *  \brief The end-of-fast-charge detection timeout (in milli seconds) in the autonomous charging
 *  \details This timer is used to collect the ADC readings for the battery voltage, in order
 *  to decide if it is charged close to full ( ::AUTO_CHARGING_VMAXSEL ).
 *  \note This timer should only be started when a charger hardware is attached to the phone. 
 *  This timer should be stopped whenever the charger hardware is removed from the phone or the  
 *  battery voltage is equal or above ( ::AUTO_CHARGING_VMAXSEL ).
 */  
#define AUTO_CHARGING_END_FAST_CHARGE_DETECTION_T         59911
