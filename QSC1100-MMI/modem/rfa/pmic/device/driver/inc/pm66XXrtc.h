...
/*===========================================================================
         ...
         P M 6 6 X X   R T C   S E R V I C E S   H E A D E R   F I L E
...
$Header: //source/qcom/qct/modem/rfa/pmic/device/main/latest/driver/inc/pm66XXrtc.h#3 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/13/09   lp      Added pm_hal_rtc_set_reset_trigger, 
                   pm_hal_rtc_get_reset_trigger, and
                   pm_hal_rtc_get_pwr_on_triggered_from_rtc
...
===========================================================================*/
extern pm_err_flag_type pm_hal_rtc_start(
   const pm_hal_rtc_time_type *start_time_ptr
);
/*~ FUNCTION pm_hal_rtc_start */
/*~ PARAM IN start_time_ptr POINTER */
...
SIDE EFFECTS
   Interrupts are disabled during this function.
===========================================================================*/
extern pm_err_flag_type pm_hal_rtc_get_time(
   pm_hal_rtc_time_type *time_ptr
);
/*~ FUNCTION pm_hal_rtc_get_time */
/*~ PARAM OUT time_ptr POINTER */
...
/*~ FUNCTION pm_hal_rtc_enable_alarm */
/*~ PARAM IN trigger_time_ptr POINTER */
...
SIDE EFFECTS
   Interrupts are disabled during this function.
===========================================================================*/
extern pm_err_flag_type pm_hal_rtc_disable_alarm(
   pm_hal_rtc_alarm  what_alarm
);
/*~ FUNCTION pm_hal_rtc_disable_alarm */
...
/*~ FUNCTION pm_hal_rtc_get_alarm_time */
/*~ PARAM OUT alarm_time_ptr POINTER */
...
/*~ FUNCTION pm_hal_rtc_get_alarm_status */
/*~ PARAM OUT status_ptr POINTER */
...
SIDE EFFECTS
   Interrupts are disabled during this function.
===========================================================================*/
extern pm_err_flag_type pm_hal_rtc_set_time_adjust(
   uint8 time_adjust
);
/*~ FUNCTION pm_hal_rtc_set_time_adjust */
...
SIDE EFFECTS
   Interrupts are disabled during this function.
===========================================================================*/
extern pm_err_flag_type pm_hal_rtc_get_time_adjust(
   uint8 *time_adjust_ptr
);
/*~ FUNCTION pm_hal_rtc_get_time_adjust */
...
/**
 * Function pm_hal_rtc_get_reset_trigger
 * 
 * Read bit 7 of TEMP_ALARM2_TEST register to get RTC state
 * 
 * @param rtc_state FALSE -> RESET RTC
 *                 TRUE-> RTC TIME IS SET
 * 
 * @return pm_err_flag_type
 */
extern pm_err_flag_type pm_hal_rtc_get_reset_trigger(boolean *rtc_state_ptr);

/**
 * Function pm_hal_rtc_set_reset_trigger
 * 
 * Set bit 7 of TEMP_ALARM2_TEST register to 1. Setting this bit
 * to 0 is an invalid condition.
 * 
 * @param None
 * 
 * @return pm_err_flag_type
 */
extern pm_err_flag_type pm_hal_rtc_set_reset_trigger(void);

/**
 * Function pm_hal_rtc_get_pwr_on_triggered_from_rtc
 * 
 * Read power on trigger 
 * 
 * @param pwr_on_trigger_ptr
 *    FALSE -> Triggered from non-RTC
 *    TRUE -> Triggered from RTC
 * 
 * @return pm_err_flag_type
 */
extern pm_err_flag_type pm_hal_rtc_get_pwr_on_triggered_from_rtc(boolean *pwr_on_trigger_ptr);
